    ...
    fn test_parsing() {
        ...
        assert!(parse("e") == Some(vec!(Selector{
            compound_selectors: Arc::new(CompoundSelector {
                simple_selectors: vec!(LocalNameSelector(~"e")),
                next: None,
            }),
            pseudo_element: None,
        ...
        assert!(parse(".foo") == Some(vec!(Selector{
            compound_selectors: Arc::new(CompoundSelector {
                simple_selectors: vec!(ClassSelector(~"foo")),
                next: None,
            }),
            pseudo_element: None,
        ...
        assert!(parse("#bar") == Some(vec!(Selector{
            compound_selectors: Arc::new(CompoundSelector {
                simple_selectors: vec!(IDSelector(~"bar")),
                next: None,
            }),
            pseudo_element: None,
        ...
        assert!(parse("div :after") == Some(vec!(Selector{
            compound_selectors: Arc::new(CompoundSelector {
                simple_selectors: Vec::new(),
                next: Some((~CompoundSelector {
                    simple_selectors: vec!(LocalNameSelector(~"div")),
                    next: None,
                }, Descendant)),
            }),
