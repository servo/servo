...
class GlobalGenRoots():
    ...
    def InheritTypes(config):
        ...
        allprotos = [CGGeneric("#![allow(unused_imports)]\n"),
                     ...
                     CGGeneric("use dom::bindings::utils::{Reflectable, Reflector};\n"),
...
''').substitute({'name': name}))]
            ...
            if parent is not None:
                parent_name = parent.identifier.name.lower()
                reflector = [CGGeneric(string.Template('''impl Reflectable for ${name} {
...
''').substitute({'name': name, 'parent': parent_name}))]

            allprotos += protos + derived + cast + trace + reflector
