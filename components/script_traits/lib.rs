...
pub enum CompositorEvent {
    ...
    MouseButtonEvent(MouseEventType, MouseButton, Point2D<f32>, Option<u64>),
    /// The mouse was moved over a point (or was moved out of the recognizable region).
    MouseMoveEvent(Option<Point2D<f32>>, Option<u64>),
    /// A touch event was generated with a touch ID and location.
    TouchEvent(TouchEventType, TouchId, Point2D<f32>, Option<u64>),
    /// Touchpad pressure event
    TouchpadPressureEvent(Point2D<f32>, f32, TouchpadPressurePhase, Option<u64>),
    /// A key was pressed.
