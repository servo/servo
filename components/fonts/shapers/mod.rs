...
mod harfbuzz;
#[cfg(feature = "harfbuzz")]
pub use harfbuzz::Shaper as HarfBuzzShaper;

#[cfg(feature = "harfrust")]
mod harfrust;
#[cfg(feature = "harfrust")]
pub use harfrust::Shaper as HarfRustShaper;

#[cfg(all(feature = "harfbuzz", feature = "harfrust"))]
mod both;
#[cfg(all(feature = "harfbuzz", feature = "harfrust"))]
pub use BothShaper as Shaper;
// Configure default shaper (actually used)
#[cfg(all(feature = "harfbuzz", not(feature = "harfrust")))]
pub use HarfBuzzShaper as Shaper;
#[cfg(all(not(feature = "harfbuzz"), feature = "harfrust"))]
pub use HarfRustShaper as Shaper;
#[cfg(all(feature = "harfbuzz", feature = "harfrust"))]
pub use both::Shaper as BothShaper;
