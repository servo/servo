...
pub struct GlyphStore {
    ...
    /// Whether or not the last character of this [`GlyphStore`] is a softwrap opportunity generated by `icu_segmenter`'s `LineSegmenter`
    /// (UAX#14 linebreak) or it is generated by other properties such as `overflow-wrap: anywhere`. If it is the former, this value is true.
...
impl GlyphStore {
    ...
    pub(crate) fn new(length: usize, options: &ShapingOptions) -> Self {
        Self {
            ...
            ends_with_uax_14_linebreak: false,
        }
    }

    pub fn set_uax_linebreak_flag(&mut self, state: bool) {
        self.ends_with_uax_14_linebreak = state;
    }

    pub fn get_uax_linebreak_flag(&self) -> bool {
        self.ends_with_uax_14_linebreak
    }
