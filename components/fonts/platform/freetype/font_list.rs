...
use fontconfig_sys::constants::{
    ...
    FC_WEIGHT, FC_WEIGHT_BLACK, FC_WEIGHT_BOLD, FC_WEIGHT_BOOK, FC_WEIGHT_DEMIBOLD,
    FC_WEIGHT_EXTRABLACK, FC_WEIGHT_EXTRABOLD, FC_WEIGHT_EXTRALIGHT, FC_WEIGHT_LIGHT,
    FC_WEIGHT_MEDIUM, FC_WEIGHT_REGULAR, FC_WEIGHT_THIN, FC_WIDTH, FC_WIDTH_CONDENSED,
