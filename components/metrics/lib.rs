...
impl InteractiveWindow {
    ...
    pub fn needs_check(&self) -> bool {
        self.instant.elapsed() > *TEN_SECONDS && !self.all_interactive
    }
...
impl<'a> ProgressiveWebMetric for &'a InteractiveMetrics {
    fn get_navigation_start(&self) -> Option<f64> {
...
impl<'a> ProgressiveWebMetric for &'a PaintTimeMetrics {
    fn get_navigation_start(&self) -> Option<f64> {
        self.navigation_start.get()
    }
