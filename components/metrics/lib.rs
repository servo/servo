...
/// maximum task time is 50ms (in ns) -- jdm i swear i asked google
pub const MAX_TASK_MS: u64 = 50000000;
/// 10 second window (in ns)
const INTERACTIVE_WINDOW_SECONDS: u64 = 10000000000;
...
impl InteractiveWindow {
    ...
    pub fn needs_check(&self) -> bool {
        precise_time_ns() - self.start >= INTERACTIVE_WINDOW_SECONDS
    }
