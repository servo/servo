...
pub fn sandbox_access_files_rec() -> Vec<PathBuf> {
    RES.read().unwrap().as_ref().expect("Resource reader not set.").sandbox_access_files_rec()
}
...
pub fn register_resources_for_tests() {
    INIT.call_once(|| {
        ...
        impl ResourceReaderMethods for ResourceReader {
            ...
            fn sandbox_access_files_rec(&self) -> Vec<PathBuf> { vec![] }
