        ...
        match *self {
            ...
            NthChild(a, b) | NthLastChild(a, b) | NthOfType(a, b) | NthLastOfType(a, b) => {
                match *self {
                    ...
                    NthLastChild(_, _) => write!(dest, ":nth-last-child(")?,
                    NthOfType(_, _) => write!(dest, ":nth-of-type(")?,
                    NthLastOfType(_, _) => write!(dest, ":nth-last-of-type(")?,
                    _ => unreachable!(),
                }
        ...
        Some((namespace, local_name)) => {
            match namespace {
                ...
                QNamePrefix::ExplicitNamespace(prefix, url) => {
                    sequence.push(match parser.default_namespace() {
