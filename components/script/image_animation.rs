...
pub struct ImageAnimationManager {
    ...
    /// A list of nodes with in-progress Animated Image.
...
impl ImageAnimationManager {
    ...
    pub fn next_schedule_time(&self, now: f64) -> f64 {
    ...
    // Unroot any nodes that we have rooted but are no longer tracking image animations for.
