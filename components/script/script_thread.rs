...
use msg::constellation_msg::{MouseEventType, MozBrowserEvent, PipelineId};
...
use script_traits::{LayoutMsg, MouseButton, OpaqueScriptLayoutChannel, ScriptMsg as ConstellationMsg};
