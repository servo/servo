        ...
        loop {
            ...
            match event {
                ...
                FromScript(MainThreadScriptMsg::Common(CommonScriptMsg::Task(
                    ...
                    // Instead of running this task now or while handling other messages, `update_the_rendering()`
                    // is run (if necessary) after handling other messages received via IPC. This is to ensure
                    // a consistent `ScriptThread` state and to make all message handling atomic with rendering
                    // updates.
                },
