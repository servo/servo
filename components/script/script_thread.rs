...
use net_traits::{AsyncResponseTarget, ResourceMsg, LoadConsumer};
use net_traits::{LoadContext, Metadata, ResourceThreads, ResourceThread};
...
pub struct ScriptThread {
    ...
    /// A collection of resource-related threads
...
impl ScriptThread {
    ...
    fn load(&self, metadata: Metadata, incomplete: InProgressLoad) -> ParserRoot {
        ...
        let loader = DocumentLoader::new_with_thread(Arc::new(self.resource_thread()),
    ...
    fn start_page_load(&self, incomplete: InProgressLoad, mut load_data: LoadData) {
        ...
        self.resource_thread().send(ResourceMsg::Load(NetLoadData {
    ...
    fn resource_thread(&self) -> ResourceThread {
        self.resource_threads.resource_thread.clone()
    }
}
