...
impl CanvasRenderingContext2DMethods for CanvasRenderingContext2D {
    ...
    fn CreateImageData(&self, sw: Finite<f64>, sh: Finite<f64>) -> Fallible<Root<ImageData>> {
        ...
        Ok(ImageData::new(self.global_root().r(), sw, sh, None))
    }

    // https://html.spec.whatwg.org/multipage/#dom-context-2d-createimagedata
    fn CreateImageData_(&self, imagedata: &ImageData) -> Fallible<Root<ImageData>> {
        Ok(ImageData::new(self.global_root().r(),
                          imagedata.Width(),
                          imagedata.Height(),
                          None))
    }
    ...
    fn GetImageData(&self,
        ...
        Ok(ImageData::new(self.global_root().r(), sw, sh, Some(data)))
    }
    ...
    fn PutImageData_(&self,
        ...
        let data = imagedata.get_data_array(&self.global_root().r());
    ...
    fn CreateLinearGradient(&self,
                            ...
                            y1: Finite<f64>)
                            -> Root<CanvasGradient> {
        CanvasGradient::new(self.global_root().r(),
    ...
    fn CreateRadialGradient(&self,
        ...
        Ok(CanvasGradient::new(self.global_root().r(),
    ...
    fn CreatePattern(&self,
        ...
        if let Ok(rep) = RepetitionStyle::from_str(&repetition) {
            Ok(CanvasPattern::new(self.global_root().r(),
                                  image_data,
                                  image_size,
                                  rep,
