...
impl CanvasRenderingContext2DMethods for CanvasRenderingContext2D {
    ...
    fn IsPointInPath(&self, x: f64, y: f64, fill_rule: CanvasFillRule) -> bool {
        ...
        let (sender, receiver) = receiver::channel::<bool>(self.global().time_profiler_chan().clone()).unwrap();
        self.ipc_renderer
    ...
    fn GetImageData(&self,
        ...
        let (sender, receiver) = receiver::channel::<Vec<u8>>(self.global().time_profiler_chan().clone()).unwrap();
