...
impl CanvasRenderingContext2DMethods for CanvasRenderingContext2D {
    ...
    fn Scale(&self, x: f64, y: f64) {
        ...
        self.state.borrow_mut().transform = transform.post_scaled(x as f32, y as f32);
    ...
    fn Rotate(&self, angle: f64) {
        ...
        let transform = self.state.borrow().transform;
        self.state.borrow_mut().transform = transform.post_mul(
    ...
    fn Translate(&self, x: f64, y: f64) {
        ...
        let transform = self.state.borrow().transform;
        self.state.borrow_mut().transform = transform.post_translated(x as f32, y as f32);
        self.update_transform()
    }
