...
impl<'a> CanvasRenderingContext2DMethods for JSRef<'a, CanvasRenderingContext2D> {
    // https://html.spec.whatwg.org/multipage/scripting.html#dom-context-2d-canvas
    fn Canvas(self) -> Temporary<HTMLCanvasElement> {
        Temporary::new(self.canvas)
    }

    // https://html.spec.whatwg.org/multipage/scripting.html#dom-context-2d-scale
    ...
    // https://html.spec.whatwg.org/multipage/scripting.html#dom-context-2d-translate
    ...
    // https://html.spec.whatwg.org/multipage/scripting.html#dom-context-2d-transform
    ...
    // https://html.spec.whatwg.org/multipage/scripting.html#dom-context-2d-settransform
    ...
    // https://html.spec.whatwg.org/multipage/scripting.html#dom-context-2d-fillrect
    ...
    // https://html.spec.whatwg.org/multipage/scripting.html#dom-context-2d-clearrect
    ...
    // https://html.spec.whatwg.org/multipage/scripting.html#dom-context-2d-strokerect
    ...
    // https://html.spec.whatwg.org/multipage/scripting.html#dom-context-2d-closepath
    fn ClosePath(self) {
        self.renderer.send(CanvasMsg::ClosePath).unwrap();
    }

    // https://html.spec.whatwg.org/multipage/scripting.html#dom-context-2d-fill
    fn Fill(self, _: CanvasWindingRule) {
        self.renderer.send(CanvasMsg::Fill).unwrap();
    }

    // https://html.spec.whatwg.org/multipage/scripting.html#dom-context-2d-stroke
    fn Stroke(self) {
    ...
    // https://html.spec.whatwg.org/multipage/scripting.html#dom-context-2d-moveto
    ...
    // https://html.spec.whatwg.org/multipage/scripting.html#dom-context-2d-lineto
    ...
    // https://html.spec.whatwg.org/multipage/scripting.html#dom-context-2d-quadraticcurveto
    ...
    // https://html.spec.whatwg.org/multipage/scripting.html#dom-context-2d-beziercurveto
    ...
    // https://html.spec.whatwg.org/multipage/scripting.html#dom-context-2d-arcto
    ...
    // https://html.spec.whatwg.org/multipage/scripting.html#dom-context-2d-strokestyle
    ...
    // https://html.spec.whatwg.org/multipage/scripting.html#dom-context-2d-createimagedata
    ...
    // https://html.spec.whatwg.org/multipage/scripting.html#dom-context-2d-createlineargradient
