...
impl CanvasRenderingContext2DMethods for CanvasRenderingContext2D {
    ...
    fn FillText(&self, text: DOMString, x: f64, y: f64, max_width: Option<f64>) {
        ...
        self.ipc_renderer.send(CanvasMsg::Canvas2d(Canvas2dMsg::FillText(parsed_text, x, y, max_width),
        self.get_canvas_id())).unwrap();
        self.mark_as_dirty();
    }
    ...
    fn PutImageData_(&self,
        ...
        let msg = CanvasMsg::Canvas2d(Canvas2dMsg::PutImageData(data.into(),
                                                                offset,
                                                                image_data_size,
                                                                dirty_rect),
                                                                self.get_canvas_id());
