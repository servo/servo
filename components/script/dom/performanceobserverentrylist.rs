...
impl<TH: TypeHolderTrait> PerformanceObserverEntryList<TH> {
    ...
    pub fn new(
        ...
        entries: PerformanceEntryList<TH>,
...
impl<TH: TypeHolderTrait> PerformanceObserverEntryListMethods<TH>
    for PerformanceObserverEntryList<TH>
{
