...
impl Worker {
    ...
    pub fn Constructor(global: GlobalRef, script_url: DOMString) -> Fallible<Root<Worker>> {
        ...
        let (devtools_sender, devtools_receiver) = match global.devtools_chan() {
            Some(ref chan) => {
                ...
                chan.send(ScriptToDevtoolsControlMsg::NewGlobal((pipeline_id, Some(worker_id)),
                                                                ...
                                                                page_info)).unwrap();
                (Some(devtools_sender), Some(devtools_receiver))
            },
            None => (None, None),
        };
        ...
        DedicatedWorkerGlobalScope::run_worker_scope(
            ...
            devtools_sender, devtools_receiver.unwrap(), worker_ref, resource_task,
