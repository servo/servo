...
impl HTMLFormElement {
    ...
    pub fn submit(&self, submit_method_flag: SubmittedFrom, submitter: FormSubmitter) {
        ...
        match (&*scheme, method) {
            // [Submit Dialog](https://html.spec.whatwg.org/multipage/#submit-dialog)
            (_, FormMethod::FormDialog) => return, // Unimplemented
            // [Mutate action URL](https://html.spec.whatwg.org/multipage/#submit-mutate-action)
            ("http", FormMethod::FormGet) | ("https", FormMethod::FormGet) => {
                load_data.url.query = Some(parsed_data);
                self.plan_to_navigate(load_data, &win);
            }
            // [Submit as entity body](https://html.spec.whatwg.org/multipage/#submit-body)
            ("http", FormMethod::FormPost) | ("https", FormMethod::FormPost) => {
                load_data.method = Method::Post;
                load_data.data = Some(parsed_data.into_bytes());
            }
            // [Get action URL](https://html.spec.whatwg.org/multipage/#submit-get-action)
