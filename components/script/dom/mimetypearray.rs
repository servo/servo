...
impl MimeTypeArrayMethods for MimeTypeArray {
    // https://html.spec.whatwg.org/multipage/webappapis.html#dom-mimetypearray-length
    fn Length(&self) -> u32 {
        0
    }

    // https://html.spec.whatwg.org/multipage/webappapis.html#dom-mimetypearray-item
    fn Item(&self, _index: u32) -> Option<Root<MimeType>> {
        None
    }

    // https://html.spec.whatwg.org/multipage/webappapis.html#dom-mimetypearray-nameditem
