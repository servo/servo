...
use dom::bindings::js::{Temporary, JS, JSRef, MutNullableHeap};
...
impl WebGLProgram {
    ...
    pub fn maybe_new(global: GlobalRef, renderer: Sender<CanvasMsg>) -> Option<Temporary<WebGLProgram>> {
    ...
    pub fn new(global: GlobalRef, renderer: Sender<CanvasMsg>, id: u32) -> Temporary<WebGLProgram> {
