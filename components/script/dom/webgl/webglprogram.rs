...
impl DroppableWebGLProgram {
    fn new(id: WebGLProgramId, context: WeakRef<WebGLRenderingContext>) -> Self {
        Self {
            id,
...
impl DroppableWebGLProgram {
    ...
    fn set_fragment_shader(&self, shader: Option<WeakRef<WebGLShader>>) {
    ...
    fn set_vertex_shader(&self, shader: Option<WeakRef<WebGLShader>>) {
...
impl WebGLProgram {
    fn new_inherited(context: &WebGLRenderingContext, id: WebGLProgramId) -> Self {
        Self {
            ...
            droppable: DroppableWebGLProgram::new(id, WeakRef::new(context)),
        }
    }
