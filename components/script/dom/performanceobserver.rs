...
impl PerformanceObserver {
    fn new_inherited(callback: Rc<PerformanceObserverCallback>, global: &GlobalScope)
        -> PerformanceObserver {
        PerformanceObserver {
            reflector_: Reflector::new(),
            callback,
            global: JS::from_ref(global),
            entries: DOMRefCell::new(Vec::new()),
        }
    }

    #[allow(unrooted_must_root)]
    fn new(global: &GlobalScope, callback: Rc<PerformanceObserverCallback>)
        -> Root<PerformanceObserver> {
        let observer = PerformanceObserver::new_inherited(callback, global);
...
impl PerformanceObserverMethods for PerformanceObserver {
    // https://www.w3.org/TR/performance-timeline-2/#dom-performanceobserver-observe
    ...
    // https://www.w3.org/TR/performance-timeline-2/#dom-performanceobserver-disconnect
    fn Disconnect(&self) {
