...
pub enum ServiceWorkerScriptMsg {
    // Msg variants common to all workers
...
impl ServiceWorkerGlobalScope {
    ...
    fn handle_script_event(&self, msg: ServiceWorkerScriptMsg) {
        match msg {
            ServiceWorkerScriptMsg::CommonWorker(WorkerScriptMsg::DOMMessage(data)) => {
            ...
            ServiceWorkerScriptMsg::CommonWorker(WorkerScriptMsg::Common(CommonScriptMsg::RunnableMsg(_, runnable))) => {
                runnable.handler()
            },
            ServiceWorkerScriptMsg::CommonWorker(WorkerScriptMsg::Common(CommonScriptMsg::RefcountCleanup(addr))) => {
                LiveDOMReferences::cleanup(addr);
            },
            ServiceWorkerScriptMsg::CommonWorker(WorkerScriptMsg::Common(CommonScriptMsg::CollectReports(reports_chan))) => {
                let scope = self.upcast::<WorkerGlobalScope>();
                let cx = scope.get_cx();
            ...
            ServiceWorkerScriptMsg::Response(mediator) => {
