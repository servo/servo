    ...
    match value {
        WebGLSamplerValue::GLenum(value) => {
            let allowed_values = match pname {
                ...
                constants::TEXTURE_MAG_FILTER => vec![constants::NEAREST, constants::LINEAR],
                constants::TEXTURE_WRAP_R |
                constants::TEXTURE_WRAP_S |
                constants::TEXTURE_WRAP_T => vec![
                    constants::CLAMP_TO_EDGE,
                    constants::MIRRORED_REPEAT,
                    constants::REPEAT,
                ],
                constants::TEXTURE_COMPARE_MODE => {
                    vec![constants::NONE, constants::COMPARE_REF_TO_TEXTURE]
                },
                constants::TEXTURE_COMPARE_FUNC => vec![
                    constants::LEQUAL,
                    constants::GEQUAL,
                    constants::LESS,
                    constants::GREATER,
