...
use dom::bindings::weakref::WeakRef;
...
pub struct Window {
    ...
    media_query_lists: DOMRefCell<WeakMediaQueryListVec>,
}
...
impl WindowMethods for Window {
    ...
    fn MatchMedia(&self, query: DOMString) -> Root<MediaQueryList> {
        ...
        self.media_query_lists.borrow_mut().push(WeakRef::new(&*mql));
        mql
    }
...
impl Window {
    ...
    pub fn evaluate_media_queries_and_report_changes(&self) {
        self.media_query_lists.borrow().evaluate_and_report_changes();
    }
}
...
impl Window {
    pub fn new(runtime: Rc<Runtime>,
        ...
        let win = box Window {
            ...
            media_query_lists: DOMRefCell::new(WeakMediaQueryListVec::new()),
        };
