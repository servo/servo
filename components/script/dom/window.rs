...
use page::Page;
use script_task::{TimerSource, ScriptChan, ScriptPort, NonWorkerScriptChan, MainThreadScriptMsg};
...
pub struct Window {
    ...
    script_chan: NonWorkerScriptChan,
...
impl Window {
    ...
    pub fn main_thread_script_chan(&self) -> Sender<MainThreadScriptMsg> {
        let NonWorkerScriptChan(ref sender) = self.script_chan;
        sender.clone()
    }
