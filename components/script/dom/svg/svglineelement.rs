...
#[dom_struct]
pub(crate) struct SVGLineElement {
...
impl SVGLineElement {
    ...
    ) -> DomRoot<SVGLineElement> {
        Node::reflect_node_with_proto(
            cx,
            Box::new(SVGLineElement::new_inherited(local_name, prefix, document)),
            document,
            proto,
        )
    }
...
impl VirtualMethods for SVGLineElement {
