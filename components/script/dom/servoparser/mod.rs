...
impl ParserContext {
    ...
    pub(crate) fn set_policy_container(&mut self, policy_container: Option<&PolicyContainer>) {
        ...
        self.navigation_params.policy_container = Some(policy_container.clone());
    }
    ...
    fn initialize_document_object(&self, document: &Document) {
        ...
        if let Some(policy_container) = &self.navigation_params.policy_container {
            document.set_policy_container(policy_container.clone());
        }
