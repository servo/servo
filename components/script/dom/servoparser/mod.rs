...
impl ServoParser {
    ...
    pub fn is_script_created(&self) -> bool {
        self.script_created_parser.get()
    }
    ...
    pub fn can_write(&self) -> bool {
        self.script_created_parser.get() || self.script_nesting_level.get() > 0
    }
    ...
    pub fn close(&self) {
        assert!(self.script_created_parser.get());
    ...
    fn new_inherited(document: &Document,
        ...
        ServoParser {
            ...
            script_created_parser: Cell::new(kind == ParserKind::ScriptCreated),
        }
    }
