...
impl TreeSink for Sink {
    ...
    fn create_comment(&mut self, text: StrTendril) -> Self::Handle {
        let node = self.new_parse_node();
        self.process_operation(ParseOperation::CreateComment(String::from(text), node.id));
        node
    }
    ...
    fn append_doctype_to_document(&mut self, name: StrTendril, public_id: StrTendril,
        ...
        self.process_operation(ParseOperation::AppendDoctypeToDocument(name.into(), public_id.into(), system_id.into()));
    }
