...
impl HTMLMediaElement {
    ...
    fn change_ready_state(&self, ready_state: ReadyState) {
        ...
        match (old_ready_state, ready_state) {
            ...
            (ReadyState::HaveEnoughData, ReadyState::HaveFutureData) |
    ...
    fn media_element_load_algorithm(&self) {
        ...
        if network_state != NetworkState::Empty {
            ...
            // 4.5
            if self.ready_state.get() != ReadyState::HaveEnoughData {
...
impl HTMLMediaElementMethods for HTMLMediaElement {
    ...
    fn Play(&self) {
        ...
        if self.Paused() {
            ...
            // 7.4
            if state == ReadyState::HaveEnoughData ||
...
impl FetchResponseListener for HTMLMediaElementContext {
    ...
    fn process_response_eof(&mut self, status: Result<(), NetworkError>) {
        ...
        else if elem.ready_state.get() != ReadyState::HaveEnoughData {
            // Step 2
