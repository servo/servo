...
/// Number of event path segments stored inline.
/// TODO: confirm with benchmarks/real pages this is a good size?
...
impl Event {
    ...
    fn dispatch_inner(
        ...
        // here instead of re-rooting it on every ancestor step below.
