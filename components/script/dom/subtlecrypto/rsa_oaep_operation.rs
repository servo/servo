...
pub(crate) fn import_key(
    ...
    let (handle, key_type) = match format {
        ...
        // If format is "pkcs8":
        KeyFormat::Pkcs8 => {
            // Step 2.2. If usages contains an entry which is not "decrypt" or "unwrapKey", then
            // throw a SyntaxError.
            if usages
                .iter()
        ...
        KeyFormat::Jwk => {
            ...
            // If the alg field is equal to the string "RSA-OAEP":
            //     Let hash be the string "SHA-1".
            // If the alg field is equal to the string "RSA-OAEP-256":
            //     Let hash be the string "SHA-256".
            // If the alg field is equal to the string "RSA-OAEP-384":
            //     Let hash be the string "SHA-384".
            // If the alg field is equal to the string "RSA-OAEP-512":
