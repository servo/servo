...
use crate::dom::subtlecrypto::rsa_common::{RsaAlgorithm, decode_base64url_uint};
use crate::dom::subtlecrypto::{
    ALG_RSASSA_PKCS1, ALG_SHA1, ALG_SHA256, ALG_SHA384, ALG_SHA512, ExportedKey, JsonWebKeyExt,
    KeyAlgorithmAndDerivatives, Operation, SubtleRsaHashedImportParams,
    SubtleRsaHashedKeyAlgorithm, normalize_algorithm, rsa_common,
};
...
pub(crate) fn import_key(
    ...
    let algorithm = SubtleRsaHashedKeyAlgorithm {
        name: ALG_RSASSA_PKCS1.to_string(),
        modulus_length,
        public_exponent,
