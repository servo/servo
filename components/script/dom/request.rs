...
impl<TH: TypeHolderTrait> Request<TH> {
    fn new_inherited(global: &GlobalScope<TH>, url: ServoUrl) -> Request<TH> {
        Request {
    ...
    pub fn new(global: &GlobalScope<TH>, url: ServoUrl) -> DomRoot<Request<TH>> {
        reflect_dom_object(
...
fn net_request_from_global<TH: TypeHolderTrait>(
    global: &GlobalScope<TH>,
    url: ServoUrl,
) -> NetTraitsRequest {
