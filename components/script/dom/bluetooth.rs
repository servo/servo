...
use dom::bindings::codegen::Bindings::BluetoothBinding::{BluetoothMethods, BluetoothRequestDeviceFilter};
use dom::bindings::codegen::Bindings::BluetoothBinding::{self, RequestDeviceOptions};
