...
impl WebGLRenderbuffer {
    ...
    pub fn maybe_new(global: GlobalRef, renderer: Sender<CanvasMsg>) -> Option<Temporary<WebGLRenderbuffer>> {
    ...
    pub fn new(global: GlobalRef, renderer: Sender<CanvasMsg>, id: u32) -> Temporary<WebGLRenderbuffer> {
