...
impl WebGLRenderingContextMethods for WebGLRenderingContext {
    ...
    #[allow(unsafe_code)]
    // https://www.khronos.org/registry/webgl/specs/latest/1.0/#5.14.8
    fn CompressedTexImage2D(&self, _cx: *mut JSContext, target: u32, _level: i32, _internal_format: u32,
    ...
    #[allow(unsafe_code)]
    // https://www.khronos.org/registry/webgl/specs/latest/1.0/#5.14.8
    fn CompressedTexSubImage2D(&self, _cx: *mut JSContext, target: u32, _level: i32,
