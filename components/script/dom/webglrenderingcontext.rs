...
macro_rules! object_binding_to_js {
...
impl WebGLRenderingContextMethods for WebGLRenderingContext {
    ...
    fn GetParameter(&self, cx: *mut JSContext, parameter: u32) -> JSVal {
        ...
        match parameter {
            constants::ARRAY_BUFFER_BINDING => return object_binding_to_js!(cx, &self.bound_buffer_array),
            constants::ELEMENT_ARRAY_BUFFER_BINDING => return object_binding_to_js!(cx, &self.bound_buffer_element_array),
            constants::FRAMEBUFFER_BINDING => return object_binding_to_js!(cx, &self.bound_framebuffer),
            constants::RENDERBUFFER_BINDING => return object_binding_to_js!(cx, &self.bound_renderbuffer),
            constants::TEXTURE_BINDING_2D => return object_binding_to_js!(cx, &self.bound_texture_2d),
            constants::TEXTURE_BINDING_CUBE_MAP => return object_binding_to_js!(cx, &self.bound_texture_cube_map),
            _ => {}
        }
