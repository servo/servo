...
pub struct WebGLRenderingContext {
    ...
    global: GlobalField,
    // TODO(pcwalton): Remove me. Only the privileged chrome process should have this.
    in_process_renderer: Sender<CanvasMsg>,
...
impl WebGLRenderingContext {
    fn new_inherited(global: GlobalRef,
        ...
        let (ipc_renderer, in_process_renderer) = try!(WebGLPaintTask::start(size, attrs));
        Ok(WebGLRenderingContext {
            reflector_: Reflector::new(),
            global: GlobalField::from_rooted(&global),
            in_process_renderer: in_process_renderer,
...
pub trait LayoutCanvasWebGLRenderingContextHelpers {
    #[allow(unsafe_code)]
    unsafe fn get_in_process_renderer(&self) -> Sender<CanvasMsg>;
    #[allow(unsafe_code)]
...
impl LayoutCanvasWebGLRenderingContextHelpers for LayoutJS<WebGLRenderingContext> {
    #[allow(unsafe_code)]
    unsafe fn get_in_process_renderer(&self) -> Sender<CanvasMsg> {
        (*self.unsafe_get()).in_process_renderer.clone()
    }
    #[allow(unsafe_code)]
    unsafe fn get_ipc_renderer(&self) -> IpcSender<CanvasMsg> {
