...
/// An "object" implementing the spec’s IDBVersionChangeEvent interface:
/// <https://w3c.github.io/IndexedDB/#idbversionchangeevent>.
///
/// The IDBVersionChangeEvent interface represents a version change event
/// which can be fired at connections or requests.
#[dom_struct]
...
impl IDBVersionChangeEventMethods<crate::DomTypeHolder> for IDBVersionChangeEvent {
    ...
    /// <https://w3c.github.io/IndexedDB/#dom-idbversionchangeevent-oldversion>
    fn OldVersion(&self) -> u64 {
        self.old_version
    }

    /// <https://w3c.github.io/IndexedDB/#dom-idbversionchangeevent-newversion>
