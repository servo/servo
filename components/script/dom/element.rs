...
impl LayoutElementHelpers for LayoutJS<Element> {
        ...
        where V: Push<ApplicableDeclarationBlock>
    {
        ...
        if let Some(size) = size {
            let value = specified::Length::Inner(
                specified::LengthInternal::ServoCharacterWidth(specified::CharacterWidth(size)));
            hints.push(from_declaration(
        ...
        match width {
            ...
            LengthOrPercentageOrAuto::Length(length) => {
                let width_value = specified::LengthOrPercentageOrAuto::Length(
                    specified::Length::Inner(specified::LengthInternal::Absolute(length)));
                hints.push(from_declaration(
                    PropertyDeclaration::Width(DeclaredValue::Value(width_value))));
            }
        }
        ...
        if let Some(cols) = cols {
            ...
            let value = specified::Length::Inner(
                specified::LengthInternal::ServoCharacterWidth(specified::CharacterWidth(cols)));
            hints.push(from_declaration(
                PropertyDeclaration::Width(DeclaredValue::Value(
                    specified::LengthOrPercentageOrAuto::Length(value)))));
        }
        ...
        if let Some(rows) = rows {
            ...
            let value = specified::Length::Inner(
                specified::LengthInternal::FontRelative(specified::FontRelativeLength::Em(rows as CSSFloat)));
            hints.push(from_declaration(
