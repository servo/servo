...
pub trait RawLayoutElementHelpers {
    unsafe fn get_attr_val_for_layout<'a>(&'a self, namespace: &Atom, name: &str) -> Option<&'a str>;
...
impl RawLayoutElementHelpers for Element {
    ...
    unsafe fn get_attr_val_for_layout<'a>(&'a self, namespace: &Atom, name: &str)
                                          -> Option<&'a str> {
...
impl<'a> ElementMethods for JSRef<'a, Element> {
    ...
    fn GetAttributeNS(self,
        ...
        let namespace = Atom::from_option_domstring(&namespace);
    ...
    fn SetAttributeNS(self,
        ...
        // Step 1.
        let namespace = Atom::from_option_domstring(&namespace_url);
...
impl<'a> style::TElement<'a> for JSRef<'a, Element> {
    fn get_attr(&self, namespace: &Atom, attr: &str) -> Option<&'a str> {
    ...
    fn get_namespace<'b>(&'b self) -> &'b Atom {
