...
impl Element {
    ...
    pub fn style_attribute<'a>(&'a self) -> &'a DOMRefCell<Option<PropertyDeclarationBlock>> {
    ...
    pub fn get_inline_style_declaration<'a>(&'a self, property: &Atom) -> Option<Ref<'a, PropertyDeclaration>> {
    ...
    pub fn get_important_inline_style_declaration<'a>(&'a self, property: &Atom) -> Option<Ref<'a, PropertyDeclaration>> {
        Ref::filter_map(self.style_attribute.borrow(), |inline_declarations| {
            inline_declarations.as_ref().and_then(|declarations| {
