...
impl PerformanceTimingMethods for PerformanceTiming {
    ...
    // https://www.w3.org/TR/navigation-timing/#dom-performancetiming-domloading
    fn DomLoading(&self) -> u64 {
        self.document.get_dom_loading()
    }

    // https://www.w3.org/TR/navigation-timing/#dom-performancetiming-dominteractive
    fn DomInteractive(&self) -> u64 {
        self.document.get_dom_interactive()
    }

    // https://www.w3.org/TR/navigation-timing/#dom-performancetiming-domcontenteventstart
    fn DomContentLoadedEventStart(&self) -> u64 {
        self.document.get_dom_content_loaded_event_start()
    }

    // https://www.w3.org/TR/navigation-timing/#dom-performancetiming-domcontenteventend
