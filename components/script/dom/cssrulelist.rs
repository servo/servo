...
use dom_struct::dom_/* This Source Code Form is subject to the terms of the Mozilla Public
 * License, v. 2.0. If a copy of the MPL was not distributed with this
 * file, You can obtain one at https://mozilla.org/MPL/2.0/. */
...
impl CSSRuleList {
    ...
    pub fn insert_rule(&self, rule: &str, idx: u32, nested: bool) -> Fallible<u32> {
        ...
        let owner = self.parent_stylesheet.get_owner().downcast::<HTMLElement>().unwrap();
