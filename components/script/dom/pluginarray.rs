...
impl PluginArrayMethods for PluginArray {
    // https://html.spec.whatwg.org/multipage/webappapis.html#dom-pluginarray-refresh
    fn Refresh(&self, _reload: bool) {

    }

    // https://html.spec.whatwg.org/multipage/webappapis.html#dom-pluginarray-length
    fn Length(&self) -> u32 {
        0
    }

    // https://html.spec.whatwg.org/multipage/webappapis.html#dom-pluginarray-item
    fn Item(&self, _index: u32) -> Option<Root<Plugin>> {
        None
    }

    // https://html.spec.whatwg.org/multipage/webappapis.html#dom-pluginarray-nameditem
