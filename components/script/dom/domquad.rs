...
use dom::bindings::js::{Root, RootedReference, JS, MutHeap};
...
fn create_bound(p1: &DOMPointInit, p2: &DOMPointInit, p3: &DOMPointInit,
    p4: &DOMPointInit) -> DOMRectReadOnly {
...
impl DOMQuad {
    fn new_inherited(global: GlobalRef,
        ...
        DOMQuad {
            ...
            p1: MutHeap::new(JS::from_ref(&DOMPoint::from_init(&p1))),
            p2: MutHeap::new(JS::from_ref(&DOMPoint::from_init(&p2))),
            p3: MutHeap::new(JS::from_ref(&DOMPoint::from_init(&p3))),
            p4: MutHeap::new(JS::from_ref(&DOMPoint::from_init(&p4))),
    ...
    pub fn SetP1(&mut self, p1: DOMPoint) {
        *self.p1 = p1;
        self.bounds = JS::from_ref(&create_bound_from_point(&self.p1, &self.p2, &self.p3, &self.p4));
    }

    // https://drafts.fxtf.org/geometry/#dom-domquad-p2
    pub fn SetP2(&mut self, p2: DOMPoint) {
        *self.p2 = p2;
        self.bounds = JS::from_ref(&create_bound_from_point(&self.p1, &self.p2, &self.p3, &self.p4));
    }

    // https://drafts.fxtf.org/geometry/#dom-domquad-p3
    pub fn SetP3(&mut self, p3: DOMPoint) {
        *self.p3 = p3;
        self.bounds = JS::from_ref(&create_bound_from_point(&self.p1, &self.p2, &self.p3, &self.p4));
    }

    // https://drafts.fxtf.org/geometry/#dom-domquad-p4
    pub fn SetP4(&mut self, p4: DOMPoint) {
        *self.p4 = p4;
        self.bounds = JS::from_ref(&create_bound_from_point(&self.p1, &self.p2, &self.p3, &self.p4));
    }
}
