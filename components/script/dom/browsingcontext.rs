...
impl BrowsingContext {
    fn new_inherited(currently_active: Option<PipelineId>,
               ...
               -> Root<BrowsingContext>
    {
        unsafe {
            ...
            let mut browsing_context = box BrowsingContext::new_inherited(currently_active, frame_element, parent);
                                 ...
                                 -> Root<BrowsingContext>
    {
        unsafe {
            ...
            // Create a new browsing context.
            let mut browsing_context = box BrowsingContext::new_inherited(None, None, parent);
