...
pub struct WebGLContextEvent {
    event: Event,
    status_message: DOMRefCell<DOMString>,
}
...
impl WebGLContextEvent {
    pub fn new_inherited(type_id: EventTypeId) -> WebGLContextEvent {
        WebGLContextEvent {
            event: Event::new_inherited(type_id),
            status_message: DOMRefCell::new("".to_owned()),
        }
    }

    pub fn new_uninitialized(global: GlobalRef) -> Root<WebGLContextEvent> {
        reflect_dom_object(box WebGLContextEvent::new_inherited(EventTypeId::WebGLContextEvent),
                           global,
    ...
    pub fn new(global: GlobalRef,
        ...
        let event = WebGLContextEvent::new_uninitialized(global);
        ...
        *event.status_message.borrow_mut() = status_message;
        event
    }
