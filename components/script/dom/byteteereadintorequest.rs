...
impl ByteTeeReadIntoRequest {
    ...
    pub(crate) fn chunk_steps(&self, chunk: HeapBufferSource<ArrayBufferViewU8>, can_gc: CanGc)  {
        let cx = GlobalScope::get_cx();
    ...
    pub(crate) fn close_steps(&self, chunk: HeapBufferSource<ArrayBufferViewU8>, can_gc: CanGc) {
        let cx = GlobalScope::get_cx();
