...
impl<TH: TypeHolderTrait> WindowProxy<TH> {
    ...
    pub unsafe fn opener(&self, cx: *mut JSContext) -> JSVal {
        ...
        let opener_proxy = match ScriptThread::<TH>::find_window_proxy(opener_id) {
            ...
            None => {
                ...
                match ScriptThread::<TH>::get_top_level_for_browsing_context(
                    sender_pipeline_id,
                    opener_id,
                ) {
                    Some(opener_top_id) => {
    ...
    pub fn choose_browsing_context(
        ...
        name: DOMString,
        noopener: bool,
    ) -> (Option<DomRoot<WindowProxy<TH>>>, bool) {
...
unsafe fn GetSubframeWindowProxy<TH: TypeHolderTrait>(
    ...
    if let Some(index) = index {
        ...
        if let Ok(win) = root_from_handleobject::<Window<TH>>(target.handle()) {
            ...
            root_from_handleobject::<DissimilarOriginWindow<TH>>(target.handle())
        {
            let browsing_context_id = win.window_proxy().browsing_context_id();
            let (result_sender, result_receiver) = ipc::channel().unwrap();
...
#[allow(unsafe_code)]
unsafe extern "C" fn getOwnPropertyDescriptor<TH: TypeHolderTrait>(
    cx: *mut JSContext,
    proxy: RawHandleObject,
    id: RawHandleId,
...
#[allow(unsafe_code)]
unsafe extern "C" fn has<TH: TypeHolderTrait>(
    cx: *mut JSContext,
    proxy: RawHandleObject,
    id: RawHandleId,
    bp: *mut bool,
...
#[allow(unsafe_code)]
unsafe extern "C" fn get<TH: TypeHolderTrait>(
    cx: *mut JSContext,
    proxy: RawHandleObject,
...
#[allow(unsafe_code)]
unsafe extern "C" fn has_xorigin<TH: TypeHolderTrait>(
    cx: *mut JSContext,
    proxy: RawHandleObject,
    id: RawHandleId,
    bp: *mut bool,
...
#[allow(unsafe_code)]
unsafe extern "C" fn get_xorigin<TH: TypeHolderTrait>(
    cx: *mut JSContext,
    proxy: RawHandleObject,
    receiver: RawHandleValue,
    id: RawHandleId,
...
#[allow(unsafe_code)]
unsafe extern "C" fn set_xorigin<TH: TypeHolderTrait>(
    cx: *mut JSContext,
    _: RawHandleObject,
    _: RawHandleId,
    _: RawHandleValue,
...
#[allow(unsafe_code)]
unsafe extern "C" fn delete_xorigin<TH: TypeHolderTrait>(
    cx: *mut JSContext,
    _: RawHandleObject,
    _: RawHandleId,
    _: *mut ObjectOpResult,
...
#[allow(unsafe_code)]
unsafe extern "C" fn getOwnPropertyDescriptor_xorigin<TH: TypeHolderTrait>(
    cx: *mut JSContext,
    proxy: RawHandleObject,
    id: RawHandleId,
...
#[allow(unsafe_code)]
unsafe extern "C" fn defineProperty_xorigin<TH: TypeHolderTrait>(
    cx: *mut JSContext,
    _: RawHandleObject,
    _: RawHandleId,
...
#[allow(unsafe_code)]
unsafe extern "C" fn preventExtensions_xorigin<TH: TypeHolderTrait>(
    cx: *mut JSContext,
    _: RawHandleObject,
    _: *mut ObjectOpResult,
) -> bool {
...
#[allow(unsafe_code)]
unsafe extern "C" fn finalize<TH: TypeHolderTrait>(_fop: *mut JSFreeOp, obj: *mut JSObject) {
    let mut slot = UndefinedValue();
    GetProxyReservedSlot(obj, 0, &mut slot);
    let this = slot.to_private() as *mut WindowProxy<TH>;
    if this.is_null() {
...
#[allow(unsafe_code)]
unsafe extern "C" fn trace<TH: TypeHolderTrait>(trc: *mut JSTracer, obj: *mut JSObject) {
    let mut slot = UndefinedValue();
    GetProxyReservedSlot(obj, 0, &mut slot);
    let this = slot.to_private() as *const WindowProxy<TH>;
    if this.is_null() {
        // GC during obj creation or after transplanting.
        return;
    }
