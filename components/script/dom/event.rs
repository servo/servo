...
// See dispatch_event.
// https://dom.spec.whatwg.org/#concept-event-dispatch
fn dispatch_to_listeners<TH: TypeHolderTrait>(
    event: &Event<TH>,
    target: &EventTarget<TH>,
    event_path: &[&EventTarget<TH>],
) {
...
fn invoke<TH: TypeHolderTrait>(
    window: Option<&Window<TH>>,
...
fn inner_invoke<TH: TypeHolderTrait>(
    window: Option<&Window<TH>>,
    object: &EventTarget<TH>,
    event: &Event<TH>,
