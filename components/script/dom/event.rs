...
impl Event {
    pub fn new_inherited() -> Event {
        Event {
            ...
            type_atom: DOMRefCell::new(Atom::from_slice("")),
...
impl EventMethods for Event {
    ...
    fn Type(&self) -> DOMString {
        (*self.type_atom.borrow()).as_slice().to_owned()
    }
    ...
    fn InitEvent(&self,
        ...
        *self.type_atom.borrow_mut() = Atom::from_slice(&type_);
