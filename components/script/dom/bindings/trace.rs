...
use js::rust::Runtime;
use libc;
use msg::constellation_msg::{FrameId, FrameType, HistoryStateId, PipelineId, ReferrerPolicy, WindowSizeType};
...
no_jsmanaged_fields!(FrameId, FrameType, HistoryStateId, WindowSizeData, WindowSizeType, PipelineId);
