...
use canvas_traits::webgl::{WebGLChan, WebGLContextLimits, WebGLContextShareMode, WebGLError, WebGLPipeline};
use canvas_traits::webgl::{WebGLMsgSender, WebGLReceiver, WebGLSender, WebGLShaderId, WebGLTextureId};
use canvas_traits::webgl::{WebGLSLVersion, WebGLVersion, WebGLVertexArrayId};
use cssparser::RGBA;
...
unsafe_no_jsmanaged_fields!(WebGLError, WebGLContextLimits);
