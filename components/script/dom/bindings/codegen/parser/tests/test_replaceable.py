...
<html lang="en-US">
  ...
  <link rel="shortcut icon" href="/static/icons/mimetypes/py.5ef6367a.png" />
    ...
    <title>test_replaceable.py - DXR</title>
  ...
  <div class="breadcrumbs"><a href="/mozilla-central/source">mozilla-central</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom">dom</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings">bindings</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings/parser">parser</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings/parser/tests">tests</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings/parser/tests/test_replaceable.py">test_replaceable.py</a></div>
    ...
    <section id="tree-selector" class="tree-selector">
      ...
      <div class="select-options ts-modal" aria-expanded="false">
        ...
        <ul class="selector-options" tabindex="-1">
            ...
            <li>
              <a href="/build-central/parallel/dom/bindings/parser/tests/test_replaceable.py" >
            ...
            <li>
              <a href="/comm-central/parallel/dom/bindings/parser/tests/test_replaceable.py" >
            ...
            <li>
              <a href="/hgcustom_version-control-tools/parallel/dom/bindings/parser/tests/test_replaceable.py" >
            ...
            <li>
              <a href="/mozilla-central/parallel/dom/bindings/parser/tests/test_replaceable.py" class="selected" aria-checked="true">
            ...
            <li>
              <a href="/nss/parallel/dom/bindings/parser/tests/test_replaceable.py" >
            ...
            <li>
              <a href="/rust/parallel/dom/bindings/parser/tests/test_replaceable.py" >
            ...
            <li>
              <a href="/rustfmt/parallel/dom/bindings/parser/tests/test_replaceable.py" >
    ...
    <div class="panel">
      ...
      <section id="panel-content" aria-expanded="true" aria-hidden="false">
          ...
          <ul>
              ...
              <li>
                <a href="/mozilla-central/rev/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_replaceable.py" title="Permalink" class="permalink icon">Permalink</a>
              </li>
          </ul>
          ...
          <ul>
              ...
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/filelog/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_replaceable.py" title="Log" class="log icon">Log</a>
              </li>
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/annotate/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_replaceable.py" title="Blame" class="blame icon">Blame</a>
              </li>
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/diff/59e7253e901c152e334599a2d8a03547aeba19a9/dom/bindings/parser/tests/test_replaceable.py" title="Diff" class="diff icon">Diff</a>
              </li>
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/raw-file/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_replaceable.py" title="Raw" class="raw icon">Raw</a>
              </li>
          </ul>
  ...
  <div id="annotations">
      ...
      <div class="annotation-set" id="aset-58"></div></div>
...
<pre>
<code id="line-1" aria-labelledby="1"><span class="c"># This Source Code Form is subject to the terms of the Mozilla Public</span>
</code><code id="line-2" aria-labelledby="2"><span class="c"># License, v. 2.0. If a copy of the MPL was not distributed with this</span>
</code><code id="line-3" aria-labelledby="3"><span class="c"># file, You can obtain one at <a data-menu="[{&quot;href&quot;: &quot;http://mozilla.org/MPL/2.0/.&quot;, &quot;html&quot;: &quot;Follow link&quot;, &quot;icon&quot;: &quot;external_link&quot;, &quot;title&quot;: &quot;Visit http://mozilla.org/MPL/2.0/.&quot;}]">http://mozilla.org/MPL/2.0/.</a></span>
</code><code id="line-4" aria-labelledby="4">
</code><code id="line-5" aria-labelledby="5"><span class="k">def</span> should_throw(parser, harness, message, code):
</code><code id="line-6" aria-labelledby="6">    parser = parser.reset();
</code><code id="line-7" aria-labelledby="7">    threw = False
</code><code id="line-8" aria-labelledby="8">    <span class="k">try</span>:
</code><code id="line-9" aria-labelledby="9">        parser.parse(code)
</code><code id="line-10" aria-labelledby="10">        parser.finish()
</code><code id="line-11" aria-labelledby="11">    <span class="k">except</span>:
</code><code id="line-12" aria-labelledby="12">        threw = True
</code><code id="line-13" aria-labelledby="13">
</code><code id="line-14" aria-labelledby="14">    harness.ok(threw, <span class="str">"</span><span class="str">Should have thrown: </span><span class="str">%s</span><span class="str">"</span> % message)
</code><code id="line-15" aria-labelledby="15">
</code><code id="line-16" aria-labelledby="16">
</code><code id="line-17" aria-labelledby="17"><span class="k">def</span> WebIDLTest(parser, harness):
</code><code id="line-18" aria-labelledby="18">    <span class="c"># The [Replaceable] extended attribute MUST take no arguments.</span>
</code><code id="line-19" aria-labelledby="19">    should_throw(parser, harness, <span class="str">"</span><span class="str">no arguments</span><span class="str">"</span>, <span class="str">"""</span><span class="str">
</span></code><code id="line-20" aria-labelledby="20"><span class="str">        interface I {</span><span class="str">
</span></code><code id="line-21" aria-labelledby="21"><span class="str">          [Replaceable=X] readonly attribute long A;</span><span class="str">
</span></code><code id="line-22" aria-labelledby="22"><span class="str">        };</span><span class="str">
</span></code><code id="line-23" aria-labelledby="23"><span class="str">    </span><span class="str">"""</span>)
</code><code id="line-24" aria-labelledby="24">
</code><code id="line-25" aria-labelledby="25">    <span class="c"># An attribute with the [Replaceable] extended attribute MUST NOT also be</span>
</code><code id="line-26" aria-labelledby="26">    <span class="c"># declared with the [PutForwards] extended attribute.</span>
</code><code id="line-27" aria-labelledby="27">    should_throw(parser, harness, <span class="str">"</span><span class="str">PutForwards</span><span class="str">"</span>, <span class="str">"""</span><span class="str">
</span></code><code id="line-28" aria-labelledby="28"><span class="str">        interface I {</span><span class="str">
</span></code><code id="line-29" aria-labelledby="29"><span class="str">          [PutForwards=B, Replaceable] readonly attribute J A;</span><span class="str">
</span></code><code id="line-30" aria-labelledby="30"><span class="str">        };</span><span class="str">
</span></code><code id="line-31" aria-labelledby="31"><span class="str">        interface J {</span><span class="str">
</span></code><code id="line-32" aria-labelledby="32"><span class="str">          attribute long B;</span><span class="str">
</span></code><code id="line-33" aria-labelledby="33"><span class="str">        };</span><span class="str">
</span></code><code id="line-34" aria-labelledby="34"><span class="str">    </span><span class="str">"""</span>)
</code><code id="line-35" aria-labelledby="35">
</code><code id="line-36" aria-labelledby="36">    <span class="c"># The [Replaceable] extended attribute MUST NOT be used on an attribute</span>
</code><code id="line-37" aria-labelledby="37">    <span class="c"># that is not read only.</span>
</code><code id="line-38" aria-labelledby="38">    should_throw(parser, harness, <span class="str">"</span><span class="str">writable attribute</span><span class="str">"</span>, <span class="str">"""</span><span class="str">
</span></code><code id="line-39" aria-labelledby="39"><span class="str">        interface I {</span><span class="str">
</span></code><code id="line-40" aria-labelledby="40"><span class="str">          [Replaceable] attribute long A;</span><span class="str">
</span></code><code id="line-41" aria-labelledby="41"><span class="str">        };</span><span class="str">
</span></code><code id="line-42" aria-labelledby="42"><span class="str">    </span><span class="str">"""</span>)
</code><code id="line-43" aria-labelledby="43">
</code><code id="line-44" aria-labelledby="44">    <span class="c"># The [Replaceable] extended attribute MUST NOT be used on a static</span>
</code><code id="line-45" aria-labelledby="45">    <span class="c"># attribute.</span>
</code><code id="line-46" aria-labelledby="46">    should_throw(parser, harness, <span class="str">"</span><span class="str">static attribute</span><span class="str">"</span>, <span class="str">"""</span><span class="str">
</span></code><code id="line-47" aria-labelledby="47"><span class="str">        interface I {</span><span class="str">
</span></code><code id="line-48" aria-labelledby="48"><span class="str">          [Replaceable] static readonly attribute long A;</span><span class="str">
</span></code><code id="line-49" aria-labelledby="49"><span class="str">        };</span><span class="str">
</span></code><code id="line-50" aria-labelledby="50"><span class="str">    </span><span class="str">"""</span>)
</code><code id="line-51" aria-labelledby="51">
</code><code id="line-52" aria-labelledby="52">    <span class="c"># The [Replaceable] extended attribute MUST NOT be used on an attribute</span>
</code><code id="line-53" aria-labelledby="53">    <span class="c"># declared on a callback interface.</span>
</code><code id="line-54" aria-labelledby="54">    should_throw(parser, harness, <span class="str">"</span><span class="str">callback interface</span><span class="str">"</span>, <span class="str">"""</span><span class="str">
</span></code><code id="line-55" aria-labelledby="55"><span class="str">        callback interface I {</span><span class="str">
</span></code><code id="line-56" aria-labelledby="56"><span class="str">          [Replaceable] readonly attribute long A;</span><span class="str">
</span></code><code id="line-57" aria-labelledby="57"><span class="str">        };</span><span class="str">
</span></code><code id="line-58" aria-labelledby="58"><span class="str">    </span><span class="str">"""</span>)
</code></pre>
        </td>
      </tr>
    </tbody>
