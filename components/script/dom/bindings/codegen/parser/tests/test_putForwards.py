...
<html lang="en-US">
  ...
  <link rel="shortcut icon" href="/static/icons/mimetypes/py.5ef6367a.png" />
    ...
    <title>test_putForwards.py - DXR</title>
  ...
  <div class="breadcrumbs"><a href="/mozilla-central/source">mozilla-central</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom">dom</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings">bindings</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings/parser">parser</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings/parser/tests">tests</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings/parser/tests/test_putForwards.py">test_putForwards.py</a></div>
    ...
    <section id="tree-selector" class="tree-selector">
      ...
      <div class="select-options ts-modal" aria-expanded="false">
        ...
        <ul class="selector-options" tabindex="-1">
            ...
            <li>
              <a href="/build-central/parallel/dom/bindings/parser/tests/test_putForwards.py" >
            ...
            <li>
              <a href="/comm-central/parallel/dom/bindings/parser/tests/test_putForwards.py" >
            ...
            <li>
              <a href="/hgcustom_version-control-tools/parallel/dom/bindings/parser/tests/test_putForwards.py" >
            ...
            <li>
              <a href="/mozilla-central/parallel/dom/bindings/parser/tests/test_putForwards.py" class="selected" aria-checked="true">
            ...
            <li>
              <a href="/nss/parallel/dom/bindings/parser/tests/test_putForwards.py" >
            ...
            <li>
              <a href="/rust/parallel/dom/bindings/parser/tests/test_putForwards.py" >
            ...
            <li>
              <a href="/rustfmt/parallel/dom/bindings/parser/tests/test_putForwards.py" >
    ...
    <div class="panel">
      ...
      <section id="panel-content" aria-expanded="true" aria-hidden="false">
          ...
          <ul>
              ...
              <li>
                <a href="/mozilla-central/rev/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_putForwards.py" title="Permalink" class="permalink icon">Permalink</a>
              </li>
          </ul>
          ...
          <ul>
              ...
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/filelog/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_putForwards.py" title="Log" class="log icon">Log</a>
              </li>
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/annotate/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_putForwards.py" title="Blame" class="blame icon">Blame</a>
              </li>
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/diff/461978f9a844c3418db9d639d27739951be433e6/dom/bindings/parser/tests/test_putForwards.py" title="Diff" class="diff icon">Diff</a>
              </li>
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/raw-file/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_putForwards.py" title="Raw" class="raw icon">Raw</a>
              </li>
          </ul>
  ...
  <div id="annotations">
      ...
      <div class="annotation-set" id="aset-107"></div></div>
...
</span></code><code id="line-5" aria-labelledby="5"><span class="str">            interface I {</span><span class="str">
</span></code><code id="line-6" aria-labelledby="6"><span class="str">              [PutForwards=B] readonly attribute long A;</span><span class="str">
...
</code><code id="line-14" aria-labelledby="14">    harness.ok(threw, <span class="str">"</span><span class="str">Should have thrown.</span><span class="str">"</span>)
</code><code id="line-15" aria-labelledby="15">
</code><code id="line-16" aria-labelledby="16">    parser = parser.reset();
...
</span></code><code id="line-21" aria-labelledby="21"><span class="str">              [PutForwards=B] readonly attribute J A;</span><span class="str">
</span></code><code id="line-22" aria-labelledby="22"><span class="str">            };</span><span class="str">
</span></code><code id="line-23" aria-labelledby="23"><span class="str">            interface J {</span><span class="str">
</span></code><code id="line-24" aria-labelledby="24"><span class="str">            };</span><span class="str">
</span></code><code id="line-25" aria-labelledby="25"><span class="str">        </span><span class="str">"""</span>)
...
</code><code id="line-31" aria-labelledby="31">    harness.ok(threw, <span class="str">"</span><span class="str">Should have thrown.</span><span class="str">"</span>)
</code><code id="line-32" aria-labelledby="32">
</code><code id="line-33" aria-labelledby="33">    parser = parser.reset();
</code><code id="line-34" aria-labelledby="34">    threw = False
</code><code id="line-35" aria-labelledby="35">    <span class="k">try</span>:
</code><code id="line-36" aria-labelledby="36">        parser.parse(<span class="str">"""</span><span class="str">
</span></code><code id="line-37" aria-labelledby="37"><span class="str">            interface I {</span><span class="str">
</span></code><code id="line-38" aria-labelledby="38"><span class="str">              [PutForwards=B] attribute J A;</span><span class="str">
</span></code><code id="line-39" aria-labelledby="39"><span class="str">            };</span><span class="str">
</span></code><code id="line-40" aria-labelledby="40"><span class="str">            interface J {</span><span class="str">
</span></code><code id="line-41" aria-labelledby="41"><span class="str">              attribute long B;</span><span class="str">
...
</code><code id="line-49" aria-labelledby="49">    harness.ok(threw, <span class="str">"</span><span class="str">Should have thrown.</span><span class="str">"</span>)
</code><code id="line-50" aria-labelledby="50">
</code><code id="line-51" aria-labelledby="51">    parser = parser.reset();
</code><code id="line-52" aria-labelledby="52">    threw = False
</code><code id="line-53" aria-labelledby="53">    <span class="k">try</span>:
</code><code id="line-54" aria-labelledby="54">        parser.parse(<span class="str">"""</span><span class="str">
</span></code><code id="line-55" aria-labelledby="55"><span class="str">            interface I {</span><span class="str">
</span></code><code id="line-56" aria-labelledby="56"><span class="str">              [PutForwards=B] static readonly attribute J A;</span><span class="str">
</span></code><code id="line-57" aria-labelledby="57"><span class="str">            };</span><span class="str">
</span></code><code id="line-58" aria-labelledby="58"><span class="str">            interface J {</span><span class="str">
</span></code><code id="line-59" aria-labelledby="59"><span class="str">              attribute long B;</span><span class="str">
...
</code><code id="line-67" aria-labelledby="67">    harness.ok(threw, <span class="str">"</span><span class="str">Should have thrown.</span><span class="str">"</span>)
</code><code id="line-68" aria-labelledby="68">
</code><code id="line-69" aria-labelledby="69">    parser = parser.reset();
</code><code id="line-70" aria-labelledby="70">    threw = False
</code><code id="line-71" aria-labelledby="71">    <span class="k">try</span>:
</code><code id="line-72" aria-labelledby="72">        parser.parse(<span class="str">"""</span><span class="str">
</span></code><code id="line-73" aria-labelledby="73"><span class="str">            callback interface I {</span><span class="str">
</span></code><code id="line-74" aria-labelledby="74"><span class="str">              [PutForwards=B] readonly attribute J A;</span><span class="str">
</span></code><code id="line-75" aria-labelledby="75"><span class="str">            };</span><span class="str">
</span></code><code id="line-76" aria-labelledby="76"><span class="str">            interface J {</span><span class="str">
</span></code><code id="line-77" aria-labelledby="77"><span class="str">              attribute long B;</span><span class="str">
</span></code><code id="line-78" aria-labelledby="78"><span class="str">            };</span><span class="str">
</span></code><code id="line-79" aria-labelledby="79"><span class="str">        </span><span class="str">"""</span>)
</code><code id="line-80" aria-labelledby="80">
</code><code id="line-81" aria-labelledby="81">        results = parser.finish()
</code><code id="line-82" aria-labelledby="82">    <span class="k">except</span>:
</code><code id="line-83" aria-labelledby="83">        threw = True
</code><code id="line-84" aria-labelledby="84">
</code><code id="line-85" aria-labelledby="85">    harness.ok(threw, <span class="str">"</span><span class="str">Should have thrown.</span><span class="str">"</span>)
...
</span></code><code id="line-91" aria-labelledby="91"><span class="str">            interface I {</span><span class="str">
</span></code><code id="line-92" aria-labelledby="92"><span class="str">              [PutForwards=C] readonly attribute J A;</span><span class="str">
</span></code><code id="line-93" aria-labelledby="93"><span class="str">              [PutForwards=C] readonly attribute J B;</span><span class="str">
</span></code><code id="line-94" aria-labelledby="94"><span class="str">            };</span><span class="str">
</span></code><code id="line-95" aria-labelledby="95"><span class="str">            interface J {</span><span class="str">
</span></code><code id="line-96" aria-labelledby="96"><span class="str">              [PutForwards=D] readonly attribute K C;</span><span class="str">
</span></code><code id="line-97" aria-labelledby="97"><span class="str">            };</span><span class="str">
</span></code><code id="line-98" aria-labelledby="98"><span class="str">            interface K {</span><span class="str">
</span></code><code id="line-99" aria-labelledby="99"><span class="str">              [PutForwards=A] readonly attribute I D;</span><span class="str">
</span></code><code id="line-100" aria-labelledby="100"><span class="str">            };</span><span class="str">
</span></code><code id="line-101" aria-labelledby="101"><span class="str">        </span><span class="str">"""</span>)
</code><code id="line-102" aria-labelledby="102">
</code><code id="line-103" aria-labelledby="103">        results = parser.finish()
</code><code id="line-104" aria-labelledby="104">    <span class="k">except</span>:
</code><code id="line-105" aria-labelledby="105">        threw = True
</code><code id="line-106" aria-labelledby="106">
</code><code id="line-107" aria-labelledby="107">    harness.ok(threw, <span class="str">"</span><span class="str">Should have thrown.</span><span class="str">"</span>)
</code></pre>
        </td>
      </tr>
    </tbody>
