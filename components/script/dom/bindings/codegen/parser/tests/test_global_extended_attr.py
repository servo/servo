...
<html lang="en-US">
  ...
  <link rel="shortcut icon" href="/static/icons/mimetypes/py.5ef6367a.png" />
    ...
    <title>test_global_extended_attr.py - DXR</title>
  ...
  <div class="breadcrumbs"><a href="/mozilla-central/source">mozilla-central</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom">dom</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings">bindings</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings/parser">parser</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings/parser/tests">tests</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings/parser/tests/test_global_extended_attr.py">test_global_extended_attr.py</a></div>
    ...
    <section id="tree-selector" class="tree-selector">
      ...
      <div class="select-options ts-modal" aria-expanded="false">
        ...
        <ul class="selector-options" tabindex="-1">
            ...
            <li>
              <a href="/build-central/parallel/dom/bindings/parser/tests/test_global_extended_attr.py" >
            ...
            <li>
              <a href="/comm-central/parallel/dom/bindings/parser/tests/test_global_extended_attr.py" >
            ...
            <li>
              <a href="/hgcustom_version-control-tools/parallel/dom/bindings/parser/tests/test_global_extended_attr.py" >
            ...
            <li>
              <a href="/mozilla-central/parallel/dom/bindings/parser/tests/test_global_extended_attr.py" class="selected" aria-checked="true">
            ...
            <li>
              <a href="/nss/parallel/dom/bindings/parser/tests/test_global_extended_attr.py" >
            ...
            <li>
              <a href="/rust/parallel/dom/bindings/parser/tests/test_global_extended_attr.py" >
            ...
            <li>
              <a href="/rustfmt/parallel/dom/bindings/parser/tests/test_global_extended_attr.py" >
    ...
    <div class="panel">
      ...
      <section id="panel-content" aria-expanded="true" aria-hidden="false">
          ...
          <ul>
              ...
              <li>
                <a href="/mozilla-central/rev/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_global_extended_attr.py" title="Permalink" class="permalink icon">Permalink</a>
              </li>
          </ul>
          ...
          <ul>
              ...
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/filelog/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_global_extended_attr.py" title="Log" class="log icon">Log</a>
              </li>
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/annotate/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_global_extended_attr.py" title="Blame" class="blame icon">Blame</a>
              </li>
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/diff/542cba368cc621bcc394da9f245b3879b286ad61/dom/bindings/parser/tests/test_global_extended_attr.py" title="Diff" class="diff icon">Diff</a>
              </li>
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/raw-file/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_global_extended_attr.py" title="Raw" class="raw icon">Raw</a>
              </li>
          </ul>
  ...
  <div id="annotations">
      ...
      <div class="annotation-set" id="aset-122"></div></div>
...
</span></code><code id="line-3" aria-labelledby="3"><span class="str">      [Global]</span><span class="str">
</span></code><code id="line-4" aria-labelledby="4"><span class="str">      interface Foo : Bar {</span><span class="str">
</span></code><code id="line-5" aria-labelledby="5"><span class="str">        getter any(DOMString name);</span><span class="str">
</span></code><code id="line-6" aria-labelledby="6"><span class="str">      };</span><span class="str">
</span></code><code id="line-7" aria-labelledby="7"><span class="str">      interface Bar {};</span><span class="str">
...
</code><code id="line-12" aria-labelledby="12">    harness.ok(results[0].isOnGlobalProtoChain(),
</code><code id="line-13" aria-labelledby="13">               <span class="str">"</span><span class="str">[Global] interface should be on global</span><span class="str">'</span><span class="str">s proto chain</span><span class="str">"</span>)
</code><code id="line-14" aria-labelledby="14">    harness.ok(results[1].isOnGlobalProtoChain(),
</code><code id="line-15" aria-labelledby="15">               <span class="str">"</span><span class="str">[Global] interface should be on global</span><span class="str">'</span><span class="str">s proto chain</span><span class="str">"</span>)
</code><code id="line-16" aria-labelledby="16">
</code><code id="line-17" aria-labelledby="17">    parser = parser.reset()
</code><code id="line-18" aria-labelledby="18">    threw = False
</code><code id="line-19" aria-labelledby="19">    <span class="k">try</span>:
</code><code id="line-20" aria-labelledby="20">        parser.parse(<span class="str">"""</span><span class="str">
</span></code><code id="line-21" aria-labelledby="21"><span class="str">          [Global]</span><span class="str">
</span></code><code id="line-22" aria-labelledby="22"><span class="str">          interface Foo {</span><span class="str">
</span></code><code id="line-23" aria-labelledby="23"><span class="str">            getter any(DOMString name);</span><span class="str">
</span></code><code id="line-24" aria-labelledby="24"><span class="str">            setter void(DOMString name, any arg);</span><span class="str">
</span></code><code id="line-25" aria-labelledby="25"><span class="str">          };</span><span class="str">
</span></code><code id="line-26" aria-labelledby="26"><span class="str">        </span><span class="str">"""</span>)
</code><code id="line-27" aria-labelledby="27">        results = parser.finish()
</code><code id="line-28" aria-labelledby="28">    <span class="k">except</span>:
</code><code id="line-29" aria-labelledby="29">        threw = True
</code><code id="line-30" aria-labelledby="30">
</code><code id="line-31" aria-labelledby="31">    harness.ok(threw,
</code><code id="line-32" aria-labelledby="32">               <span class="str">"</span><span class="str">Should have thrown for [Global] used on an interface with a </span><span class="str">"</span>
</code><code id="line-33" aria-labelledby="33">               <span class="str">"</span><span class="str">named setter</span><span class="str">"</span>)
</code><code id="line-34" aria-labelledby="34">
</code><code id="line-35" aria-labelledby="35">    parser = parser.reset()
</code><code id="line-36" aria-labelledby="36">    threw = False
</code><code id="line-37" aria-labelledby="37">    <span class="k">try</span>:
</code><code id="line-38" aria-labelledby="38">        parser.parse(<span class="str">"""</span><span class="str">
</span></code><code id="line-39" aria-labelledby="39"><span class="str">          [Global]</span><span class="str">
</span></code><code id="line-40" aria-labelledby="40"><span class="str">          interface Foo {</span><span class="str">
</span></code><code id="line-41" aria-labelledby="41"><span class="str">            getter any(DOMString name);</span><span class="str">
</span></code><code id="line-42" aria-labelledby="42"><span class="str">            creator void(DOMString name, any arg);</span><span class="str">
</span></code><code id="line-43" aria-labelledby="43"><span class="str">          };</span><span class="str">
</span></code><code id="line-44" aria-labelledby="44"><span class="str">        </span><span class="str">"""</span>)
</code><code id="line-45" aria-labelledby="45">        results = parser.finish()
</code><code id="line-46" aria-labelledby="46">    <span class="k">except</span>:
</code><code id="line-47" aria-labelledby="47">        threw = True
</code><code id="line-48" aria-labelledby="48">
</code><code id="line-49" aria-labelledby="49">    harness.ok(threw,
</code><code id="line-50" aria-labelledby="50">               <span class="str">"</span><span class="str">Should have thrown for [Global] used on an interface with a </span><span class="str">"</span>
</code><code id="line-51" aria-labelledby="51">               <span class="str">"</span><span class="str">named creator</span><span class="str">"</span>)
</code><code id="line-52" aria-labelledby="52">
</code><code id="line-53" aria-labelledby="53">    parser = parser.reset()
</code><code id="line-54" aria-labelledby="54">    threw = False
</code><code id="line-55" aria-labelledby="55">    <span class="k">try</span>:
</code><code id="line-56" aria-labelledby="56">        parser.parse(<span class="str">"""</span><span class="str">
</span></code><code id="line-57" aria-labelledby="57"><span class="str">          [Global]</span><span class="str">
</span></code><code id="line-58" aria-labelledby="58"><span class="str">          interface Foo {</span><span class="str">
</span></code><code id="line-59" aria-labelledby="59"><span class="str">            getter any(DOMString name);</span><span class="str">
</span></code><code id="line-60" aria-labelledby="60"><span class="str">            deleter void(DOMString name);</span><span class="str">
...
</code><code id="line-64" aria-labelledby="64">    <span class="k">except</span>:
</code><code id="line-65" aria-labelledby="65">        threw = True
</code><code id="line-66" aria-labelledby="66">
</code><code id="line-67" aria-labelledby="67">    harness.ok(threw,
</code><code id="line-68" aria-labelledby="68">               <span class="str">"</span><span class="str">Should have thrown for [Global] used on an interface with a </span><span class="str">"</span>
</code><code id="line-69" aria-labelledby="69">               <span class="str">"</span><span class="str">named deleter</span><span class="str">"</span>)
</code><code id="line-70" aria-labelledby="70">
</code><code id="line-71" aria-labelledby="71">    parser = parser.reset()
</code><code id="line-72" aria-labelledby="72">    threw = False
</code><code id="line-73" aria-labelledby="73">    <span class="k">try</span>:
</code><code id="line-74" aria-labelledby="74">        parser.parse(<span class="str">"""</span><span class="str">
</span></code><code id="line-75" aria-labelledby="75"><span class="str">          [Global, OverrideBuiltins]</span><span class="str">
</span></code><code id="line-76" aria-labelledby="76"><span class="str">          interface Foo {</span><span class="str">
</span></code><code id="line-77" aria-labelledby="77"><span class="str">          };</span><span class="str">
</span></code><code id="line-78" aria-labelledby="78"><span class="str">        </span><span class="str">"""</span>)
</code><code id="line-79" aria-labelledby="79">        results = parser.finish()
</code><code id="line-80" aria-labelledby="80">    <span class="k">except</span>:
</code><code id="line-81" aria-labelledby="81">        threw = True
</code><code id="line-82" aria-labelledby="82">
</code><code id="line-83" aria-labelledby="83">    harness.ok(threw,
</code><code id="line-84" aria-labelledby="84">               <span class="str">"</span><span class="str">Should have thrown for [Global] used on an interface with a </span><span class="str">"</span>
</code><code id="line-85" aria-labelledby="85">               <span class="str">"</span><span class="str">[OverrideBuiltins]</span><span class="str">"</span>)
</code><code id="line-86" aria-labelledby="86">
</code><code id="line-87" aria-labelledby="87">    parser = parser.reset()
</code><code id="line-88" aria-labelledby="88">    threw = False
</code><code id="line-89" aria-labelledby="89">    <span class="k">try</span>:
</code><code id="line-90" aria-labelledby="90">        parser.parse(<span class="str">"""</span><span class="str">
</span></code><code id="line-91" aria-labelledby="91"><span class="str">          [Global]</span><span class="str">
</span></code><code id="line-92" aria-labelledby="92"><span class="str">          interface Foo : Bar {</span><span class="str">
</span></code><code id="line-93" aria-labelledby="93"><span class="str">          };</span><span class="str">
</span></code><code id="line-94" aria-labelledby="94"><span class="str">          [OverrideBuiltins]</span><span class="str">
</span></code><code id="line-95" aria-labelledby="95"><span class="str">          interface Bar {</span><span class="str">
</span></code><code id="line-96" aria-labelledby="96"><span class="str">          };</span><span class="str">
</span></code><code id="line-97" aria-labelledby="97"><span class="str">        </span><span class="str">"""</span>)
</code><code id="line-98" aria-labelledby="98">        results = parser.finish()
</code><code id="line-99" aria-labelledby="99">    <span class="k">except</span>:
</code><code id="line-100" aria-labelledby="100">        threw = True
</code><code id="line-101" aria-labelledby="101">
</code><code id="line-102" aria-labelledby="102">    harness.ok(threw,
</code><code id="line-103" aria-labelledby="103">               <span class="str">"</span><span class="str">Should have thrown for [Global] used on an interface with an </span><span class="str">"</span>
</code><code id="line-104" aria-labelledby="104">               <span class="str">"</span><span class="str">[OverrideBuiltins] ancestor</span><span class="str">"</span>)
</code><code id="line-105" aria-labelledby="105">
</code><code id="line-106" aria-labelledby="106">    parser = parser.reset()
</code><code id="line-107" aria-labelledby="107">    threw = False
</code><code id="line-108" aria-labelledby="108">    <span class="k">try</span>:
</code><code id="line-109" aria-labelledby="109">        parser.parse(<span class="str">"""</span><span class="str">
</span></code><code id="line-110" aria-labelledby="110"><span class="str">          [Global]</span><span class="str">
</span></code><code id="line-111" aria-labelledby="111"><span class="str">          interface Foo {</span><span class="str">
</span></code><code id="line-112" aria-labelledby="112"><span class="str">          };</span><span class="str">
</span></code><code id="line-113" aria-labelledby="113"><span class="str">          interface Bar : Foo {</span><span class="str">
</span></code><code id="line-114" aria-labelledby="114"><span class="str">          };</span><span class="str">
</span></code><code id="line-115" aria-labelledby="115"><span class="str">        </span><span class="str">"""</span>)
</code><code id="line-116" aria-labelledby="116">        results = parser.finish()
</code><code id="line-117" aria-labelledby="117">    <span class="k">except</span>:
</code><code id="line-118" aria-labelledby="118">        threw = True
</code><code id="line-119" aria-labelledby="119">
</code><code id="line-120" aria-labelledby="120">    harness.ok(threw,
</code><code id="line-121" aria-labelledby="121">               <span class="str">"</span><span class="str">Should have thrown for [Global] used on an interface with a </span><span class="str">"</span>
</code><code id="line-122" aria-labelledby="122">               <span class="str">"</span><span class="str">descendant</span><span class="str">"</span>)
</code></pre>
        </td>
      </tr>
    </tbody>
