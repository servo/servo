...
<html lang="en-US">
  ...
  <div class="breadcrumbs"><a href="/mozilla-central/source">mozilla-central</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom">dom</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings">bindings</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings/parser">parser</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings/parser/tests">tests</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings/parser/tests/test_array.py">test_array.py</a></div>
    ...
    <section id="tree-selector" class="tree-selector">
      ...
      <div class="select-options ts-modal" aria-expanded="false">
        ...
        <ul class="selector-options" tabindex="-1">
            ...
            <li>
              <a href="/build-central/parallel/dom/bindings/parser/tests/test_array.py" >
            ...
            <li>
              <a href="/comm-central/parallel/dom/bindings/parser/tests/test_array.py" >
            ...
            <li>
              <a href="/hgcustom_version-control-tools/parallel/dom/bindings/parser/tests/test_array.py" >
            ...
            <li>
              <a href="/mozilla-central/parallel/dom/bindings/parser/tests/test_array.py" class="selected" aria-checked="true">
            ...
            <li>
              <a href="/nss/parallel/dom/bindings/parser/tests/test_array.py" >
            ...
            <li>
              <a href="/rust/parallel/dom/bindings/parser/tests/test_array.py" >
            ...
            <li>
              <a href="/rustfmt/parallel/dom/bindings/parser/tests/test_array.py" >
    ...
    <div class="panel">
      ...
      <section id="panel-content" aria-expanded="true" aria-hidden="false">
          ...
          <ul>
              ...
              <li>
                <a href="/mozilla-central/rev/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_array.py" title="Permalink" class="permalink icon">Permalink</a>
              </li>
          </ul>
          ...
          <ul>
              ...
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/filelog/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_array.py" title="Log" class="log icon">Log</a>
              </li>
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/annotate/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_array.py" title="Blame" class="blame icon">Blame</a>
              </li>
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/diff/ddf8cdc9d2e3220dac570534b1ff42e9a58bc433/dom/bindings/parser/tests/test_array.py" title="Diff" class="diff icon">Diff</a>
              </li>
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/raw-file/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_array.py" title="Raw" class="raw icon">Raw</a>
              </li>
          </ul>
  ...
  <div id="annotations">
      ...
      <div class="annotation-set" id="aset-18"></div></div>
...
</span></code><code id="line-5" aria-labelledby="5"><span class="str">          dictionary Foo {</span><span class="str">
</span></code><code id="line-6" aria-labelledby="6"><span class="str">            short a;</span><span class="str">
...
</span></code><code id="line-9" aria-labelledby="9"><span class="str">          dictionary Foo1 {</span><span class="str">
</span></code><code id="line-10" aria-labelledby="10"><span class="str">            Foo[] b;</span><span class="str">
</span></code><code id="line-11" aria-labelledby="11"><span class="str">          };</span><span class="str">
</span></code><code id="line-12" aria-labelledby="12"><span class="str">        </span><span class="str">"""</span>)
</code><code id="line-13" aria-labelledby="13">        results = parser.finish()
</code><code id="line-14" aria-labelledby="14">    <span class="k">except</span>:
</code><code id="line-15" aria-labelledby="15">        threw = True
</code><code id="line-16" aria-labelledby="16">
</code><code id="line-17" aria-labelledby="17">    harness.ok(threw, <span class="str">"</span><span class="str">Array must not contain dictionary </span><span class="str">"</span>
</code><code id="line-18" aria-labelledby="18">                      <span class="str">"</span><span class="str">as element type.</span><span class="str">"</span>)
</code></pre>
        </td>
      </tr>
    </tbody>
