...
<html lang="en-US">
  ...
  <link rel="shortcut icon" href="/static/icons/mimetypes/py.5ef6367a.png" />
    ...
    <title>test_mozmap.py - DXR</title>
  ...
  <div class="breadcrumbs"><a href="/mozilla-central/source">mozilla-central</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom">dom</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings">bindings</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings/parser">parser</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings/parser/tests">tests</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings/parser/tests/test_mozmap.py">test_mozmap.py</a></div>
    ...
    <section id="tree-selector" class="tree-selector">
      ...
      <div class="select-options ts-modal" aria-expanded="false">
        ...
        <ul class="selector-options" tabindex="-1">
            ...
            <li>
              <a href="/build-central/parallel/dom/bindings/parser/tests/test_mozmap.py" >
            ...
            <li>
              <a href="/comm-central/parallel/dom/bindings/parser/tests/test_mozmap.py" >
            ...
            <li>
              <a href="/hgcustom_version-control-tools/parallel/dom/bindings/parser/tests/test_mozmap.py" >
            ...
            <li>
              <a href="/mozilla-central/parallel/dom/bindings/parser/tests/test_mozmap.py" class="selected" aria-checked="true">
            ...
            <li>
              <a href="/nss/parallel/dom/bindings/parser/tests/test_mozmap.py" >
            ...
            <li>
              <a href="/rust/parallel/dom/bindings/parser/tests/test_mozmap.py" >
            ...
            <li>
              <a href="/rustfmt/parallel/dom/bindings/parser/tests/test_mozmap.py" >
    ...
    <div class="panel">
      ...
      <section id="panel-content" aria-expanded="true" aria-hidden="false">
          ...
          <ul>
              ...
              <li>
                <a href="/mozilla-central/rev/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_mozmap.py" title="Permalink" class="permalink icon">Permalink</a>
              </li>
          </ul>
          ...
          <ul>
              ...
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/filelog/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_mozmap.py" title="Log" class="log icon">Log</a>
              </li>
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/annotate/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_mozmap.py" title="Blame" class="blame icon">Blame</a>
              </li>
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/diff/b3983ebf6c52183ee86f928ea7a98475bca673b4/dom/bindings/parser/tests/test_mozmap.py" title="Diff" class="diff icon">Diff</a>
              </li>
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/raw-file/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_mozmap.py" title="Raw" class="raw icon">Raw</a>
              </li>
          </ul>
  ...
  <div id="annotations">
      ...
      <div class="annotation-set" id="aset-39"></div></div>
...
</span></code><code id="line-5" aria-labelledby="5"><span class="str">        dictionary Dict {};</span><span class="str">
</span></code><code id="line-6" aria-labelledby="6"><span class="str">        interface MozMapArg {</span><span class="str">
</span></code><code id="line-7" aria-labelledby="7"><span class="str">          void foo(MozMap&lt;Dict&gt; arg);</span><span class="str">
</span></code><code id="line-8" aria-labelledby="8"><span class="str">        };</span><span class="str">
</span></code><code id="line-9" aria-labelledby="9"><span class="str">    </span><span class="str">"""</span>)
</code><code id="line-10" aria-labelledby="10">
</code><code id="line-11" aria-labelledby="11">    results = parser.finish()
</code><code id="line-12" aria-labelledby="12">
</code><code id="line-13" aria-labelledby="13">    harness.check(len(results), 2, <span class="str">"</span><span class="str">Should know about two things</span><span class="str">"</span>);
</code><code id="line-14" aria-labelledby="14">    harness.ok(isinstance(results[1], WebIDL.IDLInterface),
</code><code id="line-15" aria-labelledby="15">               <span class="str">"</span><span class="str">Should have an interface here</span><span class="str">"</span>);
</code><code id="line-16" aria-labelledby="16">    members = results[1].members
</code><code id="line-17" aria-labelledby="17">    harness.check(len(members), 1, <span class="str">"</span><span class="str">Should have one member</span><span class="str">"</span>)
</code><code id="line-18" aria-labelledby="18">    harness.ok(members[0].isMethod(), <span class="str">"</span><span class="str">Should have method</span><span class="str">"</span>)
</code><code id="line-19" aria-labelledby="19">    signature = members[0].signatures()[0]
</code><code id="line-20" aria-labelledby="20">    args = signature[1]
</code><code id="line-21" aria-labelledby="21">    harness.check(len(args), 1, <span class="str">"</span><span class="str">Should have one arg</span><span class="str">"</span>)
</code><code id="line-22" aria-labelledby="22">    harness.ok(args[0].type.isMozMap(), <span class="str">"</span><span class="str">Should have a MozMap type here</span><span class="str">"</span>)
</code><code id="line-23" aria-labelledby="23">    harness.ok(args[0].type.inner.isDictionary(),
</code><code id="line-24" aria-labelledby="24">               <span class="str">"</span><span class="str">Should have a dictionary inner type</span><span class="str">"</span>)
</code><code id="line-25" aria-labelledby="25">
</code><code id="line-26" aria-labelledby="26">    parser = parser.reset()
</code><code id="line-27" aria-labelledby="27">    threw = False
</code><code id="line-28" aria-labelledby="28">    <span class="k">try</span>:
</code><code id="line-29" aria-labelledby="29">        parser.parse(<span class="str">"""</span><span class="str">
</span></code><code id="line-30" aria-labelledby="30"><span class="str">            interface MozMapVoidArg {</span><span class="str">
</span></code><code id="line-31" aria-labelledby="31"><span class="str">              void foo(MozMap&lt;void&gt; arg);</span><span class="str">
</span></code><code id="line-32" aria-labelledby="32"><span class="str">            };</span><span class="str">
</span></code><code id="line-33" aria-labelledby="33"><span class="str">        </span><span class="str">"""</span>)
</code><code id="line-34" aria-labelledby="34">
</code><code id="line-35" aria-labelledby="35">        results = parser.finish()
</code><code id="line-36" aria-labelledby="36">    <span class="k">except</span> Exception,x:
</code><code id="line-37" aria-labelledby="37">        threw = True
</code><code id="line-38" aria-labelledby="38">
</code><code id="line-39" aria-labelledby="39">    harness.ok(threw, <span class="str">"</span><span class="str">Should have thrown.</span><span class="str">"</span>)
</code></pre>
        </td>
      </tr>
    </tbody>
