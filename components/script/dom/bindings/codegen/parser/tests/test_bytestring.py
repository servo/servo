...
<html lang="en-US">
  ...
  <link rel="shortcut icon" href="/static/icons/mimetypes/py.5ef6367a.png" />
    ...
    <title>test_bytestring.py - DXR</title>
  ...
  <div class="breadcrumbs"><a href="/mozilla-central/source">mozilla-central</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom">dom</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings">bindings</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings/parser">parser</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings/parser/tests">tests</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings/parser/tests/test_bytestring.py">test_bytestring.py</a></div>
    ...
    <section id="tree-selector" class="tree-selector">
      ...
      <div class="select-options ts-modal" aria-expanded="false">
        ...
        <ul class="selector-options" tabindex="-1">
            ...
            <li>
              <a href="/build-central/parallel/dom/bindings/parser/tests/test_bytestring.py" >
            ...
            <li>
              <a href="/comm-central/parallel/dom/bindings/parser/tests/test_bytestring.py" >
            ...
            <li>
              <a href="/hgcustom_version-control-tools/parallel/dom/bindings/parser/tests/test_bytestring.py" >
            ...
            <li>
              <a href="/mozilla-central/parallel/dom/bindings/parser/tests/test_bytestring.py" class="selected" aria-checked="true">
            ...
            <li>
              <a href="/nss/parallel/dom/bindings/parser/tests/test_bytestring.py" >
            ...
            <li>
              <a href="/rust/parallel/dom/bindings/parser/tests/test_bytestring.py" >
            ...
            <li>
              <a href="/rustfmt/parallel/dom/bindings/parser/tests/test_bytestring.py" >
    ...
    <div class="panel">
      ...
      <section id="panel-content" aria-expanded="true" aria-hidden="false">
          ...
          <ul>
              ...
              <li>
                <a href="/mozilla-central/rev/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_bytestring.py" title="Permalink" class="permalink icon">Permalink</a>
              </li>
          </ul>
          ...
          <ul>
              ...
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/filelog/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_bytestring.py" title="Log" class="log icon">Log</a>
              </li>
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/annotate/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_bytestring.py" title="Blame" class="blame icon">Blame</a>
              </li>
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/diff/864acd590539268af53937b95943def6efcf903c/dom/bindings/parser/tests/test_bytestring.py" title="Diff" class="diff icon">Diff</a>
              </li>
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/raw-file/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_bytestring.py" title="Raw" class="raw icon">Raw</a>
              </li>
          </ul>
  ...
  <div id="annotations">
      ...
      <div class="annotation-set" id="aset-72"></div></div>
...
<pre>
<code id="line-1" aria-labelledby="1"><span class="c"># -*- coding: UTF-8 -*-</span>
</code><code id="line-2" aria-labelledby="2">
</code><code id="line-3" aria-labelledby="3"><span class="k">import</span> WebIDL
</code><code id="line-4" aria-labelledby="4">
</code><code id="line-5" aria-labelledby="5"><span class="k">def</span> WebIDLTest(parser, harness):
</code><code id="line-6" aria-labelledby="6">    parser.parse(<span class="str">"""</span><span class="str">
</span></code><code id="line-7" aria-labelledby="7"><span class="str">        interface TestByteString {</span><span class="str">
</span></code><code id="line-8" aria-labelledby="8"><span class="str">          attribute ByteString bs;</span><span class="str">
</span></code><code id="line-9" aria-labelledby="9"><span class="str">          attribute DOMString ds;</span><span class="str">
</span></code><code id="line-10" aria-labelledby="10"><span class="str">          };</span><span class="str">
</span></code><code id="line-11" aria-labelledby="11"><span class="str">    </span><span class="str">"""</span>)
...
</code><code id="line-15" aria-labelledby="15">    harness.ok(True, <span class="str">"</span><span class="str">TestByteString interface parsed without error.</span><span class="str">"</span>)
</code><code id="line-16" aria-labelledby="16">    
</code><code id="line-17" aria-labelledby="17">    harness.check(len(results), 1, <span class="str">"</span><span class="str">Should be one production</span><span class="str">"</span>)
</code><code id="line-18" aria-labelledby="18">    harness.ok(isinstance(results[0], WebIDL.IDLInterface),
</code><code id="line-19" aria-labelledby="19">               <span class="str">"</span><span class="str">Should be an IDLInterface</span><span class="str">"</span>)
</code><code id="line-20" aria-labelledby="20">    iface = results[0]
</code><code id="line-21" aria-labelledby="21">    harness.check(iface.identifier.QName(), <span class="str">"</span><span class="str">::TestByteString</span><span class="str">"</span>, <span class="str">"</span><span class="str">Interface has the right QName</span><span class="str">"</span>)
</code><code id="line-22" aria-labelledby="22">    harness.check(iface.identifier.name, <span class="str">"</span><span class="str">TestByteString</span><span class="str">"</span>, <span class="str">"</span><span class="str">Interface has the right name</span><span class="str">"</span>)
</code><code id="line-23" aria-labelledby="23">    harness.check(iface.parent, None, <span class="str">"</span><span class="str">Interface has no parent</span><span class="str">"</span>)
</code><code id="line-24" aria-labelledby="24">
</code><code id="line-25" aria-labelledby="25">    members = iface.members
</code><code id="line-26" aria-labelledby="26">    harness.check(len(members), 2, <span class="str">"</span><span class="str">Should be two productions</span><span class="str">"</span>)
</code><code id="line-27" aria-labelledby="27">
</code><code id="line-28" aria-labelledby="28">    attr = members[0]
</code><code id="line-29" aria-labelledby="29">    harness.ok(isinstance(attr, WebIDL.IDLAttribute), <span class="str">"</span><span class="str">Should be an IDLAttribute</span><span class="str">"</span>)
</code><code id="line-30" aria-labelledby="30">    harness.check(attr.identifier.QName(), <span class="str">"</span><span class="str">::TestByteString::bs</span><span class="str">"</span>, <span class="str">"</span><span class="str">Attr has correct QName</span><span class="str">"</span>)
</code><code id="line-31" aria-labelledby="31">    harness.check(attr.identifier.name, <span class="str">"</span><span class="str">bs</span><span class="str">"</span>, <span class="str">"</span><span class="str">Attr has correct name</span><span class="str">"</span>)
</code><code id="line-32" aria-labelledby="32">    harness.check(str(attr.type), <span class="str">"</span><span class="str">ByteString</span><span class="str">"</span>, <span class="str">"</span><span class="str">Attr type is the correct name</span><span class="str">"</span>)
</code><code id="line-33" aria-labelledby="33">    harness.ok(attr.type.isByteString(), <span class="str">"</span><span class="str">Should be ByteString type</span><span class="str">"</span>)
</code><code id="line-34" aria-labelledby="34">    harness.ok(attr.type.isString(), <span class="str">"</span><span class="str">Should be String collective type</span><span class="str">"</span>)
</code><code id="line-35" aria-labelledby="35">    harness.ok(not attr.type.isDOMString(), <span class="str">"</span><span class="str">Should be not be DOMString type</span><span class="str">"</span>)
</code><code id="line-36" aria-labelledby="36">
</code><code id="line-37" aria-labelledby="37">    <span class="c"># now check we haven't broken DOMStrings in the process.</span>
</code><code id="line-38" aria-labelledby="38">    attr = members[1]
</code><code id="line-39" aria-labelledby="39">    harness.ok(isinstance(attr, WebIDL.IDLAttribute), <span class="str">"</span><span class="str">Should be an IDLAttribute</span><span class="str">"</span>)
</code><code id="line-40" aria-labelledby="40">    harness.check(attr.identifier.QName(), <span class="str">"</span><span class="str">::TestByteString::ds</span><span class="str">"</span>, <span class="str">"</span><span class="str">Attr has correct QName</span><span class="str">"</span>)
</code><code id="line-41" aria-labelledby="41">    harness.check(attr.identifier.name, <span class="str">"</span><span class="str">ds</span><span class="str">"</span>, <span class="str">"</span><span class="str">Attr has correct name</span><span class="str">"</span>)
</code><code id="line-42" aria-labelledby="42">    harness.check(str(attr.type), <span class="str">"</span><span class="str">String</span><span class="str">"</span>, <span class="str">"</span><span class="str">Attr type is the correct name</span><span class="str">"</span>)
</code><code id="line-43" aria-labelledby="43">    harness.ok(attr.type.isDOMString(), <span class="str">"</span><span class="str">Should be DOMString type</span><span class="str">"</span>)
</code><code id="line-44" aria-labelledby="44">    harness.ok(attr.type.isString(), <span class="str">"</span><span class="str">Should be String collective type</span><span class="str">"</span>)
</code><code id="line-45" aria-labelledby="45">    harness.ok(not attr.type.isByteString(), <span class="str">"</span><span class="str">Should be not be ByteString type</span><span class="str">"</span>)
</code><code id="line-46" aria-labelledby="46">
</code><code id="line-47" aria-labelledby="47">    <span class="c"># Cannot represent constant ByteString in IDL.</span>
</code><code id="line-48" aria-labelledby="48">    threw = False
</code><code id="line-49" aria-labelledby="49">    <span class="k">try</span>:
</code><code id="line-50" aria-labelledby="50">        parser.parse(<span class="str">"""</span><span class="str">
</span></code><code id="line-51" aria-labelledby="51"><span class="str">            interface ConstByteString {</span><span class="str">
</span></code><code id="line-52" aria-labelledby="52"><span class="str">              const ByteString foo = </span><span class="str">"</span><span class="str">hello</span><span class="str">"</span><span class="str">
</span></code><code id="line-53" aria-labelledby="53"><span class="str">              };</span><span class="str">
</span></code><code id="line-54" aria-labelledby="54"><span class="str">        </span><span class="str">"""</span>)
</code><code id="line-55" aria-labelledby="55">    <span class="k">except</span> WebIDL.WebIDLError:
</code><code id="line-56" aria-labelledby="56">        threw = True
</code><code id="line-57" aria-labelledby="57">    harness.ok(threw, <span class="str">"</span><span class="str">Should have thrown a WebIDL error</span><span class="str">"</span>)
</code><code id="line-58" aria-labelledby="58">
</code><code id="line-59" aria-labelledby="59">    <span class="c"># Cannot have optional ByteStrings with default values</span>
</code><code id="line-60" aria-labelledby="60">    threw = False
</code><code id="line-61" aria-labelledby="61">    <span class="k">try</span>:
</code><code id="line-62" aria-labelledby="62">        parser.parse(<span class="str">"""</span><span class="str">
</span></code><code id="line-63" aria-labelledby="63"><span class="str">            interface OptionalByteString {</span><span class="str">
</span></code><code id="line-64" aria-labelledby="64"><span class="str">              void passByteString(optional ByteString arg = </span><span class="str">"</span><span class="str">hello</span><span class="str">"</span><span class="str">);</span><span class="str">
</span></code><code id="line-65" aria-labelledby="65"><span class="str">              };</span><span class="str">
</span></code><code id="line-66" aria-labelledby="66"><span class="str">        </span><span class="str">"""</span>)
</code><code id="line-67" aria-labelledby="67">        results2 = parser.finish();
</code><code id="line-68" aria-labelledby="68">    <span class="k">except</span> WebIDL.WebIDLError:
</code><code id="line-69" aria-labelledby="69">        threw = True
</code><code id="line-70" aria-labelledby="70">
</code><code id="line-71" aria-labelledby="71">    harness.ok(threw, <span class="str">"</span><span class="str">Should have thrown a WebIDL error</span><span class="str">"</span>)
</code><code id="line-72" aria-labelledby="72">
</code></pre>
        </td>
      </tr>
    </tbody>
