...
<html lang="en-US">
  ...
  <link rel="shortcut icon" href="/static/icons/mimetypes/py.5ef6367a.png" />
    ...
    <title>test_usvstring.py - DXR</title>
  ...
  <div class="breadcrumbs"><a href="/mozilla-central/source">mozilla-central</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom">dom</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings">bindings</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings/parser">parser</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings/parser/tests">tests</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings/parser/tests/test_usvstring.py">test_usvstring.py</a></div>
    ...
    <section id="tree-selector" class="tree-selector">
      ...
      <div class="select-options ts-modal" aria-expanded="false">
        ...
        <ul class="selector-options" tabindex="-1">
            ...
            <li>
              <a href="/build-central/parallel/dom/bindings/parser/tests/test_usvstring.py" >
            ...
            <li>
              <a href="/comm-central/parallel/dom/bindings/parser/tests/test_usvstring.py" >
            ...
            <li>
              <a href="/hgcustom_version-control-tools/parallel/dom/bindings/parser/tests/test_usvstring.py" >
            ...
            <li>
              <a href="/mozilla-central/parallel/dom/bindings/parser/tests/test_usvstring.py" class="selected" aria-checked="true">
            ...
            <li>
              <a href="/nss/parallel/dom/bindings/parser/tests/test_usvstring.py" >
            ...
            <li>
              <a href="/rust/parallel/dom/bindings/parser/tests/test_usvstring.py" >
            ...
            <li>
              <a href="/rustfmt/parallel/dom/bindings/parser/tests/test_usvstring.py" >
    ...
    <div class="panel">
      ...
      <section id="panel-content" aria-expanded="true" aria-hidden="false">
          ...
          <ul>
              ...
              <li>
                <a href="/mozilla-central/rev/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_usvstring.py" title="Permalink" class="permalink icon">Permalink</a>
              </li>
          </ul>
          ...
          <ul>
              ...
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/filelog/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_usvstring.py" title="Log" class="log icon">Log</a>
              </li>
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/annotate/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_usvstring.py" title="Blame" class="blame icon">Blame</a>
              </li>
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/diff/efa7ad01dac6acba64920ffd665e1bdb2634e486/dom/bindings/parser/tests/test_usvstring.py" title="Diff" class="diff icon">Diff</a>
              </li>
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/raw-file/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_usvstring.py" title="Raw" class="raw icon">Raw</a>
              </li>
          </ul>
  ...
  <div id="annotations">
      ...
      <div class="annotation-set" id="aset-36"></div></div>
...
</span></code><code id="line-7" aria-labelledby="7"><span class="str">        interface TestUSVString {</span><span class="str">
</span></code><code id="line-8" aria-labelledby="8"><span class="str">          attribute USVString svs;</span><span class="str">
...
</code><code id="line-14" aria-labelledby="14">    harness.check(len(results), 1, <span class="str">"</span><span class="str">Should be one production</span><span class="str">"</span>)
</code><code id="line-15" aria-labelledby="15">    harness.ok(isinstance(results[0], WebIDL.IDLInterface),
</code><code id="line-16" aria-labelledby="16">               <span class="str">"</span><span class="str">Should be an IDLInterface</span><span class="str">"</span>)
</code><code id="line-17" aria-labelledby="17">    iface = results[0]
</code><code id="line-18" aria-labelledby="18">    harness.check(iface.identifier.QName(), <span class="str">"</span><span class="str">::TestUSVString</span><span class="str">"</span>,
</code><code id="line-19" aria-labelledby="19">                  <span class="str">"</span><span class="str">Interface has the right QName</span><span class="str">"</span>)
</code><code id="line-20" aria-labelledby="20">    harness.check(iface.identifier.name, <span class="str">"</span><span class="str">TestUSVString</span><span class="str">"</span>,
</code><code id="line-21" aria-labelledby="21">                  <span class="str">"</span><span class="str">Interface has the right name</span><span class="str">"</span>)
</code><code id="line-22" aria-labelledby="22">    harness.check(iface.parent, None, <span class="str">"</span><span class="str">Interface has no parent</span><span class="str">"</span>)
</code><code id="line-23" aria-labelledby="23">
</code><code id="line-24" aria-labelledby="24">    members = iface.members
</code><code id="line-25" aria-labelledby="25">    harness.check(len(members), 1, <span class="str">"</span><span class="str">Should be one member</span><span class="str">"</span>)
</code><code id="line-26" aria-labelledby="26">
</code><code id="line-27" aria-labelledby="27">    attr = members[0]
</code><code id="line-28" aria-labelledby="28">    harness.ok(isinstance(attr, WebIDL.IDLAttribute), <span class="str">"</span><span class="str">Should be an IDLAttribute</span><span class="str">"</span>)
</code><code id="line-29" aria-labelledby="29">    harness.check(attr.identifier.QName(), <span class="str">"</span><span class="str">::TestUSVString::svs</span><span class="str">"</span>,
</code><code id="line-30" aria-labelledby="30">                  <span class="str">"</span><span class="str">Attr has correct QName</span><span class="str">"</span>)
</code><code id="line-31" aria-labelledby="31">    harness.check(attr.identifier.name, <span class="str">"</span><span class="str">svs</span><span class="str">"</span>, <span class="str">"</span><span class="str">Attr has correct name</span><span class="str">"</span>)
</code><code id="line-32" aria-labelledby="32">    harness.check(str(attr.type), <span class="str">"</span><span class="str">USVString</span><span class="str">"</span>,
</code><code id="line-33" aria-labelledby="33">                  <span class="str">"</span><span class="str">Attr type is the correct name</span><span class="str">"</span>)
</code><code id="line-34" aria-labelledby="34">    harness.ok(attr.type.isUSVString(), <span class="str">"</span><span class="str">Should be USVString type</span><span class="str">"</span>)
</code><code id="line-35" aria-labelledby="35">    harness.ok(attr.type.isString(), <span class="str">"</span><span class="str">Should be String collective type</span><span class="str">"</span>)
</code><code id="line-36" aria-labelledby="36">    harness.ok(not attr.type.isDOMString(), <span class="str">"</span><span class="str">Should be not be DOMString type</span><span class="str">"</span>)
</code></pre>
        </td>
      </tr>
    </tbody>
