...
<html lang="en-US">
  ...
  <link rel="shortcut icon" href="/static/icons/mimetypes/py.5ef6367a.png" />
    ...
    <title>test_promise.py - DXR</title>
  ...
  <div class="breadcrumbs"><a href="/mozilla-central/source">mozilla-central</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom">dom</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings">bindings</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings/parser">parser</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings/parser/tests">tests</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings/parser/tests/test_promise.py">test_promise.py</a></div>
    ...
    <section id="tree-selector" class="tree-selector">
      ...
      <div class="select-options ts-modal" aria-expanded="false">
        ...
        <ul class="selector-options" tabindex="-1">
            ...
            <li>
              <a href="/build-central/parallel/dom/bindings/parser/tests/test_promise.py" >
            ...
            <li>
              <a href="/comm-central/parallel/dom/bindings/parser/tests/test_promise.py" >
            ...
            <li>
              <a href="/hgcustom_version-control-tools/parallel/dom/bindings/parser/tests/test_promise.py" >
            ...
            <li>
              <a href="/mozilla-central/parallel/dom/bindings/parser/tests/test_promise.py" class="selected" aria-checked="true">
            ...
            <li>
              <a href="/nss/parallel/dom/bindings/parser/tests/test_promise.py" >
            ...
            <li>
              <a href="/rust/parallel/dom/bindings/parser/tests/test_promise.py" >
            ...
            <li>
              <a href="/rustfmt/parallel/dom/bindings/parser/tests/test_promise.py" >
    ...
    <div class="panel">
      ...
      <section id="panel-content" aria-expanded="true" aria-hidden="false">
          ...
          <ul>
              ...
              <li>
                <a href="/mozilla-central/rev/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_promise.py" title="Permalink" class="permalink icon">Permalink</a>
              </li>
          </ul>
          ...
          <ul>
              ...
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/filelog/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_promise.py" title="Log" class="log icon">Log</a>
              </li>
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/annotate/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_promise.py" title="Blame" class="blame icon">Blame</a>
              </li>
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/diff/4685bb81ef6dc8fecc958339ce19a0888d757e6f/dom/bindings/parser/tests/test_promise.py" title="Diff" class="diff icon">Diff</a>
              </li>
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/raw-file/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_promise.py" title="Raw" class="raw icon">Raw</a>
              </li>
          </ul>
  ...
  <div id="annotations">
      ...
      <div class="annotation-set" id="aset-63"></div></div>
...
</span></code><code id="line-5" aria-labelledby="5"><span class="str">            interface _Promise {};</span><span class="str">
</span></code><code id="line-6" aria-labelledby="6"><span class="str">            interface A {</span><span class="str">
</span></code><code id="line-7" aria-labelledby="7"><span class="str">              legacycaller Promise&lt;any&gt; foo();</span><span class="str">
...
</code><code id="line-12" aria-labelledby="12">    <span class="k">except</span>:
</code><code id="line-13" aria-labelledby="13">        threw = True
</code><code id="line-14" aria-labelledby="14">    harness.ok(threw,
</code><code id="line-15" aria-labelledby="15">               <span class="str">"</span><span class="str">Should not allow Promise return values for legacycaller.</span><span class="str">"</span>)
...
</span></code><code id="line-21" aria-labelledby="21"><span class="str">            interface _Promise {};</span><span class="str">
</span></code><code id="line-22" aria-labelledby="22"><span class="str">            interface A {</span><span class="str">
</span></code><code id="line-23" aria-labelledby="23"><span class="str">              Promise&lt;any&gt; foo();</span><span class="str">
</span></code><code id="line-24" aria-labelledby="24"><span class="str">              long foo(long arg);</span><span class="str">
...
</code><code id="line-30" aria-labelledby="30">    harness.ok(threw,
</code><code id="line-31" aria-labelledby="31">               <span class="str">"</span><span class="str">Should not allow overloads which have both Promise and </span><span class="str">"</span>
</code><code id="line-32" aria-labelledby="32">               <span class="str">"</span><span class="str">non-Promise return types.</span><span class="str">"</span>)
</code><code id="line-33" aria-labelledby="33">
</code><code id="line-34" aria-labelledby="34">    parser = parser.reset()
</code><code id="line-35" aria-labelledby="35">    threw = False
</code><code id="line-36" aria-labelledby="36">    <span class="k">try</span>:
</code><code id="line-37" aria-labelledby="37">        parser.parse(<span class="str">"""</span><span class="str">
</span></code><code id="line-38" aria-labelledby="38"><span class="str">            interface _Promise {};</span><span class="str">
</span></code><code id="line-39" aria-labelledby="39"><span class="str">            interface A {</span><span class="str">
</span></code><code id="line-40" aria-labelledby="40"><span class="str">              long foo(long arg);</span><span class="str">
</span></code><code id="line-41" aria-labelledby="41"><span class="str">              Promise&lt;any&gt; foo();</span><span class="str">
</span></code><code id="line-42" aria-labelledby="42"><span class="str">            };</span><span class="str">
</span></code><code id="line-43" aria-labelledby="43"><span class="str">        </span><span class="str">"""</span>)
</code><code id="line-44" aria-labelledby="44">        results = parser.finish();
</code><code id="line-45" aria-labelledby="45">    <span class="k">except</span>:
</code><code id="line-46" aria-labelledby="46">        threw = True
</code><code id="line-47" aria-labelledby="47">    harness.ok(threw,
</code><code id="line-48" aria-labelledby="48">               <span class="str">"</span><span class="str">Should not allow overloads which have both Promise and </span><span class="str">"</span>
</code><code id="line-49" aria-labelledby="49">               <span class="str">"</span><span class="str">non-Promise return types.</span><span class="str">"</span>)
</code><code id="line-50" aria-labelledby="50">
</code><code id="line-51" aria-labelledby="51">    parser = parser.reset()
</code><code id="line-52" aria-labelledby="52">    parser.parse(<span class="str">"""</span><span class="str">
</span></code><code id="line-53" aria-labelledby="53"><span class="str">        interface _Promise {};</span><span class="str">
</span></code><code id="line-54" aria-labelledby="54"><span class="str">        interface A {</span><span class="str">
</span></code><code id="line-55" aria-labelledby="55"><span class="str">          Promise&lt;any&gt; foo();</span><span class="str">
</span></code><code id="line-56" aria-labelledby="56"><span class="str">          Promise&lt;any&gt; foo(long arg);</span><span class="str">
...
</code><code id="line-59" aria-labelledby="59">    results = parser.finish();
</code><code id="line-60" aria-labelledby="60">
</code><code id="line-61" aria-labelledby="61">    harness.ok(True,
</code><code id="line-62" aria-labelledby="62">               <span class="str">"</span><span class="str">Should allow overloads which only have Promise and return </span><span class="str">"</span>
</code><code id="line-63" aria-labelledby="63">               <span class="str">"</span><span class="str">types.</span><span class="str">"</span>)
</code></pre>
        </td>
      </tr>
    </tbody>
