...
<html lang="en-US">
  ...
  <link rel="shortcut icon" href="/static/icons/mimetypes/py.5ef6367a.png" />
    ...
    <title>test_empty_sequence_default_value.py - DXR</title>
  ...
  <div class="breadcrumbs"><a href="/mozilla-central/source">mozilla-central</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom">dom</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings">bindings</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings/parser">parser</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings/parser/tests">tests</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings/parser/tests/test_empty_sequence_default_value.py">test_empty_sequence_default_value.py</a></div>
    ...
    <section id="tree-selector" class="tree-selector">
      ...
      <div class="select-options ts-modal" aria-expanded="false">
        ...
        <ul class="selector-options" tabindex="-1">
            ...
            <li>
              <a href="/build-central/parallel/dom/bindings/parser/tests/test_empty_sequence_default_value.py" >
            ...
            <li>
              <a href="/comm-central/parallel/dom/bindings/parser/tests/test_empty_sequence_default_value.py" >
            ...
            <li>
              <a href="/hgcustom_version-control-tools/parallel/dom/bindings/parser/tests/test_empty_sequence_default_value.py" >
            ...
            <li>
              <a href="/mozilla-central/parallel/dom/bindings/parser/tests/test_empty_sequence_default_value.py" class="selected" aria-checked="true">
            ...
            <li>
              <a href="/nss/parallel/dom/bindings/parser/tests/test_empty_sequence_default_value.py" >
            ...
            <li>
              <a href="/rust/parallel/dom/bindings/parser/tests/test_empty_sequence_default_value.py" >
            ...
            <li>
              <a href="/rustfmt/parallel/dom/bindings/parser/tests/test_empty_sequence_default_value.py" >
    ...
    <div class="panel">
      ...
      <section id="panel-content" aria-expanded="true" aria-hidden="false">
          ...
          <ul>
              ...
              <li>
                <a href="/mozilla-central/rev/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_empty_sequence_default_value.py" title="Permalink" class="permalink icon">Permalink</a>
              </li>
          </ul>
          ...
          <ul>
              ...
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/filelog/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_empty_sequence_default_value.py" title="Log" class="log icon">Log</a>
              </li>
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/annotate/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_empty_sequence_default_value.py" title="Blame" class="blame icon">Blame</a>
              </li>
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/diff/c793617a1d88448c7855ff81aafbaaa81a127f8e/dom/bindings/parser/tests/test_empty_sequence_default_value.py" title="Diff" class="diff icon">Diff</a>
              </li>
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/raw-file/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_empty_sequence_default_value.py" title="Raw" class="raw icon">Raw</a>
              </li>
          </ul>
  ...
  <div id="annotations">
      ...
      <div class="annotation-set" id="aset-45"></div></div>
...
</code><code id="line-4" aria-labelledby="4">    threw = False
</code><code id="line-5" aria-labelledby="5">    <span class="k">try</span>:
</code><code id="line-6" aria-labelledby="6">        parser.parse(<span class="str">"""</span><span class="str">
</span></code><code id="line-7" aria-labelledby="7"><span class="str">            interface X {</span><span class="str">
</span></code><code id="line-8" aria-labelledby="8"><span class="str">              const sequence&lt;long&gt; foo = [];</span><span class="str">
</span></code><code id="line-9" aria-labelledby="9"><span class="str">            };</span><span class="str">
</span></code><code id="line-10" aria-labelledby="10"><span class="str">        </span><span class="str">"""</span>)
</code><code id="line-11" aria-labelledby="11">
</code><code id="line-12" aria-labelledby="12">        results = parser.finish()
</code><code id="line-13" aria-labelledby="13">    <span class="k">except</span> Exception,x:
</code><code id="line-14" aria-labelledby="14">        threw = True
</code><code id="line-15" aria-labelledby="15">
</code><code id="line-16" aria-labelledby="16">    harness.ok(threw, <span class="str">"</span><span class="str">Constant cannot have [] as a default value</span><span class="str">"</span>)
</code><code id="line-17" aria-labelledby="17">
</code><code id="line-18" aria-labelledby="18">    parser = parser.reset()
</code><code id="line-19" aria-labelledby="19">
</code><code id="line-20" aria-labelledby="20">    parser.parse(<span class="str">"""</span><span class="str">
</span></code><code id="line-21" aria-labelledby="21"><span class="str">        interface X {</span><span class="str">
</span></code><code id="line-22" aria-labelledby="22"><span class="str">          void foo(optional sequence&lt;long&gt; arg = []);</span><span class="str">
...
</code><code id="line-27" aria-labelledby="27">    harness.ok(isinstance(
</code><code id="line-28" aria-labelledby="28">        results[0].members[0].signatures()[0][1][0].defaultValue,
</code><code id="line-29" aria-labelledby="29">        WebIDL.IDLEmptySequenceValue),
</code><code id="line-30" aria-labelledby="30">               <span class="str">"</span><span class="str">Should have IDLEmptySequenceValue as default value of argument</span><span class="str">"</span>)
</code><code id="line-31" aria-labelledby="31">
</code><code id="line-32" aria-labelledby="32">    parser = parser.reset()
</code><code id="line-33" aria-labelledby="33">
</code><code id="line-34" aria-labelledby="34">    parser.parse(<span class="str">"""</span><span class="str">
</span></code><code id="line-35" aria-labelledby="35"><span class="str">        dictionary X {</span><span class="str">
</span></code><code id="line-36" aria-labelledby="36"><span class="str">          sequence&lt;long&gt; foo = [];</span><span class="str">
</span></code><code id="line-37" aria-labelledby="37"><span class="str">        };</span><span class="str">
</span></code><code id="line-38" aria-labelledby="38"><span class="str">    </span><span class="str">"""</span>)
</code><code id="line-39" aria-labelledby="39">    results = parser.finish();
</code><code id="line-40" aria-labelledby="40">
</code><code id="line-41" aria-labelledby="41">    harness.ok(isinstance(results[0].members[0].defaultValue,
</code><code id="line-42" aria-labelledby="42">                          WebIDL.IDLEmptySequenceValue),
</code><code id="line-43" aria-labelledby="43">               <span class="str">"</span><span class="str">Should have IDLEmptySequenceValue as default value of </span><span class="str">"</span>
</code><code id="line-44" aria-labelledby="44">               <span class="str">"</span><span class="str">dictionary member</span><span class="str">"</span>)
