...
<html lang="en-US">
  ...
  <link rel="shortcut icon" href="/static/icons/mimetypes/py.5ef6367a.png" />
    ...
    <title>test_unforgeable.py - DXR</title>
  ...
  <div class="breadcrumbs"><a href="/mozilla-central/source">mozilla-central</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom">dom</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings">bindings</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings/parser">parser</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings/parser/tests">tests</a><span class="path-separator">/</span><a href="/mozilla-central/source/dom/bindings/parser/tests/test_unforgeable.py">test_unforgeable.py</a></div>
    ...
    <section id="tree-selector" class="tree-selector">
      ...
      <div class="select-options ts-modal" aria-expanded="false">
        ...
        <ul class="selector-options" tabindex="-1">
            ...
            <li>
              <a href="/build-central/parallel/dom/bindings/parser/tests/test_unforgeable.py" >
            ...
            <li>
              <a href="/comm-central/parallel/dom/bindings/parser/tests/test_unforgeable.py" >
            ...
            <li>
              <a href="/hgcustom_version-control-tools/parallel/dom/bindings/parser/tests/test_unforgeable.py" >
            ...
            <li>
              <a href="/mozilla-central/parallel/dom/bindings/parser/tests/test_unforgeable.py" class="selected" aria-checked="true">
            ...
            <li>
              <a href="/nss/parallel/dom/bindings/parser/tests/test_unforgeable.py" >
            ...
            <li>
              <a href="/rust/parallel/dom/bindings/parser/tests/test_unforgeable.py" >
            ...
            <li>
              <a href="/rustfmt/parallel/dom/bindings/parser/tests/test_unforgeable.py" >
    ...
    <div class="panel">
      ...
      <section id="panel-content" aria-expanded="true" aria-hidden="false">
          ...
          <ul>
              ...
              <li>
                <a href="/mozilla-central/rev/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_unforgeable.py" title="Permalink" class="permalink icon">Permalink</a>
              </li>
          </ul>
          ...
          <ul>
              ...
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/filelog/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_unforgeable.py" title="Log" class="log icon">Log</a>
              </li>
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/annotate/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_unforgeable.py" title="Blame" class="blame icon">Blame</a>
              </li>
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/diff/e437d7fa90a5dc06a399b432eadc79a02877b0ae/dom/bindings/parser/tests/test_unforgeable.py" title="Diff" class="diff icon">Diff</a>
              </li>
              <li>
                <a href="https://hg.mozilla.org/mozilla-central/raw-file/05c087337043dd8e71cc27bdb5b9d55fd00aaa26/dom/bindings/parser/tests/test_unforgeable.py" title="Raw" class="raw icon">Raw</a>
              </li>
          </ul>
  ...
  <div id="annotations">
      ...
      <div class="annotation-set" id="aset-253"></div></div>
...
</span></code><code id="line-3" aria-labelledby="3"><span class="str">            interface Child : Parent {</span><span class="str">
</span></code><code id="line-4" aria-labelledby="4"><span class="str">            };</span><span class="str">
</span></code><code id="line-5" aria-labelledby="5"><span class="str">            interface Parent {</span><span class="str">
</span></code><code id="line-6" aria-labelledby="6"><span class="str">              [Unforgeable] readonly attribute long foo;</span><span class="str">
...
</code><code id="line-11" aria-labelledby="11">    harness.check(len(results), 2,
</code><code id="line-12" aria-labelledby="12">                  <span class="str">"</span><span class="str">Should be able to inherit from an interface with </span><span class="str">"</span>
</code><code id="line-13" aria-labelledby="13">                  <span class="str">"</span><span class="str">[Unforgeable] properties.</span><span class="str">"</span>)
</code><code id="line-14" aria-labelledby="14">
</code><code id="line-15" aria-labelledby="15">    parser = parser.reset();
</code><code id="line-16" aria-labelledby="16">    parser.parse(<span class="str">"""</span><span class="str">
</span></code><code id="line-17" aria-labelledby="17"><span class="str">            interface Child : Parent {</span><span class="str">
</span></code><code id="line-18" aria-labelledby="18"><span class="str">              const short foo = 10;</span><span class="str">
</span></code><code id="line-19" aria-labelledby="19"><span class="str">            };</span><span class="str">
</span></code><code id="line-20" aria-labelledby="20"><span class="str">            interface Parent {</span><span class="str">
</span></code><code id="line-21" aria-labelledby="21"><span class="str">              [Unforgeable] readonly attribute long foo;</span><span class="str">
...
</code><code id="line-26" aria-labelledby="26">    harness.check(len(results), 2,
</code><code id="line-27" aria-labelledby="27">                  <span class="str">"</span><span class="str">Should be able to inherit from an interface with </span><span class="str">"</span>
</code><code id="line-28" aria-labelledby="28">                  <span class="str">"</span><span class="str">[Unforgeable] properties even if we have a constant with </span><span class="str">"</span>
</code><code id="line-29" aria-labelledby="29">                  <span class="str">"</span><span class="str">the same name.</span><span class="str">"</span>)
...
</span></code><code id="line-33" aria-labelledby="33"><span class="str">            interface Child : Parent {</span><span class="str">
</span></code><code id="line-34" aria-labelledby="34"><span class="str">              static attribute short foo;</span><span class="str">
</span></code><code id="line-35" aria-labelledby="35"><span class="str">            };</span><span class="str">
</span></code><code id="line-36" aria-labelledby="36"><span class="str">            interface Parent {</span><span class="str">
</span></code><code id="line-37" aria-labelledby="37"><span class="str">              [Unforgeable] readonly attribute long foo;</span><span class="str">
</span></code><code id="line-38" aria-labelledby="38"><span class="str">            };</span><span class="str">
</span></code><code id="line-39" aria-labelledby="39"><span class="str">        </span><span class="str">"""</span>)
</code><code id="line-40" aria-labelledby="40">
</code><code id="line-41" aria-labelledby="41">    results = parser.finish()
</code><code id="line-42" aria-labelledby="42">    harness.check(len(results), 2,
</code><code id="line-43" aria-labelledby="43">                  <span class="str">"</span><span class="str">Should be able to inherit from an interface with </span><span class="str">"</span>
</code><code id="line-44" aria-labelledby="44">                  <span class="str">"</span><span class="str">[Unforgeable] properties even if we have a static attribute </span><span class="str">"</span>
</code><code id="line-45" aria-labelledby="45">                  <span class="str">"</span><span class="str">with the same name.</span><span class="str">"</span>)
</code><code id="line-46" aria-labelledby="46">
</code><code id="line-47" aria-labelledby="47">    parser = parser.reset();
</code><code id="line-48" aria-labelledby="48">    parser.parse(<span class="str">"""</span><span class="str">
</span></code><code id="line-49" aria-labelledby="49"><span class="str">            interface Child : Parent {</span><span class="str">
</span></code><code id="line-50" aria-labelledby="50"><span class="str">              static void foo();</span><span class="str">
</span></code><code id="line-51" aria-labelledby="51"><span class="str">            };</span><span class="str">
</span></code><code id="line-52" aria-labelledby="52"><span class="str">            interface Parent {</span><span class="str">
</span></code><code id="line-53" aria-labelledby="53"><span class="str">              [Unforgeable] readonly attribute long foo;</span><span class="str">
</span></code><code id="line-54" aria-labelledby="54"><span class="str">            };</span><span class="str">
</span></code><code id="line-55" aria-labelledby="55"><span class="str">        </span><span class="str">"""</span>)
</code><code id="line-56" aria-labelledby="56">
</code><code id="line-57" aria-labelledby="57">    results = parser.finish()
</code><code id="line-58" aria-labelledby="58">    harness.check(len(results), 2,
</code><code id="line-59" aria-labelledby="59">                  <span class="str">"</span><span class="str">Should be able to inherit from an interface with </span><span class="str">"</span>
</code><code id="line-60" aria-labelledby="60">                  <span class="str">"</span><span class="str">[Unforgeable] properties even if we have a static operation </span><span class="str">"</span>
</code><code id="line-61" aria-labelledby="61">                  <span class="str">"</span><span class="str">with the same name.</span><span class="str">"</span>)
</code><code id="line-62" aria-labelledby="62">
</code><code id="line-63" aria-labelledby="63">    parser = parser.reset();
</code><code id="line-64" aria-labelledby="64">    threw = False
</code><code id="line-65" aria-labelledby="65">    <span class="k">try</span>:
</code><code id="line-66" aria-labelledby="66">        parser.parse(<span class="str">"""</span><span class="str">
</span></code><code id="line-67" aria-labelledby="67"><span class="str">            interface Child : Parent {</span><span class="str">
</span></code><code id="line-68" aria-labelledby="68"><span class="str">              void foo();</span><span class="str">
</span></code><code id="line-69" aria-labelledby="69"><span class="str">            };</span><span class="str">
</span></code><code id="line-70" aria-labelledby="70"><span class="str">            interface Parent {</span><span class="str">
</span></code><code id="line-71" aria-labelledby="71"><span class="str">              [Unforgeable] readonly attribute long foo;</span><span class="str">
</span></code><code id="line-72" aria-labelledby="72"><span class="str">            };</span><span class="str">
</span></code><code id="line-73" aria-labelledby="73"><span class="str">        </span><span class="str">"""</span>)
</code><code id="line-74" aria-labelledby="74">
</code><code id="line-75" aria-labelledby="75">        results = parser.finish()
</code><code id="line-76" aria-labelledby="76">    <span class="k">except</span>:
</code><code id="line-77" aria-labelledby="77">        threw = True
</code><code id="line-78" aria-labelledby="78">    harness.ok(threw,
</code><code id="line-79" aria-labelledby="79">               <span class="str">"</span><span class="str">Should have thrown when shadowing unforgeable attribute on </span><span class="str">"</span>
</code><code id="line-80" aria-labelledby="80">               <span class="str">"</span><span class="str">parent with operation.</span><span class="str">"</span>)
</code><code id="line-81" aria-labelledby="81">
</code><code id="line-82" aria-labelledby="82">    parser = parser.reset();
</code><code id="line-83" aria-labelledby="83">    threw = False
</code><code id="line-84" aria-labelledby="84">    <span class="k">try</span>:
</code><code id="line-85" aria-labelledby="85">        parser.parse(<span class="str">"""</span><span class="str">
</span></code><code id="line-86" aria-labelledby="86"><span class="str">            interface Child : Parent {</span><span class="str">
</span></code><code id="line-87" aria-labelledby="87"><span class="str">              void foo();</span><span class="str">
</span></code><code id="line-88" aria-labelledby="88"><span class="str">            };</span><span class="str">
</span></code><code id="line-89" aria-labelledby="89"><span class="str">            interface Parent {</span><span class="str">
</span></code><code id="line-90" aria-labelledby="90"><span class="str">              [Unforgeable] void foo();</span><span class="str">
</span></code><code id="line-91" aria-labelledby="91"><span class="str">            };</span><span class="str">
</span></code><code id="line-92" aria-labelledby="92"><span class="str">        </span><span class="str">"""</span>)
</code><code id="line-93" aria-labelledby="93">
</code><code id="line-94" aria-labelledby="94">        results = parser.finish()
</code><code id="line-95" aria-labelledby="95">    <span class="k">except</span>:
</code><code id="line-96" aria-labelledby="96">        threw = True
</code><code id="line-97" aria-labelledby="97">    harness.ok(threw,
</code><code id="line-98" aria-labelledby="98">               <span class="str">"</span><span class="str">Should have thrown when shadowing unforgeable operation on </span><span class="str">"</span>
</code><code id="line-99" aria-labelledby="99">               <span class="str">"</span><span class="str">parent with operation.</span><span class="str">"</span>)
...
</span></code><code id="line-105" aria-labelledby="105"><span class="str">            interface Child : Parent {</span><span class="str">
</span></code><code id="line-106" aria-labelledby="106"><span class="str">              attribute short foo;</span><span class="str">
</span></code><code id="line-107" aria-labelledby="107"><span class="str">            };</span><span class="str">
</span></code><code id="line-108" aria-labelledby="108"><span class="str">            interface Parent {</span><span class="str">
</span></code><code id="line-109" aria-labelledby="109"><span class="str">              [Unforgeable] readonly attribute long foo;</span><span class="str">
</span></code><code id="line-110" aria-labelledby="110"><span class="str">            };</span><span class="str">
</span></code><code id="line-111" aria-labelledby="111"><span class="str">        </span><span class="str">"""</span>)
</code><code id="line-112" aria-labelledby="112">
</code><code id="line-113" aria-labelledby="113">        results = parser.finish()
</code><code id="line-114" aria-labelledby="114">    <span class="k">except</span> Exception,x:
</code><code id="line-115" aria-labelledby="115">        threw = True
</code><code id="line-116" aria-labelledby="116">    harness.ok(threw,
</code><code id="line-117" aria-labelledby="117">               <span class="str">"</span><span class="str">Should have thrown when shadowing unforgeable attribute on </span><span class="str">"</span>
</code><code id="line-118" aria-labelledby="118">               <span class="str">"</span><span class="str">parent with attribute.</span><span class="str">"</span>)
</code><code id="line-119" aria-labelledby="119">
</code><code id="line-120" aria-labelledby="120">    parser = parser.reset();
</code><code id="line-121" aria-labelledby="121">    threw = False
</code><code id="line-122" aria-labelledby="122">    <span class="k">try</span>:
</code><code id="line-123" aria-labelledby="123">        parser.parse(<span class="str">"""</span><span class="str">
</span></code><code id="line-124" aria-labelledby="124"><span class="str">            interface Child : Parent {</span><span class="str">
</span></code><code id="line-125" aria-labelledby="125"><span class="str">              attribute short foo;</span><span class="str">
</span></code><code id="line-126" aria-labelledby="126"><span class="str">            };</span><span class="str">
</span></code><code id="line-127" aria-labelledby="127"><span class="str">            interface Parent {</span><span class="str">
</span></code><code id="line-128" aria-labelledby="128"><span class="str">              [Unforgeable] void foo();</span><span class="str">
</span></code><code id="line-129" aria-labelledby="129"><span class="str">            };</span><span class="str">
</span></code><code id="line-130" aria-labelledby="130"><span class="str">        </span><span class="str">"""</span>)
</code><code id="line-131" aria-labelledby="131">
</code><code id="line-132" aria-labelledby="132">        results = parser.finish()
</code><code id="line-133" aria-labelledby="133">    <span class="k">except</span> Exception,x:
</code><code id="line-134" aria-labelledby="134">        threw = True
</code><code id="line-135" aria-labelledby="135">    harness.ok(threw,
</code><code id="line-136" aria-labelledby="136">               <span class="str">"</span><span class="str">Should have thrown when shadowing unforgeable operation on </span><span class="str">"</span>
</code><code id="line-137" aria-labelledby="137">               <span class="str">"</span><span class="str">parent with attribute.</span><span class="str">"</span>)
</code><code id="line-138" aria-labelledby="138">
</code><code id="line-139" aria-labelledby="139">    parser = parser.reset();
</code><code id="line-140" aria-labelledby="140">    parser.parse(<span class="str">"""</span><span class="str">
</span></code><code id="line-141" aria-labelledby="141"><span class="str">            interface Child : Parent {</span><span class="str">
</span></code><code id="line-142" aria-labelledby="142"><span class="str">            };</span><span class="str">
</span></code><code id="line-143" aria-labelledby="143"><span class="str">            interface Parent {};</span><span class="str">
</span></code><code id="line-144" aria-labelledby="144"><span class="str">            interface Consequential {</span><span class="str">
</span></code><code id="line-145" aria-labelledby="145"><span class="str">              [Unforgeable] readonly attribute long foo;</span><span class="str">
</span></code><code id="line-146" aria-labelledby="146"><span class="str">            };</span><span class="str">
</span></code><code id="line-147" aria-labelledby="147"><span class="str">            Parent implements Consequential;</span><span class="str">
</span></code><code id="line-148" aria-labelledby="148"><span class="str">        </span><span class="str">"""</span>)
</code><code id="line-149" aria-labelledby="149">
</code><code id="line-150" aria-labelledby="150">    results = parser.finish()
</code><code id="line-151" aria-labelledby="151">    harness.check(len(results), 4,
</code><code id="line-152" aria-labelledby="152">                  <span class="str">"</span><span class="str">Should be able to inherit from an interface with a </span><span class="str">"</span>
</code><code id="line-153" aria-labelledby="153">                  <span class="str">"</span><span class="str">consequential interface with [Unforgeable] properties.</span><span class="str">"</span>)
</code><code id="line-154" aria-labelledby="154">
</code><code id="line-155" aria-labelledby="155">    parser = parser.reset();
</code><code id="line-156" aria-labelledby="156">    threw = False
</code><code id="line-157" aria-labelledby="157">    <span class="k">try</span>:
</code><code id="line-158" aria-labelledby="158">        parser.parse(<span class="str">"""</span><span class="str">
</span></code><code id="line-159" aria-labelledby="159"><span class="str">            interface Child : Parent {</span><span class="str">
</span></code><code id="line-160" aria-labelledby="160"><span class="str">              void foo();</span><span class="str">
</span></code><code id="line-161" aria-labelledby="161"><span class="str">            };</span><span class="str">
</span></code><code id="line-162" aria-labelledby="162"><span class="str">            interface Parent {};</span><span class="str">
</span></code><code id="line-163" aria-labelledby="163"><span class="str">            interface Consequential {</span><span class="str">
</span></code><code id="line-164" aria-labelledby="164"><span class="str">              [Unforgeable] readonly attribute long foo;</span><span class="str">
</span></code><code id="line-165" aria-labelledby="165"><span class="str">            };</span><span class="str">
</span></code><code id="line-166" aria-labelledby="166"><span class="str">            Parent implements Consequential;</span><span class="str">
</span></code><code id="line-167" aria-labelledby="167"><span class="str">        </span><span class="str">"""</span>)
</code><code id="line-168" aria-labelledby="168">
</code><code id="line-169" aria-labelledby="169">        results = parser.finish()
</code><code id="line-170" aria-labelledby="170">    <span class="k">except</span>:
</code><code id="line-171" aria-labelledby="171">        threw = True
</code><code id="line-172" aria-labelledby="172">
</code><code id="line-173" aria-labelledby="173">    harness.ok(threw,
</code><code id="line-174" aria-labelledby="174">               <span class="str">"</span><span class="str">Should have thrown when shadowing unforgeable attribute </span><span class="str">"</span>
</code><code id="line-175" aria-labelledby="175">               <span class="str">"</span><span class="str">of parent</span><span class="str">'</span><span class="str">s consequential interface.</span><span class="str">"</span>)
</code><code id="line-176" aria-labelledby="176">
</code><code id="line-177" aria-labelledby="177">    parser = parser.reset();
</code><code id="line-178" aria-labelledby="178">    threw = False
</code><code id="line-179" aria-labelledby="179">    <span class="k">try</span>:
</code><code id="line-180" aria-labelledby="180">        parser.parse(<span class="str">"""</span><span class="str">
</span></code><code id="line-181" aria-labelledby="181"><span class="str">            interface Child : Parent {</span><span class="str">
</span></code><code id="line-182" aria-labelledby="182"><span class="str">            };</span><span class="str">
</span></code><code id="line-183" aria-labelledby="183"><span class="str">            interface Parent : GrandParent {};</span><span class="str">
</span></code><code id="line-184" aria-labelledby="184"><span class="str">            interface GrandParent {};</span><span class="str">
</span></code><code id="line-185" aria-labelledby="185"><span class="str">            interface Consequential {</span><span class="str">
</span></code><code id="line-186" aria-labelledby="186"><span class="str">              [Unforgeable] readonly attribute long foo;</span><span class="str">
</span></code><code id="line-187" aria-labelledby="187"><span class="str">            };</span><span class="str">
</span></code><code id="line-188" aria-labelledby="188"><span class="str">            GrandParent implements Consequential;</span><span class="str">
</span></code><code id="line-189" aria-labelledby="189"><span class="str">            interface ChildConsequential {</span><span class="str">
</span></code><code id="line-190" aria-labelledby="190"><span class="str">              void foo();</span><span class="str">
</span></code><code id="line-191" aria-labelledby="191"><span class="str">            };</span><span class="str">
</span></code><code id="line-192" aria-labelledby="192"><span class="str">            Child implements ChildConsequential;</span><span class="str">
</span></code><code id="line-193" aria-labelledby="193"><span class="str">        </span><span class="str">"""</span>)
</code><code id="line-194" aria-labelledby="194">
</code><code id="line-195" aria-labelledby="195">        results = parser.finish()
</code><code id="line-196" aria-labelledby="196">    <span class="k">except</span>:
</code><code id="line-197" aria-labelledby="197">        threw = True
</code><code id="line-198" aria-labelledby="198">
</code><code id="line-199" aria-labelledby="199">    harness.ok(threw,
</code><code id="line-200" aria-labelledby="200">               <span class="str">"</span><span class="str">Should have thrown when our consequential interface shadows unforgeable attribute </span><span class="str">"</span>
</code><code id="line-201" aria-labelledby="201">               <span class="str">"</span><span class="str">of ancestor</span><span class="str">'</span><span class="str">s consequential interface.</span><span class="str">"</span>)
</code><code id="line-202" aria-labelledby="202">
</code><code id="line-203" aria-labelledby="203">    parser = parser.reset();
</code><code id="line-204" aria-labelledby="204">    threw = False
</code><code id="line-205" aria-labelledby="205">    <span class="k">try</span>:
</code><code id="line-206" aria-labelledby="206">        parser.parse(<span class="str">"""</span><span class="str">
</span></code><code id="line-207" aria-labelledby="207"><span class="str">            interface Child : Parent {</span><span class="str">
</span></code><code id="line-208" aria-labelledby="208"><span class="str">            };</span><span class="str">
</span></code><code id="line-209" aria-labelledby="209"><span class="str">            interface Parent : GrandParent {};</span><span class="str">
</span></code><code id="line-210" aria-labelledby="210"><span class="str">            interface GrandParent {};</span><span class="str">
</span></code><code id="line-211" aria-labelledby="211"><span class="str">            interface Consequential {</span><span class="str">
</span></code><code id="line-212" aria-labelledby="212"><span class="str">              [Unforgeable] void foo();</span><span class="str">
</span></code><code id="line-213" aria-labelledby="213"><span class="str">            };</span><span class="str">
</span></code><code id="line-214" aria-labelledby="214"><span class="str">            GrandParent implements Consequential;</span><span class="str">
</span></code><code id="line-215" aria-labelledby="215"><span class="str">            interface ChildConsequential {</span><span class="str">
</span></code><code id="line-216" aria-labelledby="216"><span class="str">              void foo();</span><span class="str">
</span></code><code id="line-217" aria-labelledby="217"><span class="str">            };</span><span class="str">
</span></code><code id="line-218" aria-labelledby="218"><span class="str">            Child implements ChildConsequential;</span><span class="str">
</span></code><code id="line-219" aria-labelledby="219"><span class="str">        </span><span class="str">"""</span>)
</code><code id="line-220" aria-labelledby="220">
</code><code id="line-221" aria-labelledby="221">        results = parser.finish()
</code><code id="line-222" aria-labelledby="222">    <span class="k">except</span>:
</code><code id="line-223" aria-labelledby="223">        threw = True
</code><code id="line-224" aria-labelledby="224">
</code><code id="line-225" aria-labelledby="225">    harness.ok(threw,
</code><code id="line-226" aria-labelledby="226">               <span class="str">"</span><span class="str">Should have thrown when our consequential interface shadows unforgeable operation </span><span class="str">"</span>
</code><code id="line-227" aria-labelledby="227">               <span class="str">"</span><span class="str">of ancestor</span><span class="str">'</span><span class="str">s consequential interface.</span><span class="str">"</span>)
</code><code id="line-228" aria-labelledby="228">
</code><code id="line-229" aria-labelledby="229">    parser = parser.reset();
</code><code id="line-230" aria-labelledby="230">    parser.parse(<span class="str">"""</span><span class="str">
</span></code><code id="line-231" aria-labelledby="231"><span class="str">        interface iface {</span><span class="str">
</span></code><code id="line-232" aria-labelledby="232"><span class="str">          [Unforgeable] attribute long foo;</span><span class="str">
</span></code><code id="line-233" aria-labelledby="233"><span class="str">        };</span><span class="str">
</span></code><code id="line-234" aria-labelledby="234"><span class="str">    </span><span class="str">"""</span>)
</code><code id="line-235" aria-labelledby="235">
</code><code id="line-236" aria-labelledby="236">    results = parser.finish()
</code><code id="line-237" aria-labelledby="237">    harness.check(len(results), 1,
</code><code id="line-238" aria-labelledby="238">                  <span class="str">"</span><span class="str">Should allow writable [Unforgeable] attribute.</span><span class="str">"</span>)
</code><code id="line-239" aria-labelledby="239">
</code><code id="line-240" aria-labelledby="240">    parser = parser.reset();
</code><code id="line-241" aria-labelledby="241">    threw = False
</code><code id="line-242" aria-labelledby="242">    <span class="k">try</span>:
</code><code id="line-243" aria-labelledby="243">        parser.parse(<span class="str">"""</span><span class="str">
</span></code><code id="line-244" aria-labelledby="244"><span class="str">            interface iface {</span><span class="str">
</span></code><code id="line-245" aria-labelledby="245"><span class="str">              [Unforgeable] static readonly attribute long foo;</span><span class="str">
</span></code><code id="line-246" aria-labelledby="246"><span class="str">            };</span><span class="str">
</span></code><code id="line-247" aria-labelledby="247"><span class="str">        </span><span class="str">"""</span>)
</code><code id="line-248" aria-labelledby="248">
</code><code id="line-249" aria-labelledby="249">        results = parser.finish()
</code><code id="line-250" aria-labelledby="250">    <span class="k">except</span>:
</code><code id="line-251" aria-labelledby="251">        threw = True
</code><code id="line-252" aria-labelledby="252">
</code><code id="line-253" aria-labelledby="253">    harness.ok(threw, <span class="str">"</span><span class="str">Should have thrown for static [Unforgeable] attribute.</span><span class="str">"</span>)
</code></pre>
        </td>
      </tr>
    </tbody>
