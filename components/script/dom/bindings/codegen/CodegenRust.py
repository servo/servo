...
"handleInvalidEnumValueCode" : handleInvalidEnumValueCode })
    ...
    if type.isDictionary():
        ...
        template = ("match %s::new(cx, ${val}.get()) {\n"
    ...
    def generateArray(self, array, name):
        ...
        def specData(m):
            if "selfHostedName" in m:
                selfHostedName = '&ARRAY_VALUES_STRING as *const u8 as *const i8'
            ...
            return ('&%s_name' % m["name"], accessor, jitinfo, m["length"], m["flags"], selfHostedName)
...
class AttrDefiner(PropertyDefiner):
    ...
    def generateArray(self, array, name):
        ...
        return decls + self.generatePrefableArray(
            array, name,
            '    JSPropertySpec { name: &%s_name as *const u8 as *const libc::c_char, flags: ((%s) & 0xFF) as u8, getter: %s, setter: %s }',
...
let private = RootedValue::new(cx, PrivateValue(boxed::into_raw(object) as *const libc::c_void));
let obj = {
...
class CGCreateInterfaceObjectsMethod(CGAbstractMethod):
    ...
    def definition_body(self):
        ...
        getParentProto = ("let parent_proto = RootedObject::new(cx, %s);\n"
...
class CGAbstractBindingMethod(CGAbstractExternMethod):
    ...
    def definition_body(self):
        ...
        unwrapThis = str(CastableObjectUnwrapper(
                        ...
                        "obj.ptr", self.unwrapFailureCode))
...
class CGGenericMethod(CGAbstractBindingMethod):
    ...
    def generate_code(self):
        return CGGeneric(
            ...
            "return CallJitMethodOp(_info, cx, obj.handle(), this.unsafe_get() as *mut libc::c_void, argc, vp);")
...
class CGGenericGetter(CGAbstractBindingMethod):
    ...
    def generate_code(self):
        return CGGeneric(
            ...
            "return CallJitGetterOp(info, cx, obj.handle(), this.unsafe_get() as *mut libc::c_void, argc, vp);")
...
class CGGenericSetter(CGAbstractBindingMethod):
    ...
    def generate_code(self):
        return CGGeneric(
                ...
                "let info: *const JSJitInfo = RUST_FUNCTION_VALUE_TO_JITINFO(JS_CALLEE(cx, vp));\n"
                "if CallJitSetterOp(info, cx, obj.handle(), this.unsafe_get() as *mut libc::c_void, argc, vp) == 0 {\n"
                "    return 0;\n"
                "}\n"
                "*vp = UndefinedValue();\n"
                "return 1;")
...
class CGBindingRoot(CGThing):
    ...
    def __init__(self, config, prefix, webIDLFile):
        ...
        curr = CGImports(curr, descriptors + callbackDescriptors, mainCallbacks, [
            ...
            'js::jsapi::{JS_NewObjectWithGivenProto, IsCallable, JS_SetProperty, JS_SetPrototype}',
            'js::jsapi::{JS_SetReservedSlot, JS_WrapValue, JSContext}',
            'js::jsapi::{JSClass, FreeOp, JSFreeOp, JSFunctionSpec, MutableHandleValue, HandleObject, HandleValue, RootedObject, RootedValue, jsid}',
            ...
            'dom::bindings::utils::ARRAY_VALUES_STRING',
...
class CallbackOperationBase(CallbackMethod):
    ...
    def getCallableDecl(self):
        ...
        getCallableFromProp = string.Template(
                ...
                '    Ok(callable) => RootedValue::new(cx, callable),\n'
                '}').substitute(replacements)
        if not self.singleOperation:
