...
class GlobalGenRoots():
    ...
    def InheritTypes(config):
        ...
        for descriptor in descriptors:
            ...
            upcast = downcast = False
            chain = descriptor.prototypeChain
            if descriptor.interface.getUserData("hasConcreteDescendant", False) or \
...
""").substitute({'fname': 'is_' + name.lower(),
                ...
                allprotos.append(CGGeneric(delegate))

            if upcast or downcast:
                allprotos.append(CGGeneric("pub struct %sCast;\n" % name))
                casts = []
                if downcast:
                    casts.append(CGGeneric(string.Template("""\
    #[inline]
...
""").substitute({'checkFn': 'is_' + name.lower(), 'name': name, 'fromBound': name + 'Base'})))
                allprotos.append(CGWrapper(CGList(casts, "\n"),
                                           pre="impl %sCast {\n" % name,
                                           post="}\n\n"))
