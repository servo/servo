...
static Class: DOMJSClass = DOMJSClass {
    base: js::Class {
        ...
        flags: JSCLASS_IS_DOMJSCLASS | %s | (((%s) & JSCLASS_RESERVED_SLOTS_MASK) << JSCLASS_RESERVED_SLOTS_SHIFT as usize), //JSCLASS_HAS_RESERVED_SLOTS(%s),
...
static PrototypeClass: JSClass = JSClass {
    ...
    flags: (1 & JSCLASS_RESERVED_SLOTS_MASK) << JSCLASS_RESERVED_SLOTS_SHIFT as usize, //JSCLASS_HAS_RESERVED_SLOTS(1)
    addProperty: Some(JS_PropertyStub),
    delProperty: Some(JS_PropertyStub),
    getProperty: Some(JS_PropertyStub),
    setProperty: Some(JS_StrictPropertyStub),
...
impl IDLInterface for ${type} {
    ...
    fn get_prototype_depth(_: Option<${type}>) -> usize {
        ${depth}
    }
}
""").substitute(replacer)
