...
}""" % (prototypeChainString, EventTargetEnum(descriptor), heapSizeOf)
...
let mut unforgeable_holder = RootedObject::new(cx, ptr::null_mut());
{
    ...
    assert!(!unforgeable_holder.handle().get().is_null());
            ...
            unforgeableHolderSetup = CGList([createUnforgeableHolder], "\n")
        else:
...
class CGBindingRoot(CGThing):
    ...
    def __init__(self, config, prefix, webIDLFile):
        ...
        curr = CGImports(curr, descriptors + callbackDescriptors, mainCallbacks, [
            ...
            'js::jsapi::{AutoIdVector, CallArgs, FreeOp, GetGlobalForObjectCrossCompartment}',
            'js::jsapi::{GetPropertyKeys, Handle, HandleId, HandleObject, HandleValue}',
            'js::jsapi::{HandleValueArray, INTERNED_STRING_TO_JSID, IsCallable}',
            'js::jsapi::{JS_CallFunctionValue, JS_ComputeThis, JS_GetClass, JS_GetGlobalForObject}',
            ...
            'js::jsapi::{JS_HasPropertyById, JS_InternString, JS_IsExceptionPending}',
            'js::jsapi::{JS_NewObject, JS_NewObjectWithGivenProto, JS_NewObjectWithoutMetadata}',
            'js::jsapi::{JS_SetProperty, JS_SetPrototype, JS_SetReservedSlot, JS_WrapValue}',
            'js::jsapi::{JSAutoCompartment, JSAutoRequest, JSContext, JSClass, JSFreeOp}',
            'js::jsapi::{JSFunctionSpec, JSJitGetterCallArgs, JSJitInfo, JSJitInfo_AliasSet}',
            'js::jsapi::{JSJitInfo_OpType, JSJitMethodCallArgs, JSJitSetterCallArgs, JSNative}',
            'js::jsapi::{JSObject, JSNativeWrapper, JSPropertyDescriptor, JSPropertySpec}',
            'js::jsapi::{JSString, JSTracer, JSType, JSValueType, ObjectOpResult, MutableHandle}',
            'js::jsapi::{MutableHandleObject, MutableHandleValue, RootedId, RootedObject}',
            ...
            'dom::bindings::utils::{ConstantSpec, DOMClass, DOMJSClass, JSCLASS_DOM_GLOBAL}',
