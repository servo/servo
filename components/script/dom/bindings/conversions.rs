...
pub unsafe fn get_property_jsval(cx: *mut jsapi::JSContext,
                                 ...
                                 -> Fallible<()>
{
    ...
    jsapi::JS_GetProperty(cx, object, cname.as_ptr(), rval);
...
pub unsafe fn get_property<T>(cx: *mut jsapi::JSContext,
                              object: jsapi::JS::HandleObject,
                              name: &str,
                              option: T::Config)
