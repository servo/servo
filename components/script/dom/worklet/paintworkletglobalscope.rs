                ...
                let speculatively_draw_a_paint_image_task =
                    move |cx: &mut JSContext, global_scope: &WorkletGlobalScope| {
                        ...
                        if should_speculate {
                            ...
                            {
                                *paint_worklet_global_scope.cached_name.borrow_mut() = name;
                                *paint_worklet_global_scope.cached_properties.borrow_mut() =
                                    properties;
                                *paint_worklet_global_scope.cached_arguments.borrow_mut() =
                                    arguments;
                                *paint_worklet_global_scope.cached_result.borrow_mut() = result;
                            }
                        }
                    };
                ...
                let draw_a_paint_image_task =
                    move |cx: &mut JSContext, global_scope: &WorkletGlobalScope| {
                        ...
                        let result = if cache_hit {
                            ...
                            {
                                *paint_worklet_global_scope.cached_name.borrow_mut() = name;
                                paint_worklet_global_scope.cached_size.set(size);
                                ...
                                *paint_worklet_global_scope.cached_arguments.borrow_mut() =
                                    arguments;
                                *paint_worklet_global_scope.cached_result.borrow_mut() =
                                    result.clone();
                            }
                            result
                        };
