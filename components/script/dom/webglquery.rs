...
impl WebGLQuery {
    ...
    pub fn begin(
        ...
        context.send_command(WebGLCommand::BeginQuery(target, self.droppable_field.gl_id));
        Ok(())
    }
    ...
    pub fn is_valid(&self) -> bool {
        !self.droppable_field.marked_for_deletion.get() && self.target().is_some()
    }
    ...
    fn update_results(&self, context: &WebGLRenderingContext) {
        ...
        self.upcast::<WebGLObject>()
            .context()
            .send_command(WebGLCommand::GetQueryState(
                sender,
                self.droppable_field.gl_id,
