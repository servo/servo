...
use embedder_traits::{
    ...
    NotificationDirection as EmbedderNotificationDirection,
};
use ipc_channel::ipc;
...
impl Notification {
    ...
    fn to_embedder_notification(&self) -> EmbedderNotification {
        EmbedderNotification {
            ...
            dir: match self.dir {
                NotificationDirection::Auto => EmbedderNotificationDirection::Auto,
                NotificationDirection::Ltr => EmbedderNotificationDirection::Ltr,
                NotificationDirection::Rtl => EmbedderNotificationDirection::Rtl,
            },
