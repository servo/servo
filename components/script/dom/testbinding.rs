...
impl<TH: TypeHolderTrait> TestBinding<TH> {
    ...
    pub fn Constructor_(
        ...
        nums: Vec<f64>,
    ) -> Fallible<DomRoot<TestBinding<TH>>> {
        Ok(TestBinding::new(global))
    }
...
impl<TH: TypeHolderTrait> TestBindingMethods<TH> for TestBinding<TH> {
    ...
    fn UnionAttribute(&self) -> HTMLElementOrLong<TH> {
        HTMLElementOrLong::Long(0)
    }
    fn SetUnionAttribute(&self, _: HTMLElementOrLong<TH>) {}
    fn Union2Attribute(&self) -> EventOrString<TH> {
    ...
    fn ReceiveUnion(&self) -> HTMLElementOrLong<TH> {
        HTMLElementOrLong::Long(0)
    }
    fn ReceiveUnion2(&self) -> EventOrString<TH> {
        EventOrString::String(DOMString::new())
    }
    ...
    fn ReceiveUnion5(&self) -> BlobOrBlobSequence<TH> {
    ...
    fn PassNullableCastableObjectNullableMozMap(
        &self,
        _: Option<MozMap<Option<DomRoot<TestBinding<TH>>>>>,
    ) {
    }
    ...
    fn PassMozMapUnion3(
        &self,
        _: UnionTypes::TestBindingOrByteStringSequenceSequenceOrStringByteStringRecord<TH>,
    ) {
    }
    ...
    fn PromiseNativeHandler(
        ...
        reject: Option<Rc<SimpleCallback<TH>>>,
    ) -> Rc<Promise<TH>> {
        let global = self.global();
        let handler = PromiseNativeHandler::<TH>::new(
            &global,
...
impl<TH: TypeHolderTrait> TestBinding<TH> {
    pub fn BooleanAttributeStatic(_: &GlobalScope<TH>) -> bool {
        false
    }
    pub fn SetBooleanAttributeStatic(_: &GlobalScope<TH>, _: bool) {}
    pub fn ReceiveVoidStatic(_: &GlobalScope<TH>) {}
    pub fn PrefControlledStaticAttributeDisabled(_: &GlobalScope<TH>) -> bool {
        false
    }
    pub fn PrefControlledStaticAttributeEnabled(_: &GlobalScope<TH>) -> bool {
        false
    }
    pub fn PrefControlledStaticMethodDisabled(_: &GlobalScope<TH>) {}
    pub fn PrefControlledStaticMethodEnabled(_: &GlobalScope<TH>) {}
    pub fn FuncControlledStaticAttributeDisabled(_: &GlobalScope<TH>) -> bool {
        false
    }
    pub fn FuncControlledStaticAttributeEnabled(_: &GlobalScope<TH>) -> bool {
        false
    }
