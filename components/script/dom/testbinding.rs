...
use dom::bindings::record::Record;
...
impl TestBindingMethods for TestBinding {
    ...
    fn PassNullableCastableObjectNullableMozMap(&self, _: Option<Record<DOMString, Option<DomRoot<TestBinding>>>>) {}
    ...
    fn ReceiveMozMap(&self) -> Record<DOMString, i32> { Record::new() }
    fn ReceiveMozMapWithUSVStringKey(&self) -> Record<USVString, i32> { Record::new() }
    fn ReceiveMozMapWithByteStringKey(&self) -> Record<ByteString, i32> { Record::new() }
    fn ReceiveNullableMozMap(&self) -> Option<Record<DOMString, i32>> { Some(Record::new()) }
    fn ReceiveMozMapOfNullableInts(&self) -> Record<DOMString, Option<i32>> { Record::new() }
    fn ReceiveNullableMozMapOfNullableInts(&self) -> Option<Record<DOMString, Option<i32>>> { Some(Record::new()) }
    fn ReceiveMozMapOfMozMaps(&self) -> Record<DOMString, Record<DOMString, i32>> { Record::new() }
    fn ReceiveAnyMozMap(&self) -> Record<DOMString, JSVal> { Record::new() }
