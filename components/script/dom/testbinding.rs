...
impl TestBindingMethods for TestBinding {
    ...
    fn GetUnion2AttributeNullable(&self) -> Option<EventOrString> {
        Some(EventOrString::eString("".to_owned()))
    }
    ...
    fn ReceiveUnion2(&self) -> EventOrString { EventOrString::eString("".to_owned()) }
