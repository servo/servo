...
impl NavigatorMethods for Navigator {
    ...
    // https://html.spec.whatwg.org/multipage/webappapis.html#dom-navigator-plugins
    fn Plugins(&self) -> Root<PluginArray> {
        self.plugins.or_init(|| PluginArray::new(self.global().r()))
    }

    // https://html.spec.whatwg.org/multipage/webappapis.html#dom-navigator-mimetypes
    fn MimeTypes(&self) -> Root<MimeTypeArray> {
        self.mime_types.or_init(|| MimeTypeArray::new(self.global().r()))
    }

    // https://html.spec.whatwg.org/multipage/webappapis.html#dom-navigator-javaenabled
