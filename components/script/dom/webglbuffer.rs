...
impl WebGLBuffer {
    ...
    pub fn maybe_new(global: GlobalRef, renderer: Sender<CanvasMsg>) -> Option<Temporary<WebGLBuffer>> {
    ...
    pub fn new(global: GlobalRef, renderer: Sender<CanvasMsg>, id: u32) -> Temporary<WebGLBuffer> {
