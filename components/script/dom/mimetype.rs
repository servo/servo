...
impl MimeTypeMethods for MimeType {
    // https://html.spec.whatwg.org/multipage/webappapis.html#dom-mimetype-type
    fn Type(&self) -> DOMString {
        DOMString::new()
    }

    // https://html.spec.whatwg.org/multipage/webappapis.html#dom-mimetype-description
    fn Description(&self) -> DOMString {
        DOMString::new()
    }

    // https://html.spec.whatwg.org/multipage/webappapis.html#dom-mimetype-suffixes
    fn Suffixes(&self) -> DOMString {
        DOMString::new()
    }

    // https://html.spec.whatwg.org/multipage/webappapis.html#dom-mimetype-enabledplugin
