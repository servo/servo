...
use crate::dom::servoparser::serialize_xml;
...
impl XMLSerializerMethods<crate::DomTypeHolder> for XMLSerializer {
    ...
    fn SerializeToString(&self, root: &Node) -> Fallible<DOMString> {
        serialize_xml(root, TraversalScope::IncludeNode)
            .map_err(|_| Error::Type(c"root must be a Node or an Attr object".to_owned()))
    }
}
