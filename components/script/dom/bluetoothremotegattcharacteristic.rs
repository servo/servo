...
impl<TH: TypeHolderTrait> BluetoothRemoteGATTCharacteristicMethods<TH>
    for BluetoothRemoteGATTCharacteristic<TH>
{
    ...
    fn GetDescriptors(&self, descriptor: Option<BluetoothDescriptorUUID>) -> Rc<Promise<TH>> {
        get_gatt_children(
            self,
            false,
            BluetoothUUID::<TH>::descriptor,
