...
use crate::dom::bindings::codegen::Bindings::{
    WEBGLCompressedTextureS3TCBinding,
    WEBGLCompressedTextureS3TCBinding::WEBGLCompressedTextureS3TCConstants,
};
...
impl WebGLExtension for WEBGLCompressedTextureS3TC {
    ...
    fn enable(ext: &WebGLExtensions) {
        ext.add_tex_compression_formats(&[
            (
                WEBGLCompressedTextureS3TCConstants::COMPRESSED_RGB_S3TC_DXT1_EXT,
                TexCompression {
                    bytes_per_block: 8,
                    block_width: 4,
                    block_height: 4,
            ...
            (
                WEBGLCompressedTextureS3TCConstants::COMPRESSED_RGBA_S3TC_DXT1_EXT,
                TexCompression {
                    bytes_per_block: 8,
                    block_width: 4,
                    block_height: 4,
            ...
            (
                WEBGLCompressedTextureS3TCConstants::COMPRESSED_RGBA_S3TC_DXT3_EXT,
                TexCompression {
                    bytes_per_block: 16,
                    block_width: 4,
                    block_height: 4,
            ...
            (
                WEBGLCompressedTextureS3TCConstants::COMPRESSED_RGBA_S3TC_DXT5_EXT,
                TexCompression {
                    bytes_per_block: 16,
                    block_width: 4,
                    block_height: 4,
