...
fn create_svg_element<TH: TypeHolderTrait>(
    name: QualName,
...
#[allow(unsafe_code)]
fn create_html_element<TH: TypeHolderTrait>(
    name: QualName,
    prefix: Option<Prefix>,
    is: Option<LocalName>,
    document: &Document<TH>,
        ...
        if definition.is_autonomous() {
            match mode {
                CustomElementCreationMode::Asynchronous => {
                    let result = DomRoot::upcast::<Element<TH>>(HTMLElement::new(
                        name.local.clone(),
                        prefix.clone(),
                        document,
                    ));
                ...
                CustomElementCreationMode::Synchronous => {
                    ...
                    return match definition.create_element(document, prefix.clone()) {
                        ...
                        Err(error) => {
                            ...
                            let global =
                                GlobalScope::<TH>::current().unwrap_or_else(|| document.global());
                            ...
                            // Step 6.1.2
                            let element = DomRoot::upcast::<Element<TH>>(HTMLUnknownElement::new(
...
pub fn create_element<TH: TypeHolderTrait>(
    name: QualName,
    is: Option<LocalName>,
    document: &Document<TH>,
    creator: ElementCreator,
