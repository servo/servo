...
impl HTMLIFrameElement {
    ...
    pub fn navigate_or_reload_child_browsing_context(&self, load_data: Option<LoadData>, nav_type: NavigationType) {
        ...
        match nav_type {
            NavigationType::SynchronousAboutBlank => {
            ...
            NavigationType::Replace | NavigationType::Normal => {
    ...
    fn create_nested_browsing_context(&self) {
        ...
        self.navigate_or_reload_child_browsing_context(Some(load_data), NavigationType::SynchronousAboutBlank);
    }
