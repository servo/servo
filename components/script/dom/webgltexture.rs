...
impl WebGLTexture {
    ...
    pub fn maybe_new(global: GlobalRef, renderer: Sender<CanvasMsg>) -> Option<Temporary<WebGLTexture>> {
    ...
    pub fn new(global: GlobalRef, renderer: Sender<CanvasMsg>, id: u32) -> Temporary<WebGLTexture> {
