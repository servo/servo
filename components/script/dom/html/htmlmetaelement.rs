...
use crate::dom::document::{Document, determine_referrer_policy_for_token_with_legacy};
...
impl HTMLMetaElement {
    ...
    fn apply_referrer(&self) {
            ...
            .filter(|attr| !attr.value().is_empty())
        {
            ...
            doc.set_referrer_policy(determine_referrer_policy_for_token_with_legacy(
                &content.value(),
            ));
        }
    }
