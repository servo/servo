...
impl FetchResponseListener for ClassicContext {
    ...
    fn process_response_eof(
        ...
        // Step 5 Let sourceText be the result of decoding bodyBytes to Unicode, using encoding as the fallback encoding.
        ...
        // Step 6 Let mutedErrors be true if response was CORS-cross-origin, and false otherwise.
