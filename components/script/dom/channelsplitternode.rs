...
impl ChannelSplitterNode {
    ...
    pub fn new_inherited(
        ...
        // ChannelSplitterNode does not inherit any audio node
        // options, since all of count, mode and interpretation are
        // constrained. Should we still unwrap options.parent or just
        // build an UnwrappedAudioNodeOptions directly?
