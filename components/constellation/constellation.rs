...
use script_traits::{
    ...
    DiscardBrowsingContext, DocumentActivity, DocumentState, GamepadEvent, HistoryEntryReplacement,
    ...
    ServiceWorkerMsg, StructuredSerializedData, Theme, TimerSchedulerMsg, TraversalDirection,
