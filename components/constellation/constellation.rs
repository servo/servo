...
/// Also stores the index of the active session history entry of the browsing context
pub struct Frame {
    prev: Vec<FrameEntry>,
    current: FrameEntry,
    next: Vec<FrameEntry>,
          ...
          STF: ScriptThreadFactory<Message=Message>
{
    ...
    fn handle_request(&mut self) -> bool {
        ...
        match request {
            ...
            Request::Compositor(FromCompositorMsg::Navigate(pipeline_id, direction)) => {
            ...
            // Handle a forward or back request
            Request::Script(FromScriptMsg::Navigate(pipeline_id, direction)) => {
