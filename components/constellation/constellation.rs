...
type BrowsingContextGroupId = u32;
...
pub struct Constellation<Message, LTF, STF> {
    ...
    browsing_context_group_next_id: BrowsingContextGroupId,
    ...
    STF: ScriptThreadFactory<Message = Message>,
{
    ...
    fn set_event_loop(
        ...
        let bc_group = self
            ...
            .last()
            .expect("This top-level to belong to an existing group");
        assert!(bc_group.event_loops.insert(host, event_loop).is_none());
    }
