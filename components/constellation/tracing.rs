    ...
    impl LogTarget for compositing_traits::ConstellationMsg {
        fn log_target(&self) -> &'static str {
            match self {
                ...
                Self::MarkWebViewInvisible(..) => target!("MarkWebViewInvisible"),
                Self::UnmarkWebViewInvisible(..) => target!("UnmarkWebViewInvisible"),
    ...
    impl LogTarget for script_traits::ScriptMsg {
        fn log_target(&self) -> &'static str {
            match self {
                ...
                Self::VisibilityChangeComplete(..) => target!("VisibilityChangeComplete"),
