...
use net_traits::request::{Destination, Referrer, RequestInit, Type};
    ...
    pub fn initiate_fetch(&self) {
        ...
        let msg = match self.res_init {
            ...
            None => {
                ...
                set_default_accept(Type::None, Destination::Document, &mut req_init.headers);
                set_default_accept_language(&mut req_init.headers);
