    ...
    let trait_def = TraitDef {
        ...
        methods: vec!(
            MethodDef {
                ...
                args: vec!(ty::Ptr(Box::new(ty::Literal(ty::Path::new(vec!("js","jsapi","JSTracer")))), ty::Raw(ast::MutMutable))),
                ret_ty: ty::nil_ty(),
                ...
                combine_substructure: combine_substructure(Box::new(jstraceable_substructure))
            }
        )
    };
