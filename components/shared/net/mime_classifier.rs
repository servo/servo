...
impl MimeClassifier {
    ...
    fn is_javascript(mt: &Mime) -> bool {
        *mt == mime::APPLICATION_JAVASCRIPT || *mt == mime::TEXT_JAVASCRIPT
    }

    /// <https://mimesniff.spec.whatwg.org/#json-mime-type>
    fn is_json(mt: &Mime) -> bool {
        mt.suffix() == Some(mime::JSON) ||
            *mt == mime::APPLICATION_JSON ||
            (mt.type_() == mime::TEXT && mt.subtype() == mime::JSON)
    }

    /// <https://mimesniff.spec.whatwg.org/#font-mime-type>
    fn is_font(mt: &Mime) -> bool {
        *mt == mime::FONT_WOFF || *mt == mime::FONT_WOFF2
    }
