...
use devtools_traits::{RequestLiveNotifications, StopLiveNotifications};
    ...
    fn handle_message(&self,
        ...
        Ok(match msg_type.as_slice() {
            ...
            "attach" => {
                ...
                console_actor.script_chan.send(RequestLiveNotifications(console_actor.pipeline));
                true
            }
            ...
            "detach" => {
                ...
                stream.write_json_packet(&msg);
                console_actor.script_chan.send(StopLiveNotifications(console_actor.pipeline));
                true
            }
