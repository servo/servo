...
impl HoistedAbsolutelyPositionedBox {
    ...
    pub(crate) fn layout(
        ...
        let mut inline_axis_solver = AbsoluteAxisSolver {
            ...
            computed_size: computed_size.inline.clone(),
        ...
        let mut block_axis_solver = AbsoluteAxisSolver {
            ...
            computed_size: computed_size.block.clone(),
...
impl<'a> AbsoluteAxisSolver<'a> {
    ...
    fn solve(&self, get_content_size: Option<impl FnOnce() -> ContentSizes>) -> AxisResult {
        ...
        let mut get_content_size = content_size.map(|content_size| move || *content_size);
            ...
            get_content_size
                ...
                .or_else(|| {
                    self.computed_size
                        ...
                        .or(initial_is_stretch.then(|| stretch_size))
                        .map(|size| {
                            let min_size = self
                                .computed_min_size
                                .maybe_resolve_extrinsic(Some(stretch_size))
