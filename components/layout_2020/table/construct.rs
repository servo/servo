...
use super::{
    Table, TableBox, TableCaption, TableSlot, TableSlotCell, TableSlotCoordinates, TableSlotOffset,
        ...
        match display {
            DisplayGeneratingBox::LayoutInternal(internal) => match internal {
                ...
                DisplayLayoutInternal::TableHeaderGroup => {
                    ...
                    box_slot.set(LayoutBox::TableBox(TableBox::TrackGroup(row_group)));
                },
                DisplayLayoutInternal::TableRow => {
                    ...
                    box_slot.set(LayoutBox::TableBox(TableBox::Track(row)));
                },
                DisplayLayoutInternal::TableColumn => {
                    ...
                    box_slot.set(LayoutBox::TableBox(TableBox::Track(column)));
                },
                DisplayLayoutInternal::TableColumnGroup => {
                    ...
                    box_slot.set(LayoutBox::TableBox(TableBox::TrackGroup(column_group)));
                },
                DisplayLayoutInternal::TableCaption => {
                    ...
                    box_slot.set(LayoutBox::TableBox(TableBox::Caption(caption)));
                },
        ...
        match display {
            DisplayGeneratingBox::LayoutInternal(internal) => match internal {
                DisplayLayoutInternal::TableCell => {
                    ...
                    box_slot.set(LayoutBox::TableBox(TableBox::Cell(cell)));
                },
                _ => {
