...
impl<'a> TableLayout<'a> {
    ...
    fn layout_caption(
        ...
        // let original_positioning_context_length = parent_positioning_context.len();
    ...
    fn layout(
        ...
        // weirdness is difficult to express in Servo's layout system. We have the wrapper size itself as
        ...
        // placed with a negative offset in the table wrappers content box so that they overlap the undrawn
        // border / padding area.
        //
        ...
        table_layout
            ...
            .extend(self.table.captions.iter().filter_map(|caption| {
                ...
                let mut box_fragment = self.layout_caption(
                    caption,
                    &table_pbm,
                    layout_context,
                    containing_block_for_children,
                ...
                box_fragment.content_rect.start_corner.inline += offset_from_wrapper.inline_start;
                box_fragment.content_rect.start_corner.block += current_block_offset;
                current_block_offset += box_fragment.margin_rect().size.block;
        ...
        table_layout.baselines = grid_fragment.baselines.clone();
    ...
    fn layout_grid(
        ...
        if self.table.size.width == 0 && self.table.size.height == 0 {
            ...
            return BoxFragment::new(
                ...
                Vec::new(),
                content_rect,
                table_pbm.padding.clone(),
                table_pbm.border.clone(),
                LogicalSides::zero(),
                None, /* clearance */
                CollapsedBlockMargins::zero(),
            );
