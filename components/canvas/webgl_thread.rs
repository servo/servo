...
use canvas_traits::webgl::{
    ...
    WebGLVersion, WebGLVertexArrayId, WebXRCommand, YAxisTreatment,
};
...
impl WebGLThread {
    ...
    fn handle_webxr_command(&mut self, command: WebXRCommand) {
        ...
        let mut contexts = WebXRBridgeContexts::new(&mut self.contexts, &mut self.bound_context_id);
        match command {
    ...
    fn remove_webgl_context(&mut self, context_id: WebGLContextId) {
        ...
        #[cfg(feature = "webxr")]
        {
            ...
            let mut webxr_contexts =
                WebXRBridgeContexts::new(&mut self.contexts, &mut self.bound_context_id);
