...
impl GLLimitsDetect for GLLimits {
    fn detect(gl: &Gl, webgl_version: WebGLVersion) -> GLLimits {
        ...
        if webgl_version == WebGLVersion::WebGL2 {
            ...
            max_element_index = gl.try_get_integer64(gl::MAX_ELEMENT_INDEX).unwrap_or(0); // requires GL 4.3
            ...
            max_varying_components = gl.get_integer(gl::MAX_VARYING_COMPONENTS);
