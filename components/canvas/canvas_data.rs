...
// Assert on WR texture cache update for zero sized image with raw data.
// https://github.com/servo/webrender/blob/main/webrender/src/texture_cache.rs#L1475
const MIN_CANVAS_IMAGE_SIZE: Size2D<u64> = Size2D::new(1, 1);
...
impl<'a> CanvasData<'a> {
    pub fn new(
        ...
        let size = size.max(MIN_CANVAS_IMAGE_SIZE);
