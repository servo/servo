...
use fnv::FnvHashMap;
use sparkle::gl::Gl;
use surfman::{self, Context, Device};
...
use crate::{
    // webgl_limits::GLLimitsDetect,
    webgl_thread::{GLContextData, WebGLThread},
};
...
pub(crate) struct WebXRBridgeManager {
    sender: WebGLSender<WebGLMsg>,
    manager_id: WebXRLayerManagerId,
