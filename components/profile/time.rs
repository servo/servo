...
impl Formattable for ProfilerCategory {
    ...
    fn format(&self, _output: &Option<OutputOptions>) -> String {
        ...
        let name = match *self {
            ...
            ProfilerCategory::WebGlActiveTexture => "WebGlActiveTexture",
            ProfilerCategory::WebGlBlendColor => "WebGlBlendColor",
            ProfilerCategory::WebGlBlendEquation => "WebGlBlendEquation",
            ProfilerCategory::WebGlBlendEquationSeparate => "WebGlBlendEquationSeparate",
            ProfilerCategory::WebGlBlendFunc => "WebGlBlendFunc",
            ProfilerCategory::WebGlBlendFuncSeparate => "WebGlBlendFuncSeparate",
            ProfilerCategory::WebGlAttachShader => "WebGlAttachShader",
            ProfilerCategory::WebGlDetachShader => "WebGlDetachShader",
            ProfilerCategory::WebGlBindAttribLocation => "WebGlBindAttribLocation",
            ProfilerCategory::WebGlBufferData => "WebGlBufferData",
            ProfilerCategory::WebGlBufferSubData => "WebGlBufferSubData",
            ProfilerCategory::WebGlClear => "WebGlClear",
            ProfilerCategory::WebGlClearColor => "WebGlClearColor",
            ProfilerCategory::WebGlClearDepth => "WebGlClearDepth",
            ProfilerCategory::WebGlClearStencil => "WebGlClearStencil",
            ProfilerCategory::WebGlColorMask => "WebGlColorMask",
            ProfilerCategory::WebGlCullFace => "WebGlCullFace",
            ProfilerCategory::WebGlFrontFace => "WebGlFrontFace",
            ProfilerCategory::WebGlDepthFunc => "WebGlDepthFunc",
            ProfilerCategory::WebGlDepthMask => "WebGlDepthMask",
            ProfilerCategory::WebGlDepthRange => "WebGlDepthRange",
            ProfilerCategory::WebGlEnable => "WebGlEnable",
            ProfilerCategory::WebGlDisable => "WebGlDisable",
            ProfilerCategory::WebGlCompileShader => "WebGlCompileShader",
            ProfilerCategory::WebGlCopyTexImage2D => "WebGlCopyTexImage2D",
            ProfilerCategory::WebGlCopyTexSubImage2D => "WebGlCopyTexSubImage2D",
            ProfilerCategory::WebGlCreateBuffer => "WebGlCreateBuffer",
            ProfilerCategory::WebGlCreateFramebuffer => "WebGlCreateFramebuffer",
            ProfilerCategory::WebGlCreateRenderbuffer => "WebGlCreateRenderbuffer",
            ProfilerCategory::WebGlCreateTexture => "WebGlCreateTexture",
            ProfilerCategory::WebGlCreateProgram => "WebGlCreateProgram",
            ProfilerCategory::WebGlCreateShader => "WebGlCreateShader",
            ProfilerCategory::WebGlDeleteBuffer => "WebGlDeleteBuffer",
            ProfilerCategory::WebGlDeleteFramebuffer => "WebGlDeleteFramebuffer",
            ProfilerCategory::WebGlDeleteRenderbuffer => "WebGlDeleteRenderbuffer",
            ProfilerCategory::WebGlDeleteTexture => "WebGlDeleteTexture",
            ProfilerCategory::WebGlDeleteProgram => "WebGlDeleteProgram",
            ProfilerCategory::WebGlDeleteShader => "WebGlDeleteShader",
            ProfilerCategory::WebGlBindBuffer => "WebGlBindBuffer",
            ProfilerCategory::WebGlBindFramebuffer => "WebGlBindFramebuffer",
            ProfilerCategory::WebGlBindRenderbuffer => "WebGlBindRenderbuffer",
            ProfilerCategory::WebGlBindTexture => "WebGlBindTexture",
            ProfilerCategory::WebGlDisableVertexAttribArray => "WebGlDisableVertexAttribArray",
            ProfilerCategory::WebGlEnableVertexAttribArray => "WebGlEnableVertexAttribArray",
            ProfilerCategory::WebGlFramebufferRenderbuffer => "WebGlFramebufferRenderbuffer",
            ProfilerCategory::WebGlFramebufferTexture2D => "WebGlFramebufferTexture2D",
            ProfilerCategory::WebGlGetExtensions => "WebGlGetExtensions",
            ProfilerCategory::WebGlGetShaderPrecisionFormat => "WebGlGetShaderPrecisionFormat",
            ...
            ProfilerCategory::WebGlReadPixels => "WebGlReadPixels",
            ProfilerCategory::WebGlSampleCoverage => "WebGlSampleCoverage",
            ProfilerCategory::WebGlScissor => "WebGlScissor",
            ProfilerCategory::WebGlStencilFunc => "WebGlStencilFunc",
            ProfilerCategory::WebGlStencilFuncSeparate => "WebGlStencilFuncSeparate",
            ProfilerCategory::WebGlStencilMask => "WebGlStencilMask",
            ProfilerCategory::WebGlStencilMaskSeparate => "WebGlStencilMaskSeparate",
            ProfilerCategory::WebGlStencilOp => "WebGlStencilOp",
            ProfilerCategory::WebGlStencilOpSeparate => "WebGlStencilOpSeparate",
            ProfilerCategory::WebGlHint => "WebGlHint",
            ProfilerCategory::WebGlLineWidth => "WebGlLineWidth",
            ProfilerCategory::WebGlPixelStorei => "WebGlPixelStorei",
            ProfilerCategory::WebGlLinkProgram => "WebGlLinkProgram",
            ProfilerCategory::WebGlUniform1f => "WebGlUniform1f",
            ProfilerCategory::WebGlUniform1fv => "WebGlUniform1fv",
            ProfilerCategory::WebGlUniform1i => "WebGlUniform1i",
            ProfilerCategory::WebGlUniform1iv => "WebGlUniform1iv",
            ProfilerCategory::WebGlUniform2f => "WebGlUniform2f",
            ProfilerCategory::WebGlUniform2fv => "WebGlUniform2fv",
            ProfilerCategory::WebGlUniform2i => "WebGlUniform2i",
            ProfilerCategory::WebGlUniform2iv => "WebGlUniform2iv",
            ProfilerCategory::WebGlUniform3f => "WebGlUniform3f",
            ProfilerCategory::WebGlUniform3fv => "WebGlUniform3fv",
            ProfilerCategory::WebGlUniform3i => "WebGlUniform3i",
            ProfilerCategory::WebGlUniform3iv => "WebGlUniform3iv",
            ProfilerCategory::WebGlUniform4f => "WebGlUniform4f",
            ProfilerCategory::WebGlUniform4fv => "WebGlUniform4fv",
            ProfilerCategory::WebGlUniform4i => "WebGlUniform4i",
            ProfilerCategory::WebGlUniform4iv => "WebGlUniform4iv",
            ProfilerCategory::WebGlUniformMatrix2fv => "WebGlUniformMatrix2fv",
            ProfilerCategory::WebGlUniformMatrix3fv => "WebGlUniformMatrix3fv",
            ProfilerCategory::WebGlUniformMatrix4fv => "WebGlUniformMatrix4fv",
            ProfilerCategory::WebGlUseProgram => "WebGlUseProgram",
            ProfilerCategory::WebGlValidateProgram => "WebGlValidateProgram",
            ProfilerCategory::WebGlVertexAttrib => "WebGlVertexAttrib",
            ProfilerCategory::WebGlVertexAttribPointer => "WebGlVertexAttribPointer",
            ProfilerCategory::WebGlVertexAttribPointer2f => "WebGlVertexAttribPointer2f",
            ProfilerCategory::WebGlSetViewport => "WebGlSetViewport",
            ProfilerCategory::WebGlTexImage2D => "WebGlTexImage2D",
            ProfilerCategory::WebGlTexSubImage2D => "WebGlTexSubImage2D",
            ProfilerCategory::WebGlDrawingBufferWidth => "WebGlDrawingBufferWidth",
            ProfilerCategory::WebGlDrawingBufferHeight => "WebGlDrawingBufferHeight",
            ProfilerCategory::WebGlFinish => "WebGlFinish",
            ProfilerCategory::WebGlFlush => "WebGlFlush",
            ProfilerCategory::WebGlGenerateMipmap => "WebGlGenerateMipmap",
            ProfilerCategory::WebGlCreateVertexArray => "WebGlCreateVertexArray",
            ProfilerCategory::WebGlDeleteVertexArray => "WebGlDeleteVertexArray",
            ProfilerCategory::WebGlBindVertexArray => "WebGlBindVertexArray",
            ProfilerCategory::WebGlGetParameterBool => "WebGlGetParameterBool",
            ProfilerCategory::WebGlGetParameterBool4 => "WebGlGetParameterBool4",
            ProfilerCategory::WebGlGetParameterInt => "WebGlGetParameterInt",
            ProfilerCategory::WebGlGetParameterInt2 => "WebGlGetParameterInt2",
            ProfilerCategory::WebGlGetParameterInt4 => "WebGlGetParameterInt4",
            ProfilerCategory::WebGlGetParameterFloat => "WebGlGetParameterFloat",
            ProfilerCategory::WebGlGetParameterFloat2 => "WebGlGetParameterFloat2",
            ProfilerCategory::WebGlGetParameterFloat4 => "WebGlGetParameterFloat4",
            ProfilerCategory::WebGlGetProgramValidateStatus => "WebGlGetProgramValidateStatus",
            ProfilerCategory::WebGlGetProgramActiveUniforms => "WebGlGetProgramActiveUniforms",
            ProfilerCategory::WebGlGetCurrentVertexAttrib => "WebGlGetCurrentVertexAttrib",
            ProfilerCategory::WebGlGetTexParameterFloat => "WebGlGetTexParameterFloat",
            ProfilerCategory::WebGlGetTexParameterInt => "WebGlGetTexParameterInt",
            ProfilerCategory::WebGlTexParameteri => "WebGlTexParameteri",
            ProfilerCategory::WebGlTexParameterf => "WebGlTexParameterf",
            ProfilerCategory::WebGlDrawArrays => "WebGlDrawArrays",
            ProfilerCategory::WebGlDrawArraysInstanced => "WebGlDrawArraysInstanced",
            ProfilerCategory::WebGlDrawElements => "WebGlDrawElements",
            ProfilerCategory::WebGlDrawElementsInstanced => "WebGlDrawElementsInstanced",
            ProfilerCategory::WebGlVertexAttribDivisor => "WebGlVertexAttribDivisor",
            ProfilerCategory::WebGlGetUniformBool => "WebGlGetUniformBool",
            ProfilerCategory::WebGlGetUniformBool2 => "WebGlGetUniformBool2",
            ProfilerCategory::WebGlGetUniformBool3 => "WebGlGetUniformBool3",
            ProfilerCategory::WebGlGetUniformBool4 => "WebGlGetUniformBool4",
            ProfilerCategory::WebGlGetUniformInt => "WebGlGetUniformInt",
            ProfilerCategory::WebGlGetUniformInt2 => "WebGlGetUniformInt2",
            ProfilerCategory::WebGlGetUniformInt3 => "WebGlGetUniformInt3",
            ProfilerCategory::WebGlGetUniformInt4 => "WebGlGetUniformInt4",
            ProfilerCategory::WebGlGetUniformFloat => "WebGlGetUniformFloat",
            ProfilerCategory::WebGlGetUniformFloat2 => "WebGlGetUniformFloat2",
            ProfilerCategory::WebGlGetUniformFloat3 => "WebGlGetUniformFloat3",
            ProfilerCategory::WebGlGetUniformFloat4 => "WebGlGetUniformFloat4",
