...
impl CORSCacheEntry {
    fn new (origin:Url, url: Url, max_age: usize, credentials: bool, header_or_method: HeaderOrMethod) -> CORSCacheEntry {
        CORSCacheEntry {
            origin: origin,
            url: url,
            max_age: max_age,
...
pub trait CORSCache {
    ...
    fn match_header_and_update(&mut self, request: CacheRequestDetails, header_name: &str, new_max_age: usize) -> bool;
    ...
    ///
    /// If not, it will insert an equivalent entry
    fn match_method_and_update(&mut self, request: CacheRequestDetails, method: Method, new_max_age: usize) -> bool;
    /// Insert an entry
...
pub enum CORSCacheTaskMsg {
    ...
    MatchHeaderUpdate(CacheRequestDetails, String, usize, Sender<bool>),
    MatchMethod(CacheRequestDetails, Method, Sender<bool>),
    MatchMethodUpdate(CacheRequestDetails, Method, usize, Sender<bool>),
