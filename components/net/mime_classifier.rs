    ...
    pub fn classify(&self,
        ...
        match context {
            ...
            LoadContext::Image => {
                ...
                //
                // 1. If the supplied MIME type is an XML type, the
                // computed MIME type is the supplied MIME type. Abort
                // these steps.
                //
                // 2. Let image-type-matched be the result of
                // executing the image type pattern matching algorithm
                // with the resource header as the byte sequence to be
                // matched.
                //
                // 3. If image-type-matched is not undefined, the
                // computed MIME type is image-type-matched. Abort
                // these steps.
                //
            ...
            LoadContext::AudioVideo => {
                ...
                // these steps.
                //
                // 2.  Let audio-or-video-type-matched be the result
                // of executing the audio or video type pattern
                // matching algorithm with the resource header as the
                // byte sequence to be matched.
                //
                // 3. If audio-or-video-type-matched is not undefined,
                // the computed MIME type is
                // audio-or-video-type-matched. Abort these steps.
                //
                // 4. The computed MIME type is the supplied MIME type.
                match MIMEClassifier::maybe_get_media_type(supplied_type) {
            ...
            LoadContext::Plugin => {
                ...
                //
                // 1. If the supplied MIME type is undefined, the
                // computed MIME type is
                // "application/octet-stream". [not finalized in the
                // specs at the time of this implementation]
                //
            ...
            LoadContext::Style => {
                ...
                // [unspecified at the time of this implementation, we
                // arbitrarily decide "text/css"]
                //
                // 2. The computed MIME type is the supplied MIME type.
                match *supplied_type {
            ...
            LoadContext::Script => {
                ...
                //
                // 1. If the supplied MIME type is undefined,
                // [unspecified at the time of this implementation, we arbitrarily
                // decide "text/javascript"]
                //
                // 2. The computed MIME type is the supplied MIME type.
                match *supplied_type {
            ...
            LoadContext::Font => {
                ...
                // these steps.
                //
                // 2. Let font-type-matched be the result of executing
                // the font type pattern matching algorithm with the
                // resource header as the byte sequence to be matched.
                //
                // 3. If font-type-matched is not undefined, the
                // computed MIME type is font-type-matched. Abort
                // these steps.
                //
                // 4.The computed MIME type is the supplied MIME type.
                match MIMEClassifier::maybe_get_media_type(supplied_type) {
            ...
            LoadContext::TextTrack => {
                ...
                //
                // The computed MIME type is "text/vtt". [not
                // finalized in the specs at the time of this
                // implementation]
            ...
            LoadContext::CacheManifest => {
                ...
                //
                // The computed MIME type is
                // "text/cache-manifest". [not finalized in the specs
