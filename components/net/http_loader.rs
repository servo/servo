...
use resource_task::{CancellationListener, start_sending_opt, start_sending_sniffed_opt};
...
pub fn factory(hsts_list: Arc<RwLock<HSTSList>>,
               ...
               -> Box<FnBox(LoadData,
                            ...
                            String) + Send> {
    box move |load_data: LoadData, senders, classifier, cancel_listener, user_agent| {
