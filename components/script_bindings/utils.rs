...
pub trait DomHelpers<D: DomTypes> {
    ...
    unsafe fn global_scope_from_object(obj: *mut JSObject) -> crate::root::DomRoot<D::GlobalScope>;
    ...
    fn perform_a_microtask_checkpoint(global: &D::GlobalScope, can_gc: CanGc);
    ...
    fn call_default_constructor(
        ...
        ctor_name: &str,
        creator: unsafe fn(SafeJSContext, HandleObject, *mut ProtoOrIfaceArray),
        constructor: impl FnOnce(SafeJSContext, &CallArgs, &D::GlobalScope, HandleObject) -> bool,
    ) -> bool;
