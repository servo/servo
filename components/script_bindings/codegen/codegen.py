...
from idl_type import Tags, builtinNames, numericTags
...
"""
    ...
    if type.isDOMString():
        ...
        if defaultValue is None:
            ...
            assert defaultValue.type.tag() == Tags.domstring
    ...
    if type.isUSVString():
        ...
        if defaultValue is None:
            ...
            assert defaultValue.type.tag() in (Tags.domstring, Tags.usvstring)
    ...
    if type.isByteString():
        ...
        if defaultValue is None:
            ...
            assert defaultValue.type.tag() in (Tags.domstring, Tags.bytestring)
...
pub(crate) fn init_{infoName}<D: DomTypes>() {{
    ...
    def getJSReturnTypeTag(t):
        ...
        if tag in [Tags.int8, Tags.uint8,
                   Tags.int16, Tags.uint16,
                   Tags.int32]:
            return "JSVAL_TYPE_INT32"
        if tag in [Tags.int64, Tags.uint64,
                   Tags.unrestricted_float, Tags.float,
                   Tags.unrestricted_double, Tags.double]:
