...
use style::servo::{Animation, LocalStyleContextCreationData, SharedStyleContext, Stylesheet, Stylist};
...
impl LayoutThread {
    ...
    fn build_shared_layout_context(&self,
                                   ...
                                   goal: ReflowGoal)
                                   -> SharedLayoutContext {
        let local_style_context_creation_data = LocalStyleContextCreationData::new(self.new_animations_sender.clone());
