...
impl LineBreaker {
    ...
    fn flush_current_line(&mut self) {
        ...
        //println!("flush_current_line(): pending_line.bounds={:?}", self.pending_line.bounds);
    ...
    fn new_inline_metrics_for_line(&self, new_fragment: &Fragment, layout_context: &LayoutContext)
        ...
        if !new_fragment.is_vertically_aligned_to_top_or_bottom() {
            ...
            /*println!("new_inline_metrics_for_line(): fragment_inline_metrics={:?} \
                      prev inline_metrics={:?}",
    ...
    fn new_block_size_for_line(&self, new_fragment: &Fragment, layout_context: &LayoutContext)
                               -> Au {
        //println!("new_block_size_for_line()");
        let new_block_size = if new_fragment.is_vertically_aligned_to_top_or_bottom() {
            //println!("... vertically aligned to top or bottom");
    ...
    fn initial_line_placement(&self,
        ...
        //println!("placing fragment between floats: {:?}", self.floats);
        ...
        //println!("... line_bounds between floats={:?}", line_bounds);
...
impl InlineFlow {
    ...
    fn set_block_fragment_positions(fragments: &mut InlineFragments,
        ...
        for fragment_index in line.range.each_index() {
            ...
            /*println!("starting fragment inline styles (line.bounds.start.b={:?} \
                      line.inline_metrics.block_size_above_baseline={:?} \
                      fragment_inline_metrics.ascent={:?})...",
                     line.bounds.start.b,
                     line.inline_metrics.block_size_above_baseline,
            ...
            for style in fragment.inline_styles() {
                match style.get_box().vertical_align {
                    ...
                    vertical_align::T::bottom => {
                        /*println!("... found bottom style, type={:?}",
                                 fragment.specific.get_type());*/
            ...
            //println!("... assigning block_start {:?}", block_start);
    ...
    pub fn compute_minimum_ascent_and_descent(&self,
                                              ...
                                              -> (Au, Au) {
        //println!("starting compute_minimum_ascent_and_descent()");
        ...
        /*println!("... block_size_above_baseline={:?} depth_below_baseline={:?} \
        ...
        /*println!("... resulting block_size_above_baseline={:?} depth_below_baseline={:?}",
                 block_size_above_baseline,
                 depth_below_baseline);*/
        ...
        fn update_inline_metrics(inline_metrics: &InlineMetrics,
            ...
            /*println!("... display={:?} vertical_align={:?} fragment type={}",
                     display_value,
            ...
            match (display_value, vertical_align_value) {
                ...
                _ => {
                    /*println!("... updating inline metrics BEFORE: \
                              block_size_above_baseline={:?} \
                              depth_below_baseline={:?}",
                             block_size_above_baseline,
                             depth_below_baseline);
                    println!("... ... new inline metrics={:?}", inline_metrics);*/
                    *block_size_above_baseline =
                        max(*block_size_above_baseline,
                            inline_metrics.block_size_above_baseline);
                    *depth_below_baseline = max(*depth_below_baseline,
                                                inline_metrics.depth_below_baseline);
                    /*println!("... ... updating inline metrics AFTER: \
    ...
    pub fn baseline_offset_of_last_line(&self) -> Au {
        match self.lines.last() {
            None => Au(0),
            Some(ref last_line) => {
                /*println!("baseline_offset_of_last_line(): last_line.bounds={:?} \
                          last_line.inline_metrics={:?}",
                         last_line.bounds,
                         last_line.inline_metrics);*/
                last_line.bounds.start.b + last_line.bounds.size.block -
...
impl Flow for InlineFlow {
    ...
    fn assign_inline_sizes(&mut self, _: &LayoutContext) {
        ...
        //println!("assigned inline size: {:?}", inline_size);
