...
fn take_task_local_bloom_filter<'ln, N: LayoutNode<'ln>>(parent_node: Option<N>,
                                                         root: OpaqueNode,
...
fn insert_ancestors_into_bloom_filter<'ln, N: LayoutNode<'ln>>(bf: &mut Box<BloomFilter>,
                                                               mut n: N,
                                                               root: OpaqueNode) {
