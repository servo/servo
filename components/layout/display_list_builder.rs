...
impl<'a> DisplayListBuildState<'a> {
    ...
    fn stacking_context_children(&mut self, id: StackingContextId) -> &mut Vec<StackingContext> {
        self.stacking_context_children.entry(id).or_insert(Vec::new())
    }
    ...
    fn update_overflow_for_stacking_context(&mut self, stacking_context: &mut StackingContext) {
        ...
        for child in self.stacking_context_children(stacking_context.id).iter_mut() {
    ...
    fn to_display_list_for_stacking_context(&mut self,
        ...
        let mut child_stacking_contexts =
            mem::replace(self.stacking_context_children(stacking_context.id), Vec::new());
...
impl BlockFlowDisplayListBuilding for BlockFlow {
    ...
    fn create_pseudo_stacking_context_for_block(&mut self,
        ...
        let new_children: Vec<StackingContext> =
            state.stacking_context_children(stacking_context_id).drain(..).collect();
