        ...
        let runs = {
            ...
            for (fragment_index, in_fragment) in self.clump.iter().enumerate() {
                ...
                for character in text.chars() {
                    ...
                    // character.
                    for font_index in range(0, fontgroup.fonts.len()) {
            ...
            run_info_list.into_iter().map(|run_info| {
                let mut font = fontgroup.fonts.get(run_info.font_index).borrow_mut();
        ...
        for (logical_offset, old_fragment) in
            ...
            loop {
                ...
                let mut new_text_fragment_info =
                    box ScannedTextFragmentInfo::new(run, mapping.range, text_size);
