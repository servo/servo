...
use super::{BaseFragmentInfo, Fragment};
...
impl PositioningFragment {
    pub fn new_anonymous(
        ...
        Self::new_with_base_fragment(BaseFragmentInfo::anonymous(), style, rect, children)
    }
    ...
    pub fn new_empty(
        ...
        Self::new_with_base_fragment(base_fragment_info, style, rect, Vec::new())
    }
