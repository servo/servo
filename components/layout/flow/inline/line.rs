...
impl LineItemLayout<'_, '_> {
    ...
    fn layout_text_run(&mut self, text_item: TextRunLineItem, is_last_text_run: bool) {
        ...
        .filter(|_| parent_style.get_box().overflow_x != Overflow_X::Visible);
        ...
        if can_be_elided {
                        ...
                        !is_last_text_run)
            {
                ...
                let overflow_indicator_width = (Au(0), overflow_indicator_total_advance);
    ...
    fn form_overflow_indicator(
        ...
        let overflow_indicator_font = overflow_indicator_font_group.write().find_by_codepoint(
