...
impl Flow for TableFlow {
    ...
    fn bubble_inline_sizes(&mut self) {
        ...
        //println!("... table computation={:?}", computation);
    ...
    fn assign_inline_sizes(&mut self, shared_context: &SharedStyleContext) {
        ...
        /*println!("TableFlow::assign_inline_sizes(): containing_block_inline_size={:?}",
        ...
        /*println!("table content_inline_size: border_box.size.inline={:?} - \
                  padding_and_borders={:?} - total_horizontal_spacing={:?} == {:?}",
...
impl ISizeAndMarginsComputer for InternalTable {
    ...
    fn compute_used_inline_size(&self,
        ...
        /*println!("InternalTable: input.available_inline_size={:?} minimum_inline_size={:?} \
                  constraint inputs={:?}",
