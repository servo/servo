...
impl LayoutTask {
    ...
    fn handle_reflow<'a>(&'a self,
        ...
        let current_screen_size = Size2D(Au::from_frac32_px(initial_viewport.width.get()),
        ...
        if screen_size_changed {
            ...
            if let Some(constraints) = rw_data.stylist.constrain_viewport() {
                ...
                rw_data.screen_size = Size2D(Au::from_frac32_px(constraints.size.width.get()),
                                             Au::from_frac32_px(constraints.size.height.get()));
