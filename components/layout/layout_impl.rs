...
impl LayoutThread {
    ...
    fn build_display_list(
        ...
        stacking_context_tree.paint_info.lcp_candidate_id = None;
        // TODO (shubhamg13): Collapse this check
        ...
        {
            stacking_context_tree.paint_info.lcp_candidate_id = Some(lcp_candidate.id);
