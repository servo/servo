...
impl Fragment {
    ...
    pub fn add_inline_context_style(&mut self, mut node_info: InlineFragmentNodeInfo) {
        ...
        match (&self.specific, &other.specific) {
            (&SpecificFragmentInfo::UnscannedText(ref first_unscanned_text),
             &SpecificFragmentInfo::UnscannedText(_)) => {
                ...
                let this_margin = self.style().logical_margin();
                let other_margin = other.style().logical_margin();
                let this_padding = self.style().logical_padding();
                let other_padding = self.style().logical_padding();
                self.style().get_font() == other.style().get_font() &&
                    self.text_decoration() == other.text_decoration() &&
                    self.white_space() == other.white_space() &&
                    self.style().logical_border_width().inline_start_end() == Au(0) &&
                    other.style().logical_border_width().inline_start_end() == Au(0) &&
                    this_margin.inline_start == LengthOrPercentageOrAuto::Length(Au(0)) &&
                    other_margin.inline_start == LengthOrPercentageOrAuto::Length(Au(0)) &&
                    this_margin.inline_end == LengthOrPercentageOrAuto::Length(Au(0)) &&
                    other_margin.inline_end == LengthOrPercentageOrAuto::Length(Au(0)) &&
                    this_padding.inline_start == LengthOrPercentage::Length(Au(0)) &&
                    other_padding.inline_start == LengthOrPercentage::Length(Au(0)) &&
                    this_padding.inline_end == LengthOrPercentage::Length(Au(0)) &&
                    other_padding.inline_end == LengthOrPercentage::Length(Au(0)) &&
