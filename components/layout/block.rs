...
impl Flow for BlockFlow {
    ...
    fn compute_stacking_relative_position(&mut self, _layout_context: &LayoutContext) {
        ...
        if self.is_absolute_containing_block() {
            let border_box_origin =
                (self.fragment.border_box - self.fragment.style.logical_border_width_in_au()).start;
            self.base
                .late_absolute_position_info
                .stacking_relative_position_of_absolute_containing_block =
        ...
        let stacking_relative_position_of_absolute_containing_block_for_children =
            if self.fragment.establishes_stacking_context() {
                let logical_border_width = self.fragment.style().logical_border_width_in_au();
    ...
    fn generated_containing_block_size(&self, _: OpaqueFlow) -> LogicalSize<Au> {
        (self.fragment.border_box - self.fragment.style().logical_border_width_in_au()).size
    }
