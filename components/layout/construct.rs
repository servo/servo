...
impl Legalizer {
    ...
    /// Returns true if the child was successfully added and false otherwise.
            ...
            (FlowClass::Flex, _) => {
                ...
                let mut block_wrapper =
                    Legalizer::create_anonymous_flow(stylist,
                                                     parent,
                                                     &[PseudoElement::ServoAnonymousFlexBlock],
                                                     SpecificFragmentInfo::Generic,
    ...
    fn create_anonymous_flow<F>(stylist: &Stylist,
        ...
        for pseudo in pseudos {
            new_style = stylist.precomputed_values_for_pseudo(pseudo, Some(&new_style), true)
                               .unwrap()
        }
