...
pub trait ImmutableFlowUtils {
    ...
    fn baseline_offset_of_last_line_box_in_flow(self) -> Au;
}
    ...
    fn baseline_offset_of_last_line_box_in_flow(self) -> Au {
        for kid in base(self).children.iter().rev() {
            ...
            if kid.is_block_like() &&
                ...
                return base(kid).position.start.b + kid.baseline_offset_of_last_line_box_in_flow()
            }
        }
        base(self).position.size.block
    }
}
