...
use style::dom::{PresentationalHintsSynthetiser, TDocument, TElement, TNode, UnsafeNode};
...
impl<'le> PresentationalHintsSynthetiser for ServoLayoutElement<'le> {
...
impl<'le> PresentationalHintsSynthetiser for ServoThreadSafeLayoutElement<'le> {
