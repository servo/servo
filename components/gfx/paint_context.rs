...
impl<'a> PaintContext<'a> {
    ...
    pub fn draw_image(&self,
        ...
        if source_rect.size == stretch_size {
            let pattern = SurfacePattern::new(azure_surface.azure_source_surface, true, true);
        ...
        let pattern = SurfacePattern::new(temporary_surface.azure_source_surface, true, true);
        draw_target_ref.fill_rect(&dest_rect, PatternRef::Surface(&pattern), None);
    }
