...
impl PrintTree {
    ...
    /// Descend one level in the tree with the given items string.
    pub fn new_level(&mut self, queued_item: String) {
    ...
    fn print_level_child_prefix(&self) {
