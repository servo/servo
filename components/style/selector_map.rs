...
fn get_id_name(selector: &SelectorInner<SelectorImpl>)
               -> Option<Atom> {
...
fn get_class_name(selector: &SelectorInner<SelectorImpl>)
                  -> Option<Atom> {
    find_from_right(selector, |ss| {
        // TODO(pradeep): Implement case-sensitivity based on the
        // document type and quirks mode.
...
fn get_local_name(selector: &SelectorInner<SelectorImpl>)
