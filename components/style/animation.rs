...
use properties::longhands::animation_direction::computed_value::SingleComputedValue as AnimationDirection;
use properties::longhands::animation_iteration_count::computed_value::AnimationIterationCount;
use properties::longhands::animation_play_state::computed_value::SingleComputedValue as AnimationPlayState;
