...
use parser::{ParserContext, ParserContextExtraData, dummy_extra_data, log_css_error};
...
impl<Impl: SelectorImpl> Stylesheet<Impl> {
    ...
    pub fn from_str(css: &str, base_url: Url, origin: Origin,
        ...
        let rule_parser = TopLevelRuleParser {
            context: ParserContext::new(origin, &base_url, error_reporter.clone(), extra_data),
