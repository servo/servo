...
pub mod basic_shape {
    ...
    use crate::gecko_bindings::structs::{StyleGeometryBox, StyleShapeSource, StyleShapeSourceType};
    ...
    use crate::values::generics::basic_shape::{BasicShape as GenericBasicShape, InsetRect, Polygon};
