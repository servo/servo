...
lazy_static! {
    ...
    static ref OBJDIR: String = env::var("MOZ_OBJDIR").unwrap();
    static ref OBJDIR_PATH: &'static Path = Path::new(&*OBJDIR);
...
fn generate_bindings() {
    ...
    write_binding_file(builder, "gecko_bindings.rs");
}
...
fn generate_structs() {
    ...
    write_binding_file(builder, "gecko_structs.rs");
}
