...
<%
    overflow_custom_consts = { "-moz-scrollbars-horizontal": "SCROLLBARS_HORIZONTAL",
                               "-moz-scrollbars-vertical": "SCROLLBARS_VERTICAL",
                               "-moz-hidden-unscrollable": "CLIP" }
    overflow_extra_gecko_values = """-moz-scrollbars-horizontal -moz-scrollbars-vertical
...
${helpers.single_keyword("overflow-x", "visible hidden scroll auto",
                         ...
                         extra_gecko_values=overflow_extra_gecko_values,
