...
<%
    display_values = """inline block inline-block
    table inline-table table-row-group table-header-group table-footer-group
    table-row table-column-group table-column table-cell table-caption
    list-item none
    """.split()
    webkit_prefixed_display_values = "flex inline-flex".split()
    display_values += webkit_prefixed_display_values
    if product == "gecko":
        display_values += """grid inline-grid ruby ruby-base ruby-base-container
...
${helpers.gecko_keyword_conversion(
    Keyword('display', ' '.join(display_values),
