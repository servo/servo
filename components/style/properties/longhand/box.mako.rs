...
<%helpers:longhand name="transition-duration"
    ...
    #[inline]
    pub fn get_initial_value() -> computed_value::T {
        computed_value::T(vec![Time::get_initial_value()])
    }
...
<%helpers:longhand name="transition-timing-function"
    ...
    pub mod computed_value {
        ...
        impl TransitionTimingFunction {
            #[inline]
            pub fn get_initial_value() -> TransitionTimingFunction {
                super::ease()
            }
        }
    ...
    #[inline]
    pub fn get_initial_value() -> computed_value::T {
        computed_value::T(vec![TransitionTimingFunction::get_initial_value()])
    }
...
<%helpers:longhand name="transition-delay"
    ...
    pub use properties::longhands::transition_duration::{get_initial_value, parse};
</%helpers:longhand>
...
<%helpers:longhand name="animation-duration"
    ...
    pub use super::transition_duration::{get_initial_value, parse};
...
<%helpers:longhand name="animation-timing-function"
    ...
    pub use super::transition_timing_function::{get_initial_value, parse};
...
<%helpers:longhand name="animation-iteration-count"
    ...
    pub mod computed_value {
        ...
        impl AnimationIterationCount {
            #[inline]
            pub fn get_initial_value() -> AnimationIterationCount {
    ...
    #[inline]
    pub fn get_initial_value() -> computed_value::T {
        computed_value::T(vec![AnimationIterationCount::get_initial_value()])
    }
