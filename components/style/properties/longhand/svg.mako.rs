...
<%helpers:vector_longhand name="mask-position" products="gecko" animatable="True" prefixes="webkit"
...
<%helpers:longhand name="mask-size" products="gecko" animatable="True" prefixes="webkit"
...
<%helpers:vector_longhand name="mask-image" products="gecko" animatable="False" prefixes="webkit"
