...
// FIXME: This prop should be animatable.
<%helpers:longhand name="column-count" experimental="True" animatable="False" prefixes="moz"
...
${helpers.single_keyword("column-fill", "auto balance", prefixes="moz",
                         products="gecko", animatable=False,
                         spec="https://drafts.csswg.org/css-multicol/#propdef-column-gap")}

// https://drafts.csswg.org/css-multicol-1/#propdef-column-rule-width
<%helpers:longhand name="column-rule-width" products="gecko" animatable="True" prefixes="moz"
...
${helpers.predefined_type("column-rule-color", "CSSColor",
                          ...
                          products="gecko", animatable=True, prefixes="moz",
