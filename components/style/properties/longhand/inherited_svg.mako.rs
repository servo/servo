...
${helpers.predefined_type("marker-start", "url::UrlOrNone", "computed_value::T::none()",
                          products="gecko",
                          animation_value_type="discrete",
                          spec="https://www.w3.org/TR/SVG2/painting.html#VertexMarkerProperties")}

${helpers.predefined_type("marker-mid", "url::UrlOrNone", "computed_value::T::none()",
                          products="gecko",
                          animation_value_type="discrete",
                          spec="https://www.w3.org/TR/SVG2/painting.html#VertexMarkerProperties")}

${helpers.predefined_type("marker-end", "url::UrlOrNone", "computed_value::T::none()",
                          products="gecko",
                          animation_value_type="discrete",
                          spec="https://www.w3.org/TR/SVG2/painting.html#VertexMarkerProperties")}
