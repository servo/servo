...
${helpers.predefined_type("text-decoration-line",
                    "TextDecorationLine",
                    "specified::TextDecorationLine::get_initial_value()",
                    initial_specified_value="specified::TextDecorationLine::get_initial_value()",
                    custom_cascade= product == 'servo',
                    cascade_property_custom="specified::TextDecorationLine::cascade_property_custom",
                    animation_value_type="discrete",
