...
)}" prefixes="webkit" spec="https://drafts.csswg.org/css-backgrounds/#border-radius">
...
<%helpers:shorthand name="border-image" products="gecko" sub_properties="border-image-outset
    ...
    prefixes="moz webkit" spec="https://drafts.csswg.org/css-backgrounds-3/#border-image">
