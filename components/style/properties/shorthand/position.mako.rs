...
<%helpers:shorthand name="flex-flow" sub_properties="flex-direction flex-wrap" prefixes="webkit"
...
<%helpers:shorthand name="flex" sub_properties="flex-grow flex-shrink flex-basis" prefixes="webkit"
