                ...
                Ok(SingleTransition {
                    ...
                    transition_duration:
                        duration.unwrap_or_else(
                            transition_duration::computed_value::SingleComputedValue::get_initial_value),
                    transition_timing_function:
                        timing_function.unwrap_or_else(
                            transition_timing_function::computed_value::SingleComputedValue::get_initial_value),
                    transition_delay:
                        delay.unwrap_or_else(
                            transition_delay::computed_value::SingleComputedValue::get_initial_value),
                })
            } else {
                Err(())
            }
        ...
        fn parse_one_animation(input: &mut Parser) -> Result<SingleAnimation,()> {
            ...
            if let Some(name) = name {
                Ok(SingleAnimation {
                    ...
                    animation_duration:
                        duration.unwrap_or_else(
                            animation_duration::computed_value::SingleComputedValue::get_initial_value),
                    animation_timing_function:
                        timing_function.unwrap_or_else(
                            animation_timing_function::computed_value::SingleComputedValue::get_initial_value),
                    animation_delay:
                        delay.unwrap_or_else(
                            animation_delay::computed_value::SingleComputedValue::get_initial_value),
                    animation_iteration_count:
                        iteration_count.unwrap_or_else(
                            animation_iteration_count::computed_value::SingleComputedValue::get_initial_value),
                    animation_direction:
                        direction.unwrap_or_else(
                            animation_direction::computed_value::SingleComputedValue::get_initial_value),
                    animation_fill_mode:
                        fill_mode.unwrap_or_else(
                            animation_fill_mode::computed_value::SingleComputedValue::get_initial_value),
                    animation_play_state:
                        play_state.unwrap_or_else(
                            animation_play_state::computed_value::SingleComputedValue::get_initial_value),
                })
            } else {
                Err(())
            }
