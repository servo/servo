...
def _remove_common_first_line_and_first_letter_properties(props, engine):
    ...
    remove(props, "overflow-wrap")
    remove(props, "text-align")
    remove(props, "text-justify")
    remove(props, "white-space")
    remove(props, "word-break")
    remove(props, "text-indent")
