...
use gecko_bindings::sugar::refptr::{RefCounted, ServoComputedValuesBorrowed};
...
pub extern "C" fn Servo_GetStyle${style_struct.gecko_name}(computed_values: ServoComputedValuesBorrowed)
  -> *const ${style_struct.gecko_ffi_name} {
    let values = <ComputedValues as RefCounted>::from_borrowed(computed_values);
    values.get_${style_struct.name_lower}().get_gecko()
