...
<%self:impl_trait style_struct_name="SVG"
    ...
    pub fn set_clip_path(&mut self, v: longhands::clip_path::computed_value::T) {
        use gecko_bindings::bindings::{Gecko_NewBasicShape, Gecko_ReleaseClipPath};
        ...
        unsafe { Gecko_ReleaseClipPath(clip_path) };
            ...
            ShapeSource::Shape(servo_shape, maybe_box) => {
                ...
                match servo_shape {
                    BasicShape::Inset(rect) => {
                        ...
                        rect.top.to_gecko_style_coord(&mut shape.mCoordinates[1]);
                        shape.mCoordinates[2].leaky_set_null();
                        rect.top.to_gecko_style_coord(&mut shape.mCoordinates[2]);
                        shape.mCoordinates[3].leaky_set_null();
                        rect.top.to_gecko_style_coord(&mut shape.mCoordinates[3]);
    ...
    pub fn clone_clip_path(&self) -> longhands::clip_path::computed_value::T {
        ...
        let source = match clip_path.mType {
        ...
        longhands::clip_path::computed_value::T(source)
    }
