                        ...
                        ::properties::substitute_variables_${property.ident}(
                            declared_value, &custom_props, |value| match *value {
                                ...
                                DeclaredValue::Initial => {
                                    ...
                                    let initial_struct = C::initial_values().get_${THIS_STYLE_STRUCT.trait_name_lower}();
                                    context.mutate_style().mutate_${THIS_STYLE_STRUCT.trait_name_lower}()
...
pub mod style_structs {
    ...
    % for style_struct in STYLE_STRUCTS:
        ...
        % endif
        pub struct ${style_struct.trait_name} {
            % for longhand in style_struct.longhands:
        ...
        impl PartialEq for ${style_struct.struct_name} {
            fn eq(&self, other: &${style_struct.trait_name}) -> bool {
        ...
        impl super::style_struct_traits::${style_struct.trait_name} for ${style_struct.struct_name} {
            % for longhand in style_struct.longhands:
                fn set_${longhand.ident}(&mut self, v: longhands::${longhand.ident}::computed_value::T) {
...
pub struct ServoComputedValues {
    % for style_struct in STYLE_STRUCTS:
        ${style_struct.ident}: Arc<style_structs::${style_struct.trait_name}>,
    % endfor
    custom_properties: Option<Arc<::custom_properties::ComputedValuesMap>>,
    shareable: bool,
...
impl ComputedValues for ServoComputedValues {
    % for style_struct in STYLE_STRUCTS:
        type Concrete${style_struct.trait_name} = style_structs::${style_struct.trait_name};
    % endfor
...
lazy_static! {
    pub static ref INITIAL_SERVO_VALUES: ServoComputedValues = ServoComputedValues {
        % for style_struct in STYLE_STRUCTS:
            ${style_struct.ident}: Arc::new(style_structs::${style_struct.trait_name} {
                % for longhand in style_struct.longhands:
