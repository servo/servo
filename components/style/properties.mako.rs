...
def switch_to_style_struct(name, products="gecko,servo"):
...
pub mod longhands {
    ...
    ${new_style_struct("SVG", is_inherited=True, products="gecko")}
    ...
    ${switch_to_style_struct("SVG", products="gecko")}
