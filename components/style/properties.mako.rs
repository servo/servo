...
class Keyword(object):
    def __init__(self, name, values, gecko_constant_prefix=None,
        ...
        if extra_gecko_values is None:
            self.extra_gecko_values = []
        else:
            self.extra_gecko_values = extra_gecko_values.split()
        if extra_servo_values is None:
            self.extra_servo_values = []
        else:
            self.extra_servo_values = extra_servo_values.split()
