...
pub mod longhands {
    ...
    <%include file="properties/border-widths.mako.rs" args="helpers=self"/>
    ...
    <%include file="properties/outline-style.mako.rs" args="helpers=self"/>
    <%include file="properties/outline-width.mako.rs" args="helpers=self"/>
    ...
    // Cannot easily be moved to an include file since it depends on methods defined in
    // this context. (to_rust_ident)
    ...
    <%include file="properties/float.mako.rs" args="helpers=self"/>

    ${single_keyword("clear", "none left right both")}

    <%include file="properties/servo-display-for-hypothetical-box.mako.rs" args="helpers=self"/>

    ${switch_to_style_struct("Position")}

    <%include file="properties/z-index.mako.rs" args="helpers=self"/>
    ...
    <%include file="properties/line-height.mako.rs" args="helpers=self"/>
    ...
    <%include file="properties/overflow-y.mako.rs" args="helpers=self"/>
    ...
    <%include file="properties/content.mako.rs" args="helpers=self"/>
    ...
    <%include file="properties/list-style-image.mako.rs" args="helpers=self"/>
    <%include file="properties/quotes.mako.rs" args="helpers=self"/>

    ${switch_to_style_struct("Counters")}

    <%include file="properties/counter-increment.mako.rs" args="helpers=self"/>
    <%include file="properties/counter-reset.mako.rs" args="helpers=self"/>
    ...
    <%include file="properties/background-image.mako.rs" args="helpers=self"/>
    <%include file="properties/background-position.mako.rs" args="helpers=self"/>
    ...
    <%include file="properties/background-size.mako.rs" args="helpers=self"/>
    ...
    <%include file="properties/color.mako.rs" args="helpers=self"/>
    ...
    <%include file="properties/font-family.mako.rs" args="helpers=self"/>

    ${single_keyword("font-style", "normal italic oblique")}
    ${single_keyword("font-variant", "normal small-caps")}

    <%include file="properties/font-weight.mako.rs" args="helpers=self"/>
    <%include file="properties/font-size.mako.rs" args="helpers=self"/>
    ...
    <%include file="properties/text-align.mako.rs" args="helpers=self"/>
    <%include file="properties/letter-spacing.mako.rs" args="helpers=self"/>
    <%include file="properties/word-spacing.mako.rs" args="helpers=self"/>
    ...
    <%include file="properties/text-decoration.mako.rs" args="helpers=self"/>
