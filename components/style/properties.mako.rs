...
pub mod longhands {
        ...
        pub mod ${property.ident} {
            ...
            pub fn cascade_property(declaration: &PropertyDeclaration,
                ...
                % if property.derived_from is None:
                    ...
                    style.${THIS_STYLE_STRUCT.ident}.make_unique().${property.ident} =
                        computed_value;
    ...
    //            }
        ...
        fn cascade_property_custom(computed_value: &computed_value::T,
                                   ...
                                   seen: &mut PropertyBitField,
                                   cacheable: &mut bool) {
            style.box_.make_unique()._servo_display_for_hypothetical_box =
                longhands::_servo_display_for_hypothetical_box::derive_from_display(
                    *computed_value,
                    &context);
            style.inheritedtext.make_unique()._servo_text_decorations_in_effect =
...
pub fn cascade(viewport_size: Size2D<Au>,
    ...
    if !seen.get_display() {
        let box_ = style.box_.make_unique();
    ...
    if seen.get_font_style() || seen.get_font_weight() || seen.get_font_stretch() ||
            seen.get_font_family() {
        compute_font_hash(&mut *style.font.make_unique())
    }
