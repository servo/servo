        ...
        input.parse_nested_block(|i| {
            match_ignore_ascii_case! { &*function,
                ...
                "grayscale" => {
                    ...
                    // https://www.w3.org/TR/filter-effects-1/#funcdef-grayscale
                ...
                "invert" => {
                    // Values of amount over 100% are allowed but UAs must clamp the values to 1.
                    // https://www.w3.org/TR/filter-effects-1/#funcdef-invert
                    Ok(GenericFilter::Invert(Factor::parse_with_clamping_to_one(context, i)?))
                },
                "opacity" => {
                    // Values of amount over 100% are allowed but UAs must clamp the values to 1.
                    // https://www.w3.org/TR/filter-effects-1/#funcdef-opacity
                ...
                "sepia" => {
                    // Values of amount over 100% are allowed but UAs must clamp the values to 1.
                    // https://www.w3.org/TR/filter-effects-1/#funcdef-sepia
