...
pub enum Display {
    ...
    InlineFlex,
    #[cfg(feature = "gecko")]
    Grid, InlineGrid, Ruby, RubyBase, RubyBaseContainer, RubyText, RubyTextContainer,
    #[cfg(feature = "gecko")]
    Contents, FlowRoot, WebkitBox, WebkitInlineBox,
    #[cfg(feature = "gecko")]
    MozBox, MozInlineBox, MozGrid, MozInlineGrid, MozGridGroup,
    #[cfg(feature = "gecko")]
    MozGridLine, MozStack, MozInlineStack, MozDeck, MozPopup, MozGroupbox,
}
