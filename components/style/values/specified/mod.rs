...
use super::computed::{self, ComputedValueAsSpecified, Context, ToComputedValue, UncomputeContext};
use url::Url;
...
impl ToComputedValue for Number {
    ...
    #[inline]
    fn to_specified_value(computed: &CSSFloat, _: &UncomputeContext) -> Self {
        Number(*computed)
    }
}
