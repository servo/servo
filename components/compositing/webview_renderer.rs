...
impl WebViewRenderer {
    ...
    pub(crate) fn dispatch_point_input_event(
        &self,
        ...
        let Some(result) = self
            .global
            .borrow()
            .hit_test_at_point(point, get_pipeline_details, webrender_instance)
            .into_iter()
            .nth(0)
        else {
    ...
    pub(crate) fn notify_input_event(
        ...
        self.dispatch_point_input_event(event, webrender_instance);
    }
    ...
    fn send_touch_event(
        ...
        self.dispatch_point_input_event(InputEvent::Touch(event), webrender_instance)
    }
