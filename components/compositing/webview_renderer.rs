...
impl WebViewRenderer {
    ...
    pub(crate) fn dispatch_input_event_with_hit_testing(&self, mut event: InputEvent, webrender_instance: &WebRenderInstance) -> bool {
    ...
    fn send_touch_event(&mut self, event: TouchEvent, webrender_instance: &WebRenderInstance) -> bool {
    ...
    fn scroll_node_at_device_point(
        ...
        let hit_test_results = self
            .global
            .borrow()
            .hit_test_at_point_with_flags(cursor, HitTestFlags::FIND_ALL, webrender_instance);
