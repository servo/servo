...
use msg::constellation_msg::{HistoryEntries, Key, KeyModifiers, KeyState};
...
pub trait WindowMethods {
    ...
    fn head_parsed(&self);
    /// Called when the history of a top level browser has changed.
    fn history_changed(&self, HistoryEntries);
