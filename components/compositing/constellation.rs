...
pub struct Constellation<LTF, STF> {
    ...
    /// A collection of channels through which messages can be sent to the resource-related threads.
...
impl<LTF: LayoutThreadFactory, STF: ScriptThreadFactory> Constellation<LTF, STF> {
    ...
    fn handle_exit(&mut self) {
        ...
        if let Err(e) = self.resource_threads.resource_thread.send(net_traits::ResourceMsg::Exit) {
        ...
        if let Err(e) = self.resource_threads.storage_thread.send(StorageThreadMsg::Exit) {
