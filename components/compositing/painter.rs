...
impl Painter {
    ...
    pub(crate) fn reenable_lcp_calculation(&mut self, webview_id: WebViewId) {
        self.reenable_lcp_calculation_for_webview(webview_id);
    }
    ...
    pub(crate) fn append_lcp_candidate(
        ...
        if self.lcp_calculator.enabled_for_webview(webview_id) {
            self.lcp_calculator
    ...
    fn reenable_lcp_calculation_for_webview(&mut self, webview_id: WebViewId) {
        self.lcp_calculator.enable_for_webview(webview_id);
    }
}
