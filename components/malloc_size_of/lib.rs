...
malloc_size_of_is_0!(style::queries::values::PrefersContrast);
malloc_size_of_is_0!(style::queries::values::PrefersReducedMotion);
malloc_size_of_is_0!(style::queries::values::PrefersReducedTransparency);
