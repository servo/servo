...
impl<T> MallocShallowSizeOf for std::collections::VecDeque<T> {
    fn shallow_size_of(&self, ops: &mut MallocSizeOfOps) -> usize {
        if let Some(elem) = self.get(0) {
            ...
            unsafe { ops.malloc_size_of(&*elem) }
        } else {
            // This assumes that no memory is allocated when the VecDeque is
            // empty.
            0
        }
    }
...
size_of_is_0!(std::sync::atomic::AtomicBool);
size_of_is_0!(std::sync::atomic::AtomicIsize, std::sync::atomic::AtomicUsize);
...
#[cfg(feature = "servo")]
size_of_is_0!(webrender_api::ClipAndScrollInfo);
#[cfg(feature = "servo")]
size_of_is_0!(webrender_api::ClipId);
#[cfg(feature = "servo")]
size_of_is_0!(webrender_api::ColorF);
#[cfg(feature = "servo")]
size_of_is_0!(webrender_api::GradientStop);
#[cfg(feature = "servo")]
size_of_is_0!(webrender_api::ImageKey);
#[cfg(feature = "servo")]
size_of_is_0!(webrender_api::LocalClip);
#[cfg(feature = "servo")]
size_of_is_0!(webrender_api::MixBlendMode);
#[cfg(feature = "servo")]
size_of_is_0!(webrender_api::RepeatMode);
#[cfg(feature = "servo")]
size_of_is_0!(webrender_api::ScrollPolicy);
#[cfg(feature = "servo")]
size_of_is_0!(webrender_api::ScrollSensitivity);
#[cfg(feature = "servo")]
size_of_is_0!(webrender_api::StickySideConstraint);
#[cfg(feature = "servo")]
size_of_is_0!(webrender_api::TransformStyle);
