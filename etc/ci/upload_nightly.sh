...
upload() {
    ...
    s3cmd --mime-type="application/octet-stream" put "${2}" "${package_upload_path}"
    s3cmd --mime-type="application/octet-stream" cp "${package_upload_path}" "${nightly_upload_dir}/servo-latest.${3}"
}
