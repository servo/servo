...
def windows_arm64(rdp=False):
    return (
        ...
        .with_script(
            "python3 mach build --dev --target=aarch64-uwp-windows-msvc",
...
def windows_uwp_x64(rdp=False):
    return (
        ...
        .with_scopes("secrets:get:project/servo/windows-codesign-cert/latest")
        .with_script(
            "python3 mach build --dev --target=x86_64-uwp-windows-msvc",
            "python3 mach package --dev --target=x86_64-uwp-windows-msvc --uwp=x64",
            "python3 mach test-tidy --force-cpp --no-wpt",
        )
        .with_artifacts(appx_artifact)
...
def windows_nightly(rdp=False):
    return (
        ...
        .with_script("python3 mach fetch",
                     "python3 mach build --release",
                     "python3 mach package --release",
                     "python3 mach upload-nightly windows-msvc --secret-from-taskcluster")
