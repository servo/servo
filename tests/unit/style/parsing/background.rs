...
fn background_shorthand_should_parse_comma_separated_declarations() {
    ...
    assert_eq!(result.background_position_x.unwrap(), parse_longhand!(background_position_x, "left, center, left"));
    assert_eq!(result.background_position_y.unwrap(), parse_longhand!(background_position_y, "top, center, top"));
