...
sizeof_checker!(size_element, Element, 472);
sizeof_checker!(size_htmlelement, HTMLElement, 488);
sizeof_checker!(size_div, HTMLDivElement, 488);
sizeof_checker!(size_span, HTMLSpanElement, 488);
