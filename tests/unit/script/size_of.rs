...
sizeof_checker!(size_element, Element, 456);
sizeof_checker!(size_htmlelement, HTMLElement, 472);
sizeof_checker!(size_div, HTMLDivElement, 472);
sizeof_checker!(size_span, HTMLSpanElement, 472);
