...
#[test]
fn garbage_input() {
    let area = Area::get_area(";.,()8.2");
    inspect_default(area);
}

#[test]
fn no_case_matching_input() {
    let area = Area::get_area("8.2, 10.2");
    inspect_default(area);
}
...
fn valid_circle_inputs() {
    ...
    let v = vec![10.2, 3.4, 5.2];
    let area = Area::get_area(input);
    inspect_circle(area, v);
}
...
fn rectangle_valid_input() {
    ...
    let v = vec![5.2, 1.1, 10.2, 3.4];
    let area = Area::get_area(input);
    inspect_rectangle(area, v);
}

#[test]
fn rectangle_valid_negative_input() {
    let input = "-10.2, -3.4, -5.2, -1.1";
    let v = vec![-10.2, -3.4, -5.2, -1.1];
    let area = Area::get_area(input);
    inspect_rectangle(area, v);
}
...
fn polygon_six_points_valid_input() {
    ...
    let v = vec![1.1, 1.1, 6.1, 1.1, 3.1, 3.1];
    let area = Area::get_area(input);
    inspect_polygon(area, v, 6);
}
...
fn polygon_eight_points_invalid_input() {
    ...
    let v = vec![1.1, -1.1, 6.1, -1.1, 1.1, -3.1, 6.1, 0.0];
    let area = Area::get_area(input);
    inspect_polygon(area, v, 8);
}
