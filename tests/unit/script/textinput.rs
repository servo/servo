...
use script::textinput::{
    ByteOffset, Direction, Lines, Selection, SelectionDirection, TextInput, TextPoint,
    UTF16CodeUnits,
};
...
fn test_textinput_when_inserting_multiple_lines_over_a_selection_respects_max_length() {
    ...
    textinput.adjust_horizontal(ByteOffset(3), Direction::Forward, Selection::Selected);
...
fn test_textinput_delete_char() {
    ...
    textinput.adjust_horizontal(ByteOffset(2), Direction::Forward, Selection::NotSelected);
    ...
    textinput.adjust_horizontal(ByteOffset(2), Direction::Forward, Selection::Selected);
    textinput.delete_char(Direction::Forward);
...
fn test_textinput_get_sorted_selection() {
    ...
    assert_eq!(start.index, ByteOffset(2));
    assert_eq!(end.index, ByteOffset(4));

    textinput.clear_selection();

    textinput.adjust_horizontal(ByteOffset(2), Direction::Backward, Selection::Selected);
    let (start, end) = textinput.sorted_selection_bounds();
    assert_eq!(start.index, ByteOffset(2));
    assert_eq!(end.index, ByteOffset(4));
}
...
fn test_textinput_current_line_length() {
    ...
    assert_eq!(textinput.current_line_length(), ByteOffset(3));

    textinput.adjust_vertical(1, Selection::NotSelected);
    assert_eq!(textinput.current_line_length(), ByteOffset(2));

    textinput.adjust_vertical(1, Selection::NotSelected);
    assert_eq!(textinput.current_line_length(), ByteOffset::one());
}

#[test]
fn test_textinput_adjust_vertical() {
    let mut textinput = text_input(Lines::Multiple, "abc\nde\nf");
    textinput.adjust_horizontal(ByteOffset(3), Direction::Forward, Selection::NotSelected);
    textinput.adjust_vertical(1, Selection::NotSelected);
    assert_eq!(textinput.edit_point().line, 1);
    assert_eq!(textinput.edit_point().index, ByteOffset(2));
    ...
    assert_eq!(textinput.edit_point().index, ByteOffset(1));
...
fn test_textinput_adjust_horizontal() {
    let mut textinput = text_input(Lines::Multiple, "abc\nde\nf");
    textinput.adjust_horizontal(ByteOffset(4), Direction::Forward, Selection::NotSelected);
    assert_eq!(textinput.edit_point().line, 1);
    assert_eq!(textinput.edit_point().index, ByteOffset::zero());
...
fn test_textinput_adjust_horizontal_by_word() {
    ...
    textinput.adjust_horizontal_by_word(Direction::Forward, Selection::NotSelected);
    assert_eq!(textinput.edit_point().line, 0);
    assert_eq!(textinput.edit_point().index, ByteOffset(7));
    textinput.adjust_horizontal_by_word(Direction::Backward, Selection::NotSelected);
    assert_eq!(textinput.edit_point().line, 0);
    assert_eq!(textinput.edit_point().index, ByteOffset(4));
    textinput.adjust_horizontal_by_word(Direction::Backward, Selection::NotSelected);
    assert_eq!(textinput.edit_point().line, 0);
    assert_eq!(textinput.edit_point().index, ByteOffset::zero());
    ...
    assert_eq!(textinput_2.edit_point().index, ByteOffset(3));
    textinput_2.adjust_horizontal_by_word(Direction::Backward, Selection::NotSelected);
    assert_eq!(textinput_2.edit_point().line, 1);
    assert_eq!(textinput_2.edit_point().index, ByteOffset::zero());
    textinput_2.adjust_horizontal_by_word(Direction::Backward, Selection::NotSelected);
    ...
    assert_eq!(textinput_3.edit_point().index, ByteOffset(5));
    textinput_3.adjust_horizontal_by_word(Direction::Forward, Selection::NotSelected);
    assert_eq!(textinput_3.edit_point().line, 0);
    assert_eq!(textinput_3.edit_point().index, ByteOffset(7));
    textinput_3.adjust_horizontal_by_word(Direction::Forward, Selection::NotSelected);
    assert_eq!(textinput_3.edit_point().line, 0);
    assert_eq!(textinput_3.edit_point().index, ByteOffset(13));
    textinput_3.adjust_horizontal_by_word(Direction::Backward, Selection::NotSelected);
    assert_eq!(textinput_3.edit_point().line, 0);
    assert_eq!(textinput_3.edit_point().index, ByteOffset(11));
    textinput_3.adjust_horizontal_by_word(Direction::Backward, Selection::NotSelected);
    assert_eq!(textinput_3.edit_point().line, 0);
    assert_eq!(textinput_3.edit_point().index, ByteOffset(6));
}
...
fn test_textinput_adjust_horizontal_to_line_end() {
    ...
    assert_eq!(textinput_3.edit_point().line, 0);
    assert_eq!(textinput_3.edit_point().index, ByteOffset::zero());
}
...
fn test_navigation_keyboard_shortcuts() {
    ...
    assert_eq!(textinput.edit_point().index, ByteOffset(11));
    ...
    assert_eq!(textinput.edit_point().index, ByteOffset(5));
    ...
    assert_eq!(textinput.edit_point().index, ByteOffset(6));
...
fn test_textinput_set_content() {
    ...
    textinput.adjust_horizontal(ByteOffset(3), Direction::Forward, Selection::Selected);
    assert_eq!(textinput.edit_point().line, 0);
    assert_eq!(textinput.edit_point().index, ByteOffset(3));
...
fn test_textinput_cursor_position_correct_after_clearing_selection() {
    ...
    textinput.adjust_horizontal(ByteOffset(3), Direction::Backward, Selection::NotSelected);
    textinput.adjust_horizontal(ByteOffset(3), Direction::Forward, Selection::Selected);
    textinput.adjust_horizontal_by_one(Direction::Forward, Selection::NotSelected);
    assert_eq!(textinput.edit_point().index, ByteOffset(3));
    ...
    // Multiline - Forward
    textinput.adjust_horizontal(ByteOffset(4), Direction::Forward, Selection::Selected);
    textinput.adjust_horizontal(
        ByteOffset::one(),
        Direction::Forward,
        Selection::NotSelected,
    ...
    textinput.adjust_horizontal(ByteOffset(4), Direction::Backward, Selection::NotSelected);
    textinput.adjust_horizontal(ByteOffset(4), Direction::Forward, Selection::Selected);
    textinput.adjust_horizontal_by_one(Direction::Forward, Selection::NotSelected);
    assert_eq!(textinput.edit_point().index, ByteOffset::zero());
    assert_eq!(textinput.edit_point().line, 1);
...
fn test_textinput_set_selection_with_direction() {
    ...
    assert_eq!(textinput.selection_origin().unwrap().index, ByteOffset(2));
    ...
    assert!(textinput.selection_origin().is_some());
    assert_eq!(textinput.selection_origin().unwrap().line, 0);
    assert_eq!(textinput.selection_origin().unwrap().index, ByteOffset(6));
...
fn test_textinput_unicode_handling() {
    ...
    assert_eq!(textinput.edit_point().index, ByteOffset(8));
}
...
fn test_selection_bounds() {
    ...
    assert_eq!(ByteOffset(2), textinput.selection_start_offset());
    assert_eq!(ByteOffset(5), textinput.selection_end_offset());
    ...
    assert_eq!(ByteOffset(3), textinput.selection_start_offset());
    assert_eq!(ByteOffset(6), textinput.selection_end_offset());
