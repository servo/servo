...
fn test_load_when_redirecting_from_a_post_should_rewrite_next_request_as_get() {
    ...
    let _ = load::<MockRequest>(load_data, resource_mgr, None, &Factory, "user_agent".to_string());
}
...
fn test_load_doesnt_send_request_body_on_any_redirect() {
    ...
    let _ = load::<AssertMustHaveBodyRequest>(load_data, resource_mgr, None, &Factory, "user_agent".to_string());
}
...
fn test_load_doesnt_add_host_to_sts_list_when_url_is_http_even_if_sts_headers_are_present() {
    ...
    let _ = load::<MockRequest>(load_data, resource_mgr.clone(), None, &Factory, "user_agent".to_string());
...
fn test_load_errors_when_there_a_redirect_loop() {
    ...
    match load::<MockRequest>(load_data, resource_mgr, None, &Factory, "user_agent".to_string()) {
...
fn test_load_errors_when_scheme_is_not_http_or_https() {
    ...
    match load::<MockRequest>(load_data, resource_mgr, None, &DontConnectFactory, "user_agent".to_string()) {
