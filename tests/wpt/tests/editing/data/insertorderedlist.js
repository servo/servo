...
["<ul><li>[foo]<ul><li>bar</ul><li>baz</ul>",
    [["insertorderedlist",""]],
    "<ol><li>[foo]<ul><li>bar</li></ul></li></ol><ul><li>baz</li></ul>",
    [true],
    {"insertorderedlist":[false,false,"",false,false,""]}],
...
["<ul><li>foo<li>[bar]<ul><li>baz</ul><li>quz</ul>",
    [["insertorderedlist",""]],
    "<ul><li>foo</li></ul><ol><li>[bar]<ul><li>baz</li></ul></li></ol><ul><li>quz</li></ul>",
    [true],
    {"insertorderedlist":[false,false,"",false,false,""]}],
...
["<ul><li>[foo<ul><li>bar]</ul><li>baz</ul>",
    [["insertorderedlist",""]],
    "<ol><li>[foo<ol><li>bar]</li></ol></li></ol><ul><li>baz</li></ul>",
    [true],
    {"insertorderedlist":[false,false,"",false,false,""]}],
...
["<ul><li>[foo]<ul><li>bar</ul>baz</ul>",
    [["insertorderedlist",""]],
    "<ol><li>[foo]<ul><li>bar</li></ul>baz</li></ol>",
    [true],
    {"insertorderedlist":[false,false,"",false,false,""]}],
["<ul><li>foo<ul><li>[bar]</ul>baz</ul>",
    [["insertorderedlist",""]],
