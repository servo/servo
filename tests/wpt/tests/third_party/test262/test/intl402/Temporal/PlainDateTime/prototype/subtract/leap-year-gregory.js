...
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2021, monthCode: "M09", day: 30, hour: 12, minute: 34, calendar }, options).subtract(months5),
  2022, 2, "M02", 28, 12, 34, 0, 0, 0, 0, "add 5mo with result in the next year constrained to Feb 28",
  "ce", 2022);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2019, monthCode: "M09", day: 30, hour: 12, minute: 34, calendar }, options).subtract(months5),
  2020, 2, "M02", 29, 12, 34, 0, 0, 0, 0, "add 5mo with result in the next year constrained to Feb 29",
  "ce", 2020);

TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2021, monthCode: "M12", day: 31, hour: 12, minute: 34, calendar }, options).subtract(years1months2),
  2023, 2, "M02", 28, 12, 34, 0, 0, 0, 0, "add 1y 2mo with result in the next year constrained to Feb 28",
  "ce", 2023);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2022, monthCode: "M12", day: 31, hour: 12, minute: 34, calendar }, options).subtract(years1months2),
...
TemporalHelpers.assertPlainDateTime(
  ...
  "ce", 2019);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2021, monthCode: "M01", day: 31, hour: 12, minute: 34, calendar }, options).subtract(months11n),
  2020, 2, "M02", 29, 12, 34, 0, 0, 0, 0, "add 11mo with result in the next year constrained to Feb 29",
  "ce", 2020);

TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2022, monthCode: "M04", day: 30, hour: 12, minute: 34, calendar }, options).subtract(years1months2n),
  2021, 2, "M02", 28, 12, 34, 0, 0, 0, 0, "add 1y 2mo with result in the previous year constrained to Feb 28",
  "ce", 2021);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2021, monthCode: "M04", day: 30, hour: 12, minute: 34, calendar }, options).subtract(years1months2n),
...
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2021, monthCode: "M02", day: 27, hour: 12, minute: 34, calendar }, options).subtract(weeks1),
  2021, 3, "M03", 6, 12, 34, 0, 0, 0, 0, "add 1w in Feb with result in March",
  "ce", 2021);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2020, monthCode: "M02", day: 27, hour: 12, minute: 34, calendar }, options).subtract(weeks1),
...
TemporalHelpers.assertPlainDateTime(
  ...
  "ce", 2020);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2020, monthCode: "M01", day: 27, hour: 12, minute: 34, calendar }, options).subtract(weeks6),
...
TemporalHelpers.assertPlainDateTime(
  ...
  "ce", 2021);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2019, monthCode: "M02", day: 28, hour: 12, minute: 34, calendar }, options).subtract(years1weeks2),
...
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2021, monthCode: "M04", day: 2, hour: 12, minute: 34, calendar }, options).subtract(weeks6n),
  2021, 2, "M02", 19, 12, 34, 0, 0, 0, 0, "subtract 6w with result in Feb",
  "ce", 2021);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2020, monthCode: "M04", day: 2, hour: 12, minute: 34, calendar }, options).subtract(weeks6n),
  2020, 2, "M02", 20, 12, 34, 0, 0, 0, 0, "subtract 6w with result in leap-year Feb",
  "ce", 2020);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2020, monthCode: "M03", day: 9, hour: 12, minute: 34, calendar }, options).subtract(weeks6n),
...
TemporalHelpers.assertPlainDateTime(
  ...
  "ce", 2019);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2023, monthCode: "M03", day: 1, hour: 12, minute: 34, calendar }, options).subtract(years1weeks2n),
...
TemporalHelpers.assertPlainDateTime(
  ...
  "ce", 2019);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2019, monthCode: "M03", day: 1, hour: 12, minute: 34, calendar }, options).subtract(months2weeks3n),
...
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2020, monthCode: "M02", day: 26, hour: 12, minute: 34, calendar }, options).subtract(days10),
...
TemporalHelpers.assertPlainDateTime(
  ...
  "ce", 2022);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2023, monthCode: "M02", day: 26, hour: 12, minute: 34, calendar }, options).subtract(years1months2days4),
  2024, 4, "M04", 30, 12, 34, 0, 0, 0, 0, "add 1y 2mo 4d with result in leap-year April",
  "ce", 2024);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2021, monthCode: "M12", day: 30, hour: 12, minute: 34, calendar }, options).subtract(years1months2days4),
  2023, 3, "M03", 4, 12, 34, 0, 0, 0, 0, "add 1y 2mo 4d with result rolling over into common-year March",
  "ce", 2023);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2022, monthCode: "M12", day: 30, hour: 12, minute: 34, calendar }, options).subtract(years1months2days4),
  2024, 3, "M03", 4, 12, 34, 0, 0, 0, 0, "add 1y 2mo 4d with result rolling over into leap-year March",
  "ce", 2024);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2022, monthCode: "M12", day: 29, hour: 12, minute: 34, calendar }, options).subtract(years1months2days4),
  2024, 3, "M03", 4, 12, 34, 0, 0, 0, 0, "add 1y 2mo 4d with result rolling over into leap-year March",
  "ce", 2024);
...
TemporalHelpers.assertPlainDateTime(
  ...
  "ce", 2021);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2020, monthCode: "M03", day: 10, hour: 12, minute: 34, calendar }, options).subtract(days10n),
  2020, 2, "M02", 29, 12, 34, 0, 0, 0, 0, "subtract 10d with result on leap day",
  "ce", 2020);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2021, monthCode: "M03", day: 10, hour: 12, minute: 34, calendar }, options).subtract(days10n),
...
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2023, monthCode: "M03", day: 24, hour: 12, minute: 34, calendar }, options).subtract(years1months2days4n),
  2022, 1, "M01", 20, 12, 34, 0, 0, 0, 0, "subtract 1y 2mo 4d with result in common-year January",
  "ce", 2022);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2021, monthCode: "M03", day: 24, hour: 12, minute: 34, calendar }, options).subtract(years1months2days4n),
  2020, 1, "M01", 20, 12, 34, 0, 0, 0, 0, "subtract 1y 2mo 4d with result in leap-year January",
  "ce", 2020);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2023, monthCode: "M05", day: 1, hour: 12, minute: 34, calendar }, options).subtract(years1months2days4n),
  2022, 2, "M02", 25, 12, 34, 0, 0, 0, 0, "add 1y 2mo 4d with result rolling over into common-year February",
  "ce", 2022);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2021, monthCode: "M05", day: 1, hour: 12, minute: 34, calendar }, options).subtract(years1months2days4n),
