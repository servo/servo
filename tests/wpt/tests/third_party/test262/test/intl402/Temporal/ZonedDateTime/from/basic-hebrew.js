...
for (let month = 1; month < 13; month++) {
  ...
  const startOfMonth = Temporal.ZonedDateTime.from({ year: commonYear, month, day: 1, hour: 12, minute: 34, timeZone: "UTC", calendar }, options);
  ...
  const endOfMonth = Temporal.ZonedDateTime.from({ year: commonYear, month, day, hour: 12, minute: 34, timeZone: "UTC", calendar }, options);
  TemporalHelpers.assertPlainDateTime(
