...
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 2564, monthCode: "M09", day: 30, calendar }, options).add(months5),
  2565, 2, "M02", 28, "add 5mo with result in the next year constrained to Feb 28",
  "be", 2565);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 2562, monthCode: "M09", day: 30, calendar }, options).add(months5),
  2563, 2, "M02", 29, "add 5mo with result in the next year constrained to Feb 29",
  "be", 2563);

TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 2564, monthCode: "M12", day: 31, calendar }, options).add(years1months2),
  2566, 2, "M02", 28, "add 1y 2mo with result in the next year constrained to Feb 28",
  "be", 2566);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 2565, monthCode: "M12", day: 31, calendar }, options).add(years1months2),
...
TemporalHelpers.assertPlainDate(
  ...
  "be", 2562);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 2564, monthCode: "M01", day: 31, calendar }, options).add(months11n),
  2563, 2, "M02", 29, "add 11mo with result in the next year constrained to Feb 29",
  "be", 2563);

TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 2565, monthCode: "M04", day: 30, calendar }, options).add(years1months2n),
  2564, 2, "M02", 28, "add 1y 2mo with result in the previous year constrained to Feb 28",
  "be", 2564);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 2564, monthCode: "M04", day: 30, calendar }, options).add(years1months2n),
...
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 2564, monthCode: "M02", day: 27, calendar }, options).add(weeks1),
  2564, 3, "M03", 6, "add 1w in Feb with result in March",
  "be", 2564);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 2563, monthCode: "M02", day: 27, calendar }, options).add(weeks1),
...
TemporalHelpers.assertPlainDate(
  ...
  "be", 2563);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 2563, monthCode: "M01", day: 27, calendar }, options).add(weeks6),
...
TemporalHelpers.assertPlainDate(
  ...
  "be", 2564);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 2562, monthCode: "M02", day: 28, calendar }, options).add(years1weeks2),
...
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 2564, monthCode: "M04", day: 2, calendar }, options).add(weeks6n),
  2564, 2, "M02", 19, "subtract 6w with result in Feb",
  "be", 2564);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 2563, monthCode: "M04", day: 2, calendar }, options).add(weeks6n),
  2563, 2, "M02", 20, "subtract 6w with result in leap-year Feb",
  "be", 2563);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 2563, monthCode: "M03", day: 9, calendar }, options).add(weeks6n),
...
TemporalHelpers.assertPlainDate(
  ...
  "be", 2562);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 2566, monthCode: "M03", day: 1, calendar }, options).add(years1weeks2n),
...
TemporalHelpers.assertPlainDate(
  ...
  "be", 2562);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 2562, monthCode: "M03", day: 1, calendar }, options).add(months2weeks3n),
...
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 2563, monthCode: "M02", day: 26, calendar }, options).add(days10),
...
TemporalHelpers.assertPlainDate(
  ...
  "be", 2565);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 2566, monthCode: "M02", day: 26, calendar }, options).add(years1months2days4),
  2567, 4, "M04", 30, "add 1y 2mo 4d with result in leap-year April",
  "be", 2567);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 2564, monthCode: "M12", day: 30, calendar }, options).add(years1months2days4),
  2566, 3, "M03", 4, "add 1y 2mo 4d with result rolling over into common-year March",
  "be", 2566);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 2565, monthCode: "M12", day: 30, calendar }, options).add(years1months2days4),
  2567, 3, "M03", 4, "add 1y 2mo 4d with result rolling over into leap-year March",
  "be", 2567);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 2565, monthCode: "M12", day: 29, calendar }, options).add(years1months2days4),
  2567, 3, "M03", 4, "add 1y 2mo 4d with result rolling over into leap-year March",
  "be", 2567);
...
TemporalHelpers.assertPlainDate(
  ...
  "be", 2564);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 2563, monthCode: "M03", day: 10, calendar }, options).add(days10n),
  2563, 2, "M02", 29, "subtract 10d with result on leap day",
  "be", 2563);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 2564, monthCode: "M03", day: 10, calendar }, options).add(days10n),
...
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 2566, monthCode: "M03", day: 24, calendar }, options).add(years1months2days4n),
  2565, 1, "M01", 20, "subtract 1y 2mo 4d with result in common-year January",
  "be", 2565);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 2564, monthCode: "M03", day: 24, calendar }, options).add(years1months2days4n),
  2563, 1, "M01", 20, "subtract 1y 2mo 4d with result in leap-year January",
  "be", 2563);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 2566, monthCode: "M05", day: 1, calendar }, options).add(years1months2days4n),
  2565, 2, "M02", 25, "add 1y 2mo 4d with result rolling over into common-year February",
  "be", 2565);
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 2564, monthCode: "M05", day: 1, calendar }, options).add(years1months2days4n),
