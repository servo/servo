...
TemporalHelpers.assertPlainDateTime(
  date13751201.subtract(years3months6days17).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  date13781201.subtract(months6).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  date13780101.subtract(weeks40).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  date13780101.subtract(days280).toPlainDateTime(),
