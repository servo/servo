...
for (const [calendar, year, month, monthCode, day, era, eraYear, descr] of cases) {
  const dateFromYearMonth = Temporal.PlainDateTime.from({ year, month, day, hour: 12, minute: 34, calendar }, options);
  ...
  const dateFromYearMonthCode = Temporal.PlainDateTime.from({ year, monthCode, day, hour: 12, minute: 34, calendar }, options);
  TemporalHelpers.assertPlainDateTime(
  ...
  const dateFromEraMonth = Temporal.PlainDateTime.from({ era, eraYear, month, day, hour: 12, minute: 34, calendar }, options);
  TemporalHelpers.assertPlainDateTime(
    dateFromEraMonth,
    year, month, monthCode, day, 12, 34, 0, 0, 0, 0,
  ...
  const dateFromEraMonthCode = Temporal.PlainDateTime.from({ era, eraYear, monthCode, day, hour: 12, minute: 34, calendar }, options);
  TemporalHelpers.assertPlainDateTime(
