...
TemporalHelpers.assertPlainDateTime(
  common200008.add(years1, options).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  common200108.add(years1n, options).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  common200008.add(new Temporal.Duration(1, 12), options).toPlainDateTime(),
  2002, 8, "M08", 2, 12, 34, 0, 0, 0, 0, "Adding 1y 12mo crossing leap month in the year part"
);

TemporalHelpers.assertPlainDateTime(
  common200108.add(new Temporal.Duration(2, 13), options).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  common200108.add(new Temporal.Duration(-1, -12), options).toPlainDateTime(),
  1999, 8, "M08", 2, 12, 34, 0, 0, 0, 0, "Adding 1y 12mo crossing leap month in the year part"
);

TemporalHelpers.assertPlainDateTime(
  common200008.add(new Temporal.Duration(-2, -13), options).toPlainDateTime(),
