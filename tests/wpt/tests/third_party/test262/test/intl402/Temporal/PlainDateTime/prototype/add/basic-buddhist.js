...
TemporalHelpers.assertPlainDateTime(
  ...
  "be", 2564);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2564, monthCode: "M08", day: 16, hour: 12, minute: 34, calendar }).add(months5),
  2565, 1, "M01", 16, 12, 34, 0, 0, 0, 0, "add 5mo with result in the next year",
  "be", 2565);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2562, monthCode: "M10", day: 1, hour: 12, minute: 34, calendar }).add(months5),
  2563, 3, "M03", 1, 12, 34, 0, 0, 0, 0, "add 5mo with result in the next year on day 1 of month",
  "be", 2563);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2564, monthCode: "M10", day: 31, hour: 12, minute: 34, calendar }).add(months5),
...
TemporalHelpers.assertPlainDateTime(
  ...
  "be", 2565);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2564, monthCode: "M11", day: 30, hour: 12, minute: 34, calendar }).add(years1months2),
...
TemporalHelpers.assertPlainDateTime(
  ...
  "be", 2564);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2564, monthCode: "M01", day: 16, hour: 12, minute: 34, calendar }).add(months5n),
  2563, 8, "M08", 16, 12, 34, 0, 0, 0, 0, "subtract 5mo with result in the previous year",
  "be", 2563);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2562, monthCode: "M02", day: 1, hour: 12, minute: 34, calendar }).add(months5n),
  2561, 9, "M09", 1, 12, 34, 0, 0, 0, 0, "subtract 5mo with result in the previous year on day 1 of month",
  "be", 2561);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2564, monthCode: "M03", day: 31, hour: 12, minute: 34, calendar }).add(months5n),
...
TemporalHelpers.assertPlainDateTime(
  ...
  "be", 2563);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2564, monthCode: "M02", day: 17, hour: 12, minute: 34, calendar }).add(years1months2n),
...
TemporalHelpers.assertPlainDateTime(
  ...
  "be", 2564);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2564, monthCode: "M12", day: 25, hour: 12, minute: 34, calendar }).add(weeks1),
...
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2562, monthCode: "M10", day: 28, hour: 12, minute: 34, calendar }).add(months2weeks3),
  2563, 1, "M01", 18, 12, 34, 0, 0, 0, 0, "add 2mo 3w with result in the next year",
  "be", 2563);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2562, monthCode: "M10", day: 31, hour: 12, minute: 34, calendar }).add(months2weeks3),
...
TemporalHelpers.assertPlainDateTime(
  ...
  "be", 2564);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2564, monthCode: "M01", day: 8, hour: 12, minute: 34, calendar }).add(weeks1n),
  2564, 1, "M01", 1, 12, 34, 0, 0, 0, 0, "subtract 1w with result on the first day of the year",
  "be", 2564);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2564, monthCode: "M01", day: 7, hour: 12, minute: 34, calendar }).add(weeks1n),
...
TemporalHelpers.assertPlainDateTime(
  ...
  "be", 2564);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2564, monthCode: "M07", day: 3, hour: 12, minute: 34, calendar }).add(weeks1n),
...
TemporalHelpers.assertPlainDateTime(
  ...
  "be", 2563);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2564, monthCode: "M09", day: 8, hour: 12, minute: 34, calendar }).add(weeks6n),
  2564, 7, "M07", 28, 12, 34, 0, 0, 0, 0, "subtract 6w crossing months of 30 and 31 days",
  "be", 2564);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2564, monthCode: "M08", day: 8, hour: 12, minute: 34, calendar }).add(weeks6n),
  2564, 6, "M06", 27, 12, 34, 0, 0, 0, 0, "subtract 6w crossing months of 31 and 31 days",
  "be", 2564);

TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2565, monthCode: "M01", day: 5, hour: 12, minute: 34, calendar }).add(years1weeks2n),
  2563, 12, "M12", 22, 12, 34, 0, 0, 0, 0, "subtract 1y 2w with result in the previous year",
  "be", 2563);

TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2562, monthCode: "M03", day: 2, hour: 12, minute: 34, calendar }).add(months2weeks3n),
...
TemporalHelpers.assertPlainDateTime(
  ...
  "be", 2564);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2564, monthCode: "M07", day: 26, hour: 12, minute: 34, calendar }).add(days10),
  2564, 8, "M08", 5, 12, 34, 0, 0, 0, 0, "add 10 days with result in the next month",
  "be", 2564);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2564, monthCode: "M12", day: 26, hour: 12, minute: 34, calendar }).add(days10),
...
TemporalHelpers.assertPlainDateTime(
  ...
  "be", 2565);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2564, monthCode: "M02", day: 27, hour: 12, minute: 34, calendar }).add(years1months2days4),
  2565, 5, "M05", 1, 12, 34, 0, 0, 0, 0, "add 1y 2mo 4d with result in a month following a 30-day month",
  "be", 2565);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2564, monthCode: "M07", day: 30, hour: 12, minute: 34, calendar }).add(years1months2days4),
  2565, 10, "M10", 4, 12, 34, 0, 0, 0, 0, "add 1y 2mo 4d with result in a month following a 30-day month",
  "be", 2565);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2564, monthCode: "M01", day: 28, hour: 12, minute: 34, calendar }).add(years1months2days4),
  2565, 4, "M04", 1, 12, 34, 0, 0, 0, 0, "add 1y 2mo 4d with result in a month following a 31-day month",
  "be", 2565);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2564, monthCode: "M06", day: 30, hour: 12, minute: 34, calendar }).add(years1months2days4),
...
TemporalHelpers.assertPlainDateTime(
  ...
  "be", 2564);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2564, monthCode: "M07", day: 6, hour: 12, minute: 34, calendar }).add(days10n),
  2564, 6, "M06", 26, 12, 34, 0, 0, 0, 0, "subtract 10 days with result in the previous month",
  "be", 2564);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2564, monthCode: "M01", day: 4, hour: 12, minute: 34, calendar }).add(days10n),
  2563, 12, "M12", 25, 12, 34, 0, 0, 0, 0, "subtract 10 days with result in the previous year",
  "be", 2563);

TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2564, monthCode: "M01", day: 15, hour: 12, minute: 34, calendar }).add(weeks2days3n),
...
TemporalHelpers.assertPlainDateTime(
  ...
  "be", 2563);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 2564, monthCode: "M07", day: 4, hour: 12, minute: 34, calendar }).add(years1months2days4n),
