...
const date20210716 = Temporal.PlainDate.from({ year: 2021, monthCode: "M07", day: 16 });
...
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M08", day: 16 }).add(months5),
    2022, 1, "M01", 16, "add 5mo with result in the next year");
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2019, monthCode: "M10", day: 1 }).add(months5),
    2020, 3, "M03", 1, "add 5mo with result in the next year on day 1 of month");
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M10", day: 31 }).add(months5),
...
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M11", day: 30 }).add(years1months2),
...
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M01", day: 16 }).add(months5n),
    2020, 8, "M08", 16, "subtract 5mo with result in the previous year");
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2019, monthCode: "M02", day: 1 }).add(months5n),
    2018, 9, "M09", 1, "subtract 5mo with result in the previous year on day 1 of month");
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M03", day: 31 }).add(months5n),
...
const date20201228 = Temporal.PlainDate.from({ year: 2020, monthCode: "M12", day: 28 });
const date20210127 = Temporal.PlainDate.from({ year: 2021, monthCode: "M01", day: 27 });
const date20210219 = Temporal.PlainDate.from({ year: 2021, monthCode: "M02", day: 19 });
const date20210604 = Temporal.PlainDate.from({ year: 2021, monthCode: "M06", day: 4 });
const date20210627 = Temporal.PlainDate.from({ year: 2021, monthCode: "M06", day: 27 });
const date20210727 = Temporal.PlainDate.from({ year: 2021, monthCode: "M07", day: 27 });
const date20211224 = Temporal.PlainDate.from({ year: 2021, monthCode: "M12", day: 24 });
...
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M12", day: 25 }).add(weeks1),
...
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2019, monthCode: "M10", day: 28 }).add(months2weeks3),
    2020, 1, "M01", 18, "add 2mo 3w with result in the next year");
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2019, monthCode: "M10", day: 31 }).add(months2weeks3),
...
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M01", day: 8 }).add(weeks1n),
    2021, 1, "M01", 1, "subtract 1w with result on the first day of the year");
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M01", day: 7 }).add(weeks1n),
...
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M07", day: 3 }).add(weeks1n),
...
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M07", day: 26 }).add(days10),
    2021, 8, "M08", 5, "add 10 days with result in the next month");
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M12", day: 26 }).add(days10),
...
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M02", day: 27 }).add(years1months2days4),
    2022, 5, "M05", 1, "add 1y 2mo 4d with result in a month following a 30-day month");
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M07", day: 30 }).add(years1months2days4),
    2022, 10, "M10", 4, "add 1y 2mo 4d with result in a month following a 30-day month");
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M01", day: 28 }).add(years1months2days4),
    2022, 4, "M04", 1, "add 1y 2mo 4d with result in a month following a 31-day month");
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M06", day: 30 }).add(years1months2days4),
...
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M07", day: 6 }).add(days10n),
    2021, 6, "M06", 26, "subtract 10 days with result in the previous month");
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M01", day: 4 }).add(days10n),
    2020, 12, "M12", 25, "subtract 10 days with result in the previous year");

TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M01", day: 15 }).add(weeks2days3n),
...
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M07", day: 4 }).add(years1months2days4n),
