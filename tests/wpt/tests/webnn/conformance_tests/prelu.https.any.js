...
const preluTests = [
  ...
  {
    'name': 'prelu float32 broadcast 5D x 1D slope',
    'graph': {
      'inputs': {
        'preluInput': {
          'data': [
  ...
  {
    'name': 'prelu float32 broadcast 5D x 5D slope',
    'graph': {
      'inputs': {
        'preluInput': {
          'data': [
  ...
  {
    'name': 'prelu float32 broadcast 5D x 5D slope with expanded output shape',
    'graph': {
      'inputs': {
        'preluInput': {
          'data': [
          ...
          'descriptor': {shape: [2, 1, 1, 2, 3], dataType: 'float32'}
        },
        'preluSlope': {
          'data': [5.0114545822143555, 0.480774462223053],
          'descriptor': {shape: [1, 2, 1, 1, 1], dataType: 'float32'},
          'constant': true
        }
      },
      ...
      'expectedOutputs': {
        'preluOutput': {
          'data': [
            -12.775040205161986, -24.029210599380804, 8.413617134094238,
            6.108623504638672, -42.55873768240599, 3.3143365383148193,
            -1.2255749271503475, -2.305245036952357, 8.413617134094238,
            6.108623504638672, -4.082877313658059, 3.3143365383148193,
            1.1687211990356445, -0.7104380229181544, -33.650173841390824,
            5.787421703338623, -18.82115611136055, -24.547539536725253,
            1.1687211990356445, -0.06815595209093228, -3.2282332338645006,
            5.787421703338623, -1.8056097405271174, -2.354970982188064
          ],
          'descriptor': {shape: [2, 2, 1, 2, 3], dataType: 'float32'}
        }
      }
  ...
  {
    'name': 'prelu float16 broadcast 5D x 1D slope',
    'graph': {
      'inputs': {
        'preluInput': {
          'data': [
  ...
  {
    'name': 'prelu float16 broadcast 5D x 5D slope',
    'graph': {
      'inputs': {
        'preluInput': {
          'data': [
      ...
      'expectedOutputs': {
        'preluOutput': {
          'data': [
            -12.7734375, -24.015625,   8.4140625,      6.109375,
            -42.5625,    3.314453125, 1.1689453125, -0.71044921875,
            -33.65625,   5.7890625,   -18.828125,  -24.546875,
            7.328125,    -19.828125,  7.06640625,  9.4375,
            -12.8203125, -43.375,     8.4765625,   4.55078125,
