...
impl Window {
    ...
    fn cursor_type_for_cursor(&self, cursor: CursorKind) -> cef_cursor_type_t {
        match cursor {
            ...
            CursorKind::ContextMenu => return cef_cursor_type_t::CT_CONTEXTMENU,
            CursorKind::Grabbing => return cef_cursor_type_t::CT_GRABBING,
            CursorKind::Crosshair => return cef_cursor_type_t::CT_CROSS,
            CursorKind::Copy => return cef_cursor_type_t::CT_COPY,
            CursorKind::Alias => return cef_cursor_type_t::CT_ALIAS,
            CursorKind::Text => return cef_cursor_type_t::CT_IBEAM,
            CursorKind::Grab | Cursor::AllScroll =>
                return cef_cursor_type_t::CT_GRAB,
            CursorKind::NoDrop => return cef_cursor_type_t::CT_NODROP,
            CursorKind::NotAllowed => return cef_cursor_type_t::CT_NOTALLOWED,
            CursorKind::Pointer => return cef_cursor_type_t::CT_POINTER,
            CursorKind::SResize => return cef_cursor_type_t::CT_SOUTHRESIZE,
            CursorKind::WResize => return cef_cursor_type_t::CT_WESTRESIZE,
            CursorKind::EwResize => return cef_cursor_type_t::CT_EASTWESTRESIZE,
            CursorKind::ColResize => return cef_cursor_type_t::CT_COLUMNRESIZE,
            CursorKind::EResize => return cef_cursor_type_t::CT_EASTRESIZE,
            CursorKind::NResize => return cef_cursor_type_t::CT_NORTHRESIZE,
            CursorKind::NsResize => return cef_cursor_type_t::CT_NORTHSOUTHRESIZE,
            CursorKind::RowResize => return cef_cursor_type_t::CT_ROWRESIZE,
            CursorKind::VerticalText => return cef_cursor_type_t::CT_VERTICALTEXT,
    ...
    fn cursor_handle_for_cursor(&self, cursor: Cursor) -> cef_cursor_handle_t {
        ...
        unsafe {
            match cursor {
                ...
                CursorKind::NoDrop | Cursor::NotAllowed =>
                ...
                CursorKind::EwResize | Cursor::ColResize =>
                ...
                CursorKind::NsResize | Cursor::RowResize =>
