...
use servo::{
    ...
    GamepadHapticEffectType, JSValue, KeyboardEvent, LoadStatus, PageZoom, PermissionRequest,
    Servo, ServoDelegate, ServoError, SimpleDialog, TraversalId, WebDriverCommandMsg,
    WebDriverJSResult, WebDriverLoadStatus, WebDriverUserPrompt, WebView, WebViewBuilder,
    WebViewDelegate,
};
use url::Url;
