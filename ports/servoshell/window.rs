...
use log::warn;
use servo::{
    AuthenticationRequest, BluetoothPickDeviceRequest, ConsoleLogLevel, Cursor,
...
pub(crate) trait PlatformWindow {
    ...
    fn show_bluetooth_device_dialog(&self, _: WebViewId, _request: BluetoothPickDeviceRequest) {}
