    ...
    pub fn update(
        ...
        let _duration = context.run(window, |ctx| {
            ...
            *toolbar_height = Length::new(height);
            ...
            let Some(focused_browser_id) = browsers.focused_browser_id() else { return };
            let Some(browser) = browsers.get_mut(focused_browser_id) else { return };
            ...
            CentralPanel::default()
                ...
                .show(ctx, |ui| {
                    ...
                    if rect != browser.rect {
                        browser.rect = rect;
                        embedder_events
                            .push(EmbedderEvent::MoveResizeBrowser(focused_browser_id, rect));
                    }
