...
use servo::{AlertResponse, ConfirmResponse, LoadStatus, MediaSessionActionType, PromptResponse};
use simpleservo::{
...
impl HostTrait for HostCallbacks {
    ...
    fn show_untrusted_prompt(&self, message: String, _default: String) -> PromptResponse {
