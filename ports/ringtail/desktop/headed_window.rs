...
use crate::window::{
    LINE_HEIGHT, LINE_WIDTH, MIN_WINDOW_INNER_SIZE, PlatformWindow, RingtailWindow,
    RingtailWindowId,
};
...
impl PlatformWindow for HeadedWindow {
    ...
    fn update_user_interface_state(&self, _: &RunningAppState, window: &RingtailWindow) -> bool {
        let title = window
            .active_webview()
            .and_then(|webview| {
                webview
