...
#[repr(C)]
#[derive(Debug, Copy)]
pub struct ServoElementSnapshot_Flags {
    pub mInternal: ::std::os::raw::c_uchar,
}
#[repr(i8)]
#[derive(Debug, Copy, Clone, Eq, PartialEq, Hash)]
pub enum ServoElementSnapshot_Flags_InternalTypeEnum {
    No = 0,
    State = 1,
    Attributes = 2,
    All = 3,
}
impl ::std::clone::Clone for ServoElementSnapshot_Flags {
    fn clone(&self) -> Self { *self }
}
#[test]
fn bindgen_test_layout_ServoElementSnapshot_Flags() {
    assert_eq!(::std::mem::size_of::<ServoElementSnapshot_Flags>() , 1usize);
    assert_eq!(::std::mem::align_of::<ServoElementSnapshot_Flags>() , 1usize);
}
#[test]
