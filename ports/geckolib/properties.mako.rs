...
<% skip_border_longhands = " ".join(["border-{0}-color border-{0}-style border-{0}-width ".format(x.ident) for x in SIDES]) %>
<%self:impl_trait style_struct_name="Border"
    ...
    <% impl_color("border_%s_color" % side.ident, "mBorderColor[%s]" % side.index,
                  gecko_currentcolor_mask_ffi_name="mBorderStyle[%s]" % side.index, need_clone=False) %>
...
<%self:impl_trait style_struct_name="Outline"
    ...
    <% impl_color("outline_color", "mOutlineColor",
                  gecko_currentcolor_mask_ffi_name="mOutlineStyle", need_clone=False) %>
...
<%self:impl_trait style_struct_name="Background" skip_longhands="background-color" skip_additionals="*">
    ...
    <% impl_color("background_color", "mBackgroundColor", need_clone=False) %>
...
<%self:impl_trait style_struct_name="Text"
    ...
    <% impl_color("text_decoration_color", "mTextDecorationColor",
                  gecko_currentcolor_mask_ffi_name="mTextDecorationStyle", need_clone=False) %>
...
<%self:impl_trait style_struct_name="SVG"
    ...
    <% impl_color("flood_color", "mFloodColor", need_clone=False) %>

    <% impl_color("lighting_color", "mLightingColor", need_clone=False) %>

    <% impl_color("stop_color", "mStopColor", need_clone=False) %>

</%self:impl_trait>

<%self:impl_trait style_struct_name="Color"
                  skip_longhands="color"
                  skip_additionals="*">
