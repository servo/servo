...
<%
   ...
   # Properties that would be auto-generated but need to be manually implemented.
   manual = ["bottom", "left", "right", "top"]
   ...
   stub_longhands = [x for x in longhands if x not in manual + keyword_longhands + predefined_longhands]
%>
