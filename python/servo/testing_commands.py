...
class MachCommands(CommandBase):
    ...
    def test_devtools(self, build_type: BuildType, test_names: list[str], servo_binary: str, **kwargs: Any) -> int:
        print("Running devtools tests...")
        passed = servo.devtools_tests.run_tests(SCRIPT_PATH, build_type, test_names, servo_binary)
        return 0 if passed else 1
