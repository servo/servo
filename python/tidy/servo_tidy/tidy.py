...
def check_rust(file_name, lines):
    ...
    check_alplabetical_order = config["check-alphabetical-order"]
    ...
    for idx, original_line in enumerate(lines):
        ...
        if line.startswith("extern crate "):
            ...
            if indent not in prev_crate:
                prev_crate[indent] = ""
            if prev_crate[indent] > crate_name and check_alplabetical_order:
        ...
        if is_lib_rs_file:
            ...
            if match:
                ...
                if sorted_features != features and check_alplabetical_order:
                ...
                if prev_feature_name > sorted_features[0] and check_alplabetical_order:
                    yield(idx + 1, decl_message.format("feature attribute")
        ...
        if line.startswith("use "):
            ...
            if prev_use:
                ...
                if indent == current_indent and current_use_cut < prev_use_cut and check_alplabetical_order:
        ...
        if line.startswith("mod ") or line.startswith("pub mod "):
            ...
            if (idx - 1) < 0 or "#[macro_use]" not in lines[idx - 1]:
                ...
                if prev_mod[indent] and mod < prev_mod[indent] and check_alplabetical_order:
        ...
        if is_attribute:
            ...
            if match:
                ...
                if sorted_derives != derives and check_alplabetical_order:
